...
export const clinicAppointmentSeries = Object.freeze([
  ...
  },
  {
    ...
    ko: '[설계 1] 상품이 바뀌어도 고객의 예약은 변경하지 않는다: 상품 버전과 구매 기준 정보',
  ...
  },
  {
    ...
    ko: '[설계 5] 상품 BOM은 어떻게 AppointmentPlan과 방문 계획으로 이어지는가',
  ...
  },
  {
    ...
    ko: '[구현 5] 병원 업무 규칙을 Timefold 제약으로 모델링하기',
  ...
  },
  {
    ...
    ko: '[구현 8] N회 상품 구매로 방문 계획을 만드는 과정',
  ...
  },
  {
    ...
    ko: '[구현 9] 패키지 상품의 실행 순서와 선택 조건을 방문 계획에 담는 과정',
