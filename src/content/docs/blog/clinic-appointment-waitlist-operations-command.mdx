---
title: "A Waitlist Operations Command Is Complete Only After the API Request and Re-read"
...
blog:
  ...
  imageAlt: An operator reviewing API command results and re-read state for a waitlist offer
...
<figure class="bt4k-blog-hero">
  <img src="/assets/clinic-appointment-waitlist-operations-dashboard-hero.png" alt="An operator reviewing API command results and re-read state for a waitlist offer" loading="eager" />
  <figcaption>Clicking a button on an operations screen does not prove that an appointment was confirmed. The screen must classify the API result and, when necessary, read the latest state in the same scope.</figcaption>
</figure>
...
<figure class="bt4k-architecture" data-diagram-title="Waitlist command and Dashboard terminal outcome decision">
  <img src="/assets/clinic-appointment-waitlist-operations-dashboard-01-en.png" alt="A waitlist Dashboard reads clinic readiness and metrics, selects an item from the action queue, checks its evidence and permitted command, and confirms the terminal outcome decision" loading="lazy" />
  <figcaption>The Dashboard starts with metrics and the action queue, moves through the evidence panel and permitted command, and returns the result to a terminal outcome decision or staff review.</figcaption>
</figure>
...
- **A Waitlist Operations Command Is Complete Only After the API Request and Re-read**
