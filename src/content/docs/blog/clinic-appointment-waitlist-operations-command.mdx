...
This article compares the `clinic-appointment` `develop` source at `f783de85` with the waitlist delivery API contract as of 2026-08-15. These three layers must not be flattened into one claim.
