...
blog:
  ...
  cardDescription: A benchmark-backed walkthrough of the CSV parser optimization, from Reader parsing to Okio UnsafeCursor segment scanning.
---
...
<figure class="bt4k-architecture">
  ...
  <figcaption>A benchmark-backed walkthrough of the CSV parser optimization, from Reader parsing to Okio UnsafeCursor segment scanning.</figcaption>
</figure>
