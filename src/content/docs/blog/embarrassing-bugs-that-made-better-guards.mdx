...
<figure class="bt4k-architecture" data-diagram-title="The loop behind embarrassing bug fixes">
  <img src="/assets/embarrassing-bug-fix-loop-01-en.png" alt="Dark flow diagram showing mistake, signal, fix, and guard for embarrassing bug fixes" loading="lazy" />
