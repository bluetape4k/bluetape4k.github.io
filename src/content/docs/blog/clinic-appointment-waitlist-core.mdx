...
<figure class="bt4k-architecture" data-diagram-title="Connecting waitlist states to operations">
  ...
  <figcaption>State transitions become operational next steps on the screen. Metrics do not confirm an item automatically; staff review the current evidence and permitted command before recording the terminal outcome decision.</figcaption>
</figure>
