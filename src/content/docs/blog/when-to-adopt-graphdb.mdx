...
<figure class="bt4k-chart" data-diagram-title="Authorization inheritance latency comparison for GraphDB adoption">
  <img src="/assets/graphdb-adoption-latency-chart-en.png" alt="Large authorization inheritance benchmark chart comparing Neo4j Cypher, PostgreSQL CTE, and PostgreSQL iterative traversal for long-chain and deep-wide scenarios" loading="lazy" />
