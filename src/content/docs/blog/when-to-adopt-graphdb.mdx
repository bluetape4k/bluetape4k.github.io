...
<figure class="bt4k-architecture">
  <img src="/assets/graphdb-adoption-latency-chart-en.png" alt="Authorization inheritance benchmark chart comparing Neo4j, AGE, PostgreSQL recursive CTE, and PostgreSQL iterative traversal" loading="lazy" />
