...
blog:
  ...
  cardDescription: "The Okio CSV writer follow-up: Flow rows, UTF-8 sinks, behavior locks, and a 3.25x large export win."
  tags: ["kotlin"]
---
...
The writer optimization cleaned up that path.
...
<figure class="bt4k-chart" data-diagram-title="CSV writer throughput comparison">
  <img src="/assets/csv-okio-writer-throughput-01-en.png" alt="CSV writer throughput comparison chart showing existing Writer and Okio BufferedSink ops per second" loading="lazy" />
  <figcaption>The Okio CSV writer follow-up: Flow rows, UTF-8 sinks, behavior locks, and a 3.25x large export win.</figcaption>
</figure>
