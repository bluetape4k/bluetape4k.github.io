...
<figure class="bt4k-blog-hero">
  <img src="/assets/clinic-appointment-prologue-hero.png" alt="Small robotic builders connect a preferred visit date to a clinic proposal, resource allocation, consent, and appointment confirmation" loading="eager" />
...
This article established the boundary at which one visit time becomes confirmed. The next article returns to the original Part 1 question and looks at why clinic appointments must coordinate clinic-specific time, resources, and policies instead of stopping at CRUD.
