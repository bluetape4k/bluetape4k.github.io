---
title: "[Design 4] Why a Package Product Becomes an Execution Graph"
...
<ClinicAppointmentSeries current="clinic-appointment-package-product-execution-graph" locale="en" />
