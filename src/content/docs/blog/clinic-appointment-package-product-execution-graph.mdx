...
<figure class="bt4k-blog-hero">
  <img src="/assets/clinic-appointment-package-product-hero.png" alt="Small robotic builders connect package components, predecessor relationships, visit candidates, and resource requirements into one execution graph" loading="eager" />
