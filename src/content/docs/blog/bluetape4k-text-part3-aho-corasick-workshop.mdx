...
<figure class="bt4k-architecture" data-diagram-title="Aho-Corasick preparation and request-processing boundaries">
  <img src="/assets/bluetape4k-text-part3-aho-corasick-flow-01-en.png" alt="Keyword dictionaries are compiled into an immutable automaton, user text is scanned once, and matches are used for masking, alerts, or highlighting" loading="lazy" />
