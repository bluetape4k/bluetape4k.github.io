...
The useful comparison is therefore not feature count. It is which layer owns client creation, message
consumption, transfer behavior, and dependency selection.

<figure class="bt4k-architecture" data-diagram-title="Responsibility boundaries in Spring Cloud AWS and bluetape4k-aws">
...
Spring Cloud AWS is designed around Spring Cloud and Spring Boot applications. Its current compatibility table targets
...
<figure class="bt4k-architecture" data-diagram-title="Choosing an AWS integration boundary">
