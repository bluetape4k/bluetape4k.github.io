...
<figure class="bt4k-architecture">
  <img src="/assets/bluetape4k-exposed-part5-cache-read-chart-en.png" alt="Cache read throughput chart showing Caffeine around 490000 ops per second and Near Cache around 465000 ops per second versus No Cache around 8200" loading="lazy" />
...
<figure class="bt4k-architecture">
  <img src="/assets/bluetape4k-exposed-part5-cache-write-chart-en.png" alt="Cache write throughput chart showing Write Behind around 24000 ops per second versus No Cache around 8200 and Write Through around 5600" loading="lazy" />
