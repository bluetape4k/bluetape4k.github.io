---
title: "bluetape4k-dependencies 1.3.0 in Practice Part 2: Composing Services"
description: "Example-driven guidance for choosing Exposed, AWS, Leader, Text, and Image modules after importing the BOM in Spring Boot worker, Ktor API, and image upload services."
sidebar:
  order: -202606281200
blog:
