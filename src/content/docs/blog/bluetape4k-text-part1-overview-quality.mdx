...
<figure class="bt4k-architecture">
  <img src="/assets/bluetape4k-text-part1-pipeline-01-en.png" alt="Raw input moves through normalization, tokenizer and language detection modules, service decisions, and quality gates" loading="lazy" />
