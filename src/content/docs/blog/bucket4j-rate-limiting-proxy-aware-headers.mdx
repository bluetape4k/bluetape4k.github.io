...
<figure class="bt4k-architecture">
  <img src="/assets/bluetape4k-rate-limit-workshop-architecture-02.png" alt="Bucket4j rate-limit architecture diagram showing client, proxy, identity strategy, WebFilter, Redis or Caffeine bucket storage, handler, and 429 response path" loading="lazy" />
