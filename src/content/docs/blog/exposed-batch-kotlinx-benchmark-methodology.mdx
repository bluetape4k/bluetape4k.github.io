...
description: How the bluetape4k-exposed batch benchmarks moved from ad hoc timing to a repeatable kotlinx-benchmark/JMH setup with generated documentation.
sidebar:
  order: -202606282358
blog:
