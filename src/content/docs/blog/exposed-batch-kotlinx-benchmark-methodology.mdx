...
<figure class="bt4k-architecture">
  <img src="/assets/exposed-batch-kotlinx-benchmark-map-01.png" alt="Structure diagram connecting utils batch benchmark Gradle profiles, DB and driver classes, JSON reports, Markdown docs, and charts" loading="lazy" />
...
<figure class="bt4k-architecture">
  <img src="/assets/exposed-batch-kotlinx-benchmark-summary-01.png" alt="Database summary chart for the H2, PostgreSQL, and MySQL batch benchmarks" loading="lazy" />
...
<figure class="bt4k-architecture">
  <img src="/assets/exposed-batch-kotlinx-benchmark-postgresql-e2e-01.png" alt="PostgreSQL end-to-end batch benchmark chart comparing JDBC and R2DBC throughput by parallelism" loading="lazy" />
