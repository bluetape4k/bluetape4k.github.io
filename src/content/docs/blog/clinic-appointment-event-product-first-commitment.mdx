...
<figure class="bt4k-blog-hero">
  <img src="/assets/clinic-appointment-event-product-hero.png" alt="Small robot workers connecting catalog data, purchase documents, a reservation plan, candidate times, and a confirmed visit promise on one workbench" loading="eager" />
...
a product BOM and a reservation plan.
