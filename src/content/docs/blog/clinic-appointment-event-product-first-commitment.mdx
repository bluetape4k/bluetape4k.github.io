...
catalog source data, purchase source data, a reservation plan, and customer consent. The next article expands to an
N-visit product and examines how repeated `PlannedTreatment` items and multiple visit commitments preserve intervals
