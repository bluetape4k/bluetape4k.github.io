...
`dependencies 1.3.1` manages a tested combination such as `projects 1.11.0`, `exposed 1.11.0`, `aws 0.4.0`,
`image 0.3.0`, `text 0.2.1`, `graph 0.5.1`, `leader 0.4.0`, and `javers 0.2.1`. The application only chooses the BOM
version.
