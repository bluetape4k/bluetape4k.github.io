...
<figure class="bt4k-architecture" data-diagram-title="Kafka-first publication and durable fallback">
...
<figure class="bt4k-sequence" data-diagram-title="Kafka-first success and fallback sequence">
