...
<figure class="bt4k-architecture">
  <img src="/assets/transactional-outbox-kafka-first-fallback-part2-architecture-01.png" alt="Architecture diagram showing orders-only transaction, direct Kafka publish, fallback event_publications row, relay, and reconciler" loading="lazy" />
...
<figure class="bt4k-architecture">
  <img src="/assets/transactional-outbox-kafka-first-fallback-part2-sequence-01.png" alt="Sequence diagram between Client, Order API, Order Tx, Publisher, Outbox DB, and Relay/Reconciler for Kafka-first fallback" loading="lazy" />
