...
<figure class="bt4k-architecture">
  <img src="/assets/ocr-api-fallback-contract-workflow-01.png" alt="OCR service workflow diagram with vertical lanes for HTTP upload boundary, image preprocessing boundary, native OCR boundary, and response contract boundary" loading="lazy" />
