---
title: "When CIO Made HTTP Benchmarks Weird"
description: A benchmark-backed story of io/http HTTP client tuning, Vert.x pool fixes, and why the first Ktor CIO numbers were disappointing but useful.
sidebar:
  order: -202605290852
blog:
  ...
  cardDescription: How io/http turned disappointing Ktor CIO numbers into a fair benchmark, found a Vert.x pool bottleneck, and documented workload-based HTTP client choices.
---
