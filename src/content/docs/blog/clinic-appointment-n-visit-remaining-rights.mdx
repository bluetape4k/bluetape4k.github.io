...
An N-visit product repeats the same kind of care. The next article turns to a package product: how a product BOM becomes a
graph of treatments with different durations, dependencies, and possible visits, without flattening it into one
