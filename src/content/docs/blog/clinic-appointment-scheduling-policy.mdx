...
- [Clinic Appointment: Designing visit commitments instead of CRUD](/blog/clinic-appointment-prologue-product-to-appointment/)
- [Booking availability starts with a product-version purchase snapshot](/blog/clinic-appointment-product-version-purchase-snapshot/)
- [Why booking reliability matters more than booking success](/blog/clinic-appointment-booking-reliability/)
- [Why Every Clinic Has Different Booking Rules](/blog/clinic-appointment-scheduling-policy/)
- [A waitlist is a state machine, not a label](/blog/clinic-appointment-waitlist-core/)
- [Waitlist operations are an action queue, not exception handling](/blog/clinic-appointment-waitlist-operations-command/)
- [Waitlist operations dashboard: Put the operator's next action on one screen](/blog/clinic-appointment-waitlist-operations-dashboard/)
