...
<figure class="bt4k-architecture">
  <img src="/assets/bluetape4k-projects-part4-data-infra-map-en.png" alt="Service code connects to data, Redis/cache, messaging/infra, coroutine path, resilience, observability, and external systems" loading="lazy" />
