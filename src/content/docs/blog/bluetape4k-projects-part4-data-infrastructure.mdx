...
description: How JDBC, R2DBC, Hibernate, MongoDB, Redis, Kafka, NATS, Pulsar, observability, and resilience modules organize service-to-operations boundaries.
sidebar:
  order: -202605301633
blog:
...
<figure class="bt4k-blog-hero">
  ...
  <figcaption>Operational systems usually live outside the service. Their failures are very good at coming inside.</figcaption>
</figure>
...
Finally add retry, timeout, metrics, and tracing. Reverse the order and infrastructure will start dragging service design
around.
