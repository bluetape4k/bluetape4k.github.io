...
[ZXing](https://github.com/zxing/zxing) is an open-source barcode image-processing library implemented in Java that
decodes multiple 1D and 2D formats. The [`images-barcode-zxing` provider](https://github.com/bluetape4k/bluetape4k-image/blob/65c31d4/images-barcode-zxing/README.md)
...
<figure class="bt4k-architecture" data-diagram-title="From the ZXing adapter to visitor-pass policy">
  <img src="/assets/blog/image-intelligence/part5/image-intelligence-barcode-boundary-flow-01-en.png" alt="A flow diagram showing BarcodeReader crossing into the images-barcode-zxing adapter, ZXing becoming normalized BarcodeResult facts, four distinct analysis states, and VisitorPassPolicy choosing ALLOW, REJECT, or MANUAL_REVIEW" loading="lazy" />
  <figcaption>BarcodeReader returns a provider-neutral contract and the adapter keeps ZXing types inside its boundary. Policy interprets facts and states as actions; the application owns HTTP, storage, and rendering side effects.</figcaption>
</figure>
