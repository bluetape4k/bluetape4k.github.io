---
slug: "ko/manual/bluetape4k-image/1.0/modules/ktor-ocr-api"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/ko/modules/ktor-ocr-api.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[`bluetape4k-images-ocr`](/ko/manual/bluetape4k-image/1.0/modules/bluetape4k-images-ocr/)와 핵심 이미지 디코딩 기능을 사용합니다. [`spring-boot-ocr-api`](/ko/manual/bluetape4k-image/1.0/modules/spring-boot-ocr-api/)와 비교하면 OCR 도메인 경계는 유지한 채 프레임워크 연결 방식만 선택할 수 있습니다.
...
1. [`ktor-image-api`](/ko/manual/bluetape4k-image/1.0/modules/ktor-image-api/)에서 기본 multipart route를 익힙니다.
