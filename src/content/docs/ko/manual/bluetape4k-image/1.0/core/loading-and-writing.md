---
slug: "ko/manual/bluetape4k-image/1.0/core/loading-and-writing"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/ko/core/loading-and-writing.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[기본 이미지 처리 워크숍](/ko/manual/bluetape4k-image/1.0/modules/basic-processing/)에서 읽기-변환-쓰기 경로를 완성할 수 있다. 네이티브 I/O와 비교하기 전에는 [Vips API](/ko/manual/bluetape4k-image/1.0/native/vips-api/)를 읽는다.
