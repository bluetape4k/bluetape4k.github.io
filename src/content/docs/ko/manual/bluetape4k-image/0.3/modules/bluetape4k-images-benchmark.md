---
slug: "ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images-benchmark"
...
[`bluetape4k-images`](/ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images/)를 특정 바인딩에 종속되지 않는 [`vips API`](/ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images-vips-api/), [Java 21 JNI](/ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images-vips-java21/), [Java 25 FFM](/ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images-vips-java25/) 런타임과 비교합니다.
...
0.3.0의 macOS arm64, GraalVM Java 25.0.3 실행에서 libvips `Path` 전체 처리 시간은 `large-photo` 7.13 ms/op, `ocr-document` 5.47 ms/op였고 Scrimage `Path`는 각각 223.19, 145.13 ms/op였습니다. 이 값은 해당 환경에서 얻은 비교 결과일 뿐 보편적인 순위가 아닙니다. suspend 경계는 지연 시간과 여러 파일의 처리량 모두 더 느렸으므로 성능 최적화가 아니라 자원 수명 관리와 연동을 위한 API로 설명해야 합니다.
...
1. [`basic-processing`](/ko/manual/bluetape4k-image/0.3/modules/basic-processing/)으로 사용자가 보는 이미지 작업을 익힙니다.
...
[![images benchmark 아키텍처](/manual-assets/bluetape4k-image/0.3/readme-diagrams/images-benchmark-architecture-01.png)](../../assets/readme-diagrams/images-benchmark-architecture-01.svg)
...
- [자연 사진 결과](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/benchmark/images-benchmark/docs/benchmark-results-2026-05-28-natural-photos.md)
...
- [파일 IO throughput](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/benchmark/images-benchmark/docs/file-io-throughput-2026-05-29.md)
...
- [Gradle 빌드 파일](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/benchmark/images-benchmark/build.gradle.kts)
