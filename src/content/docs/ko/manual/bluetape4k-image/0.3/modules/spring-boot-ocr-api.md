---
slug: "ko/manual/bluetape4k-image/0.3/modules/spring-boot-ocr-api"
...
[`bluetape4k-images-ocr`](/ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images-ocr/)와 핵심 이미지 디코딩 기능을 사용합니다. [`spring-boot-image-api`](/ko/manual/bluetape4k-image/0.3/modules/spring-boot-image-api/)와 합칠 때는 OCR을 영구 저장소에 넣기 전과 후 중 어느 시점에 실행할지 먼저 결정하세요.
...
4. [`ktor-ocr-api`](/ko/manual/bluetape4k-image/0.3/modules/ktor-ocr-api/)와 비교해 멀티파트 스트리밍 구현을 살펴봅니다.
...
- [0.3.0 README](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/examples/spring-boot-ocr-api/README.ko.md)
- [애플리케이션 소스](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/examples/spring-boot-ocr-api/src/main/kotlin/io/bluetape4k/images/examples/spring/ocr/SpringBootOcrApiApplication.kt)
- [통합 테스트](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/examples/spring-boot-ocr-api/src/test/kotlin/io/bluetape4k/images/examples/spring/ocr/SpringBootOcrApiApplicationTest.kt)
- [Gradle 빌드 파일](https://github.com/bluetape4k/bluetape4k-image/blob/0.3.0/examples/spring-boot-ocr-api/build.gradle.kts)
