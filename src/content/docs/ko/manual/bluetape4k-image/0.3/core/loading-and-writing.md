---
slug: "ko/manual/bluetape4k-image/0.3/core/loading-and-writing"
...
manual:
  ...
  sourcePath: "docs/manual/ko/core/loading-and-writing.md"
  minorVersion: "0.3"
  releaseRef: "0.3.0"
...
[기본 이미지 처리 워크숍](/ko/manual/bluetape4k-image/0.3/modules/basic-processing/)에서 읽기-변환-쓰기 경로를 완성할 수 있다. 네이티브 I/O와 비교하기 전에는 [Vips API](/ko/manual/bluetape4k-image/0.3/native/vips-api/)를 읽는다.

## 근거 소스

- [로드와 작성기 지원](https://github.com/bluetape4k/bluetape4k-image/blob/a571c30004f571fe8cfcddc29670c1404d212ec6/images/src/main/kotlin/io/bluetape4k/images/ImmutableImageSupport.kt)
- [핵심 모듈 안내](https://github.com/bluetape4k/bluetape4k-image/blob/a571c30004f571fe8cfcddc29670c1404d212ec6/images/README.ko.md)
