---
slug: "ko/manual/bluetape4k-image/0.3/core/immutable-image-model"
...
manual:
  ...
  sourcePath: "docs/manual/ko/core/immutable-image-model.md"
  minorVersion: "0.3"
  releaseRef: "0.3.0"
...
바이트 배열, 스트림, Okio 소스, 파일, 경로는 <code>immutableImageOf</code> 오버로드로 읽는다. 디코딩 진입점을 한곳에 모으고 호출자가 같은 이미지 타입을 사용하게 해 준다. I/O 소유권은 [로드와 저장](/ko/manual/bluetape4k-image/0.3/core/loading-and-writing/)에서 다룬다.
...
- [ImmutableImage factory](https://github.com/bluetape4k/bluetape4k-image/blob/a571c30004f571fe8cfcddc29670c1404d212ec6/images/src/main/kotlin/io/bluetape4k/images/ImmutableImageSupport.kt)
- [모듈 문서](/ko/manual/bluetape4k-image/0.3/modules/bluetape4k-images/)
