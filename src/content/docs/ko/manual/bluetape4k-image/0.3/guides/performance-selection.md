---
slug: "ko/manual/bluetape4k-image/0.3/guides/performance-selection"
...
Java 25 FFM 결과를 Java 21 JNI에 그대로 적용하거나 자연 사진 결과를 문서와 alpha가 많은 그래픽에 확대 해석하면 안 된다. [벤치마크 결과 해석](/ko/manual/bluetape4k-image/0.3/benchmarks/interpreting-results/)에서 보고서 읽는 법을 이어서 설명한다.
