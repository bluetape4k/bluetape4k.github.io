---
slug: "ko/manual/bluetape4k-image/0.4/architecture/runtime-boundaries"
...
![디코딩, 변환, 인코딩과 네이티브 처리 단계의 자원 소유권](/manual-assets/bluetape4k-image/0.4/architecture/processing-lifecycle.svg)
...
Java 21 구현은 JVips/JNI와 시스템 libvips가 필요하다. Java 25 구현은 JDK 25, 시스템 libvips와 <code>--enable-native-access=ALL-UNNAMED</code>이 필요하다. 자세한 내용은 [native 자원 수명 주기](/ko/manual/bluetape4k-image/0.4/guides/native-resource-lifecycle/)를 참고한다.
