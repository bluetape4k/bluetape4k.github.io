---
slug: "ko/manual/bluetape4k-image/0.4/core/immutable-image-model"
...
바이트 배열, 스트림, Okio 소스, 파일, 경로는 <code>immutableImageOf</code> 오버로드로 읽는다. 디코딩 진입점을 한곳에 모으고 호출자가 같은 이미지 타입을 사용하게 해 준다. I/O 소유권은 [로드와 저장](/ko/manual/bluetape4k-image/0.4/core/loading-and-writing/)에서 다룬다.
...
- [모듈 문서](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images/)
