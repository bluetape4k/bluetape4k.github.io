---
slug: "ko/manual/bluetape4k-image/0.4/modules/spring-boot-ocr-api"
...
[`bluetape4k-images-ocr`](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images-ocr/)와 핵심 이미지 디코딩 기능을 사용합니다. [`spring-boot-image-api`](/ko/manual/bluetape4k-image/0.4/modules/spring-boot-image-api/)와 합칠 때는 OCR을 영구 저장소에 넣기 전과 후 중 어느 시점에 실행할지 먼저 결정하세요.
...
4. [`ktor-ocr-api`](/ko/manual/bluetape4k-image/0.4/modules/ktor-ocr-api/)와 비교해 멀티파트 스트리밍 구현을 살펴봅니다.
