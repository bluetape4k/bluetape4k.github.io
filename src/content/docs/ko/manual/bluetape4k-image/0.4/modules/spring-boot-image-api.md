---
slug: "ko/manual/bluetape4k-image/0.4/modules/spring-boot-image-api"
...
[`bluetape4k-images-spring-boot`](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images-spring-boot/)와 [`bluetape4k-images`](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images/)를 조합합니다. 운영 백엔드로 전환하기 전에 버킷 소유권, 자격 증명, URL, 보존, CDN 정책을 먼저 결정하세요.
...
1. [`basic-processing`](/ko/manual/bluetape4k-image/0.4/modules/basic-processing/)에서 transform을 먼저 익힙니다.
2. 이 워크숍을 실행해 저장소 디렉터리와 두 다운로드를 확인합니다.
3. Spring Boot 저장소 모듈 매뉴얼을 읽습니다.
4. OCR이 필요하면 [`spring-boot-ocr-api`](/ko/manual/bluetape4k-image/0.4/modules/spring-boot-ocr-api/)로 이어가고, S3/CDN은 더 큰 workshop에서 다룹니다.
