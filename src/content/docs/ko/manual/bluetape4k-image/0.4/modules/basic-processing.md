---
slug: "ko/manual/bluetape4k-image/0.4/modules/basic-processing"
...
2. [`bluetape4k-images`](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images/)에서 이미지 읽기, 변환, 작성 API를 익힙니다.
3. [`spring-boot-image-api`](/ko/manual/bluetape4k-image/0.4/modules/spring-boot-image-api/) 또는 [`ktor-image-api`](/ko/manual/bluetape4k-image/0.4/modules/ktor-image-api/)로 HTTP 연동을 배웁니다.
4. 운영 작업을 libvips로 옮기기 전 [이미지 벤치마크](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images-benchmark/)를 확인합니다.
