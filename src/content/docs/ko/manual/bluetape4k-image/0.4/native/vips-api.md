---
slug: "ko/manual/bluetape4k-image/0.4/native/vips-api"
manualId: "vips-api"
...
모든 이미지는 닫아야 한다. <code>VipsImage</code>를 반환하는 연산은 새 네이티브 객체의 소유권을 호출자에게 넘긴다. [Native 자원 수명 주기](/ko/manual/bluetape4k-image/0.4/guides/native-resource-lifecycle/)를 함께 읽는다.
