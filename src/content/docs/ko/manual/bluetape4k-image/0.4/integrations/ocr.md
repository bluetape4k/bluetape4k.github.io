---
slug: "ko/manual/bluetape4k-image/0.4/integrations/ocr"
...
![웹 업로드 검증에서 이미지 전처리, 문자 인식과 응답으로 이어지는 OCR 요청 흐름](/manual-assets/bluetape4k-image/0.4/integrations/ocr-web-flow.svg)
...
[OCR 설정](/ko/manual/bluetape4k-image/0.4/guides/ocr-setup/)을 먼저 끝낸다. 이후 [Ktor OCR](/ko/manual/bluetape4k-image/0.4/modules/ktor-ocr-api/)이나 [Spring Boot OCR](/ko/manual/bluetape4k-image/0.4/modules/spring-boot-ocr-api/) 워크숍을 실행하고 애플리케이션 코드와 테스트를 함께 읽는다.
...
- [OCR 모듈 문서](/ko/manual/bluetape4k-image/0.4/modules/bluetape4k-images-ocr/)
