---
slug: "ko/manual/bluetape4k-image/0.4/integrations/storage-and-cdn"
...
[Spring Boot 이미지 API 워크숍](/ko/manual/bluetape4k-image/0.4/modules/spring-boot-image-api/)은 로컬 저장소로 시작한다. 같은 저장소 계약과 실패 동작을 검증한 뒤 S3로 확장한다.
