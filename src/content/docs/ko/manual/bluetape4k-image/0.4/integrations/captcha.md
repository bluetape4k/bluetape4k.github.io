---
slug: "ko/manual/bluetape4k-image/0.4/integrations/captcha"
manualId: "captcha"
...
[Ktor 연동](/ko/manual/bluetape4k-image/0.4/integrations/ktor/)은 발급과 검증 라우트 도우미를 제공한다. [Ktor 이미지 API 워크숍](/ko/manual/bluetape4k-image/0.4/modules/ktor-image-api/)에서 전체 흐름을 확인할 수 있다. 다른 프레임워크는 생성기, 저장소와 서비스를 직접 쓰면 된다.
