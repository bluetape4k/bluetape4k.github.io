---
slug: "ko/manual/bluetape4k-leader/0.4/modules/k8s-operator"
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/k8s-operator/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/k8s-operator/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/k8s-operator/src/main/kotlin/io/bluetape4k/leader/examples/k8soperator/OperatorController.kt)
- [데모 진입점](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/k8s-operator/src/main/kotlin/io/bluetape4k/leader/examples/k8soperator/K8sOperatorApp.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/k8s-operator/src/test/kotlin/io/bluetape4k/leader/examples/k8soperator/OperatorControllerTest.kt)
