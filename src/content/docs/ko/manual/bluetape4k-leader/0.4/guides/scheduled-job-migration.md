---
slug: "ko/manual/bluetape4k-leader/0.4/guides/scheduled-job-migration"
title: "스케줄 작업 마이그레이션"
...
- [`examples/batch-scheduler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/batch-scheduler/README.ko.md)
- [`examples/migration-gate/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/migration-gate/README.ko.md)
- [`examples/ktor-app/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/ktor-app/README.ko.md)

## 이어서 읽기

- [Bluetape4k Leader 매뉴얼](/ko/manual/bluetape4k-leader/0.4/)
- [리스 수명 주기](/ko/manual/bluetape4k-leader/0.4/guides/lease-lifecycle/)
