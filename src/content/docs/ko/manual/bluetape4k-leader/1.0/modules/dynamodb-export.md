---
slug: "ko/manual/bluetape4k-leader/1.0/modules/dynamodb-export"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/modules/dynamodb-export.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> 실행 가능한 안정판 워크숍 · DynamoDB 조건부 쓰기 · `1.0.0` 소스 기준
...
3. `DynamoDbScheduledExportRunnerTest`에서 1.0.0 안정판이 보장하는 소유권 전이를 확인합니다.
...
_배포본 README: [`examples/dynamodb-export/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/dynamodb-export/README.ko.md)_
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/src/main/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbScheduledExportRunner.kt)
- [데모 진입점](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/src/main/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbExportDemo.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/src/test/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbScheduledExportRunnerTest.kt)
