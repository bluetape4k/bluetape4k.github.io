---
slug: "ko/manual/bluetape4k-leader/1.0/modules/consul-maintenance"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/modules/consul-maintenance.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/src/main/kotlin/io/bluetape4k/leader/examples/consulmaintenance/ServiceMaintenanceCoordinator.kt)
- [데모 진입점](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/src/main/kotlin/io/bluetape4k/leader/examples/consulmaintenance/ConsulMaintenanceDemo.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/src/test/kotlin/io/bluetape4k/leader/examples/consulmaintenance/ServiceMaintenanceCoordinatorTest.kt)
