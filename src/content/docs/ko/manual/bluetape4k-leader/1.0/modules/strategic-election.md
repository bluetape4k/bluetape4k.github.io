---
slug: "ko/manual/bluetape4k-leader/1.0/modules/strategic-election"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/modules/strategic-election.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> 실행 가능한 안정판 워크숍 · 백엔드와 무관한 로컬 전략 선출 · `1.0.0` 소스 기준
...
3. `StrategicElectionDemoTest`에서 1.0.0 안정판이 보장하는 소유권 전이를 확인합니다.
...
_배포본 README: [`examples/strategic-election/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/strategic-election/README.ko.md)_
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/strategic-election/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/strategic-election/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/strategic-election/src/main/kotlin/io/bluetape4k/leader/examples/strategy/StrategicElectionDemo.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/strategic-election/src/test/kotlin/io/bluetape4k/leader/examples/strategy/StrategicElectionDemoTest.kt)
