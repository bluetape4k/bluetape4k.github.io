---
slug: "ko/manual/bluetape4k-leader/1.0/modules/etcd-reconciler"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/modules/etcd-reconciler.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> 실행 가능한 안정판 워크숍 · etcd v3 리스와 락 · `1.0.0` 소스 기준
...
3. `ControlPlaneReconcilerTest`에서 1.0.0 안정판이 보장하는 소유권 전이를 확인합니다.
...
_배포본 README: [`examples/etcd-reconciler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/etcd-reconciler/README.ko.md)_
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconciler.kt)
- [데모 진입점](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/EtcdReconcilerDemo.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/src/test/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconcilerTest.kt)
