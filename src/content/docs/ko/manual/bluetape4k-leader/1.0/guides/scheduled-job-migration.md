---
slug: "ko/manual/bluetape4k-leader/1.0/guides/scheduled-job-migration"
title: "스케줄 작업 마이그레이션"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/guides/scheduled-job-migration.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
  releaseCommit: "e70146330302758f563a46b7286e3ce25f1bac49"
...
- [`examples/batch-scheduler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/batch-scheduler/README.ko.md)
- [`examples/migration-gate/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/migration-gate/README.ko.md)
- [`examples/ktor-app/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/ktor-app/README.ko.md)

## 이어서 읽기

- [Bluetape4k Leader 매뉴얼](/ko/manual/bluetape4k-leader/1.0/)
- [리스 수명 주기](/ko/manual/bluetape4k-leader/1.0/guides/lease-lifecycle/)
