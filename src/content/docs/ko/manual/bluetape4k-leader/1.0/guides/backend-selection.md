---
slug: "ko/manual/bluetape4k-leader/1.0/guides/backend-selection"
title: "백엔드 선택"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/guides/backend-selection.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
  releaseCommit: "e70146330302758f563a46b7286e3ce25f1bac49"
...
![Leader 백엔드 선택 지도](/manual-assets/bluetape4k-leader/1.0/backends/backend-selection-map.png)
...
- [`benchmark/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/benchmark/README.ko.md)
...
- [Redis 백엔드](/ko/manual/bluetape4k-leader/1.0/backends/redis/)
- [etcd, Consul, Kubernetes Lease](/ko/manual/bluetape4k-leader/1.0/backends/control-plane-leases/)
