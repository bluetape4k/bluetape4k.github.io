---
slug: "ko/manual/bluetape4k-leader/1.0/guides/spring-vs-ktor"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/guides/spring-vs-ktor.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
  releaseCommit: "e70146330302758f563a46b7286e3ce25f1bac49"
...
![프레임워크와 관측 흐름의 소유권 경계](/manual-assets/bluetape4k-leader/1.0/frameworks/framework-observability-flow.png)
...
- [`leader-ktor/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/leader-ktor/README.ko.md)
...
- [Spring Boot 연동](/ko/manual/bluetape4k-leader/1.0/frameworks/spring-boot/)
- [Ktor 연동](/ko/manual/bluetape4k-leader/1.0/frameworks/ktor/)
- [스케줄 작업 마이그레이션](/ko/manual/bluetape4k-leader/1.0/guides/scheduled-job-migration/)
