---
slug: "ko/manual/bluetape4k-leader/1.0/guides/election-model-selection"
title: "선출 모델 선택"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/ko/guides/election-model-selection.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
  releaseCommit: "e70146330302758f563a46b7286e3ce25f1bac49"
...
![선출 모델과 실행 API 선택 지도](/manual-assets/bluetape4k-leader/1.0/architecture/model-decision-map.png)
...
- [단일·그룹·전략 선출 계약](/ko/manual/bluetape4k-leader/1.0/core/single-group-strategic/)
- [실행 API 선택](/ko/manual/bluetape4k-leader/1.0/guides/execution-model-selection/)
