---
slug: "ko/manual/bluetape4k-leader/0.5/guides/backend-selection"
title: "백엔드 선택"
...
![Leader 백엔드 선택 지도](/manual-assets/bluetape4k-leader/0.5/backends/backend-selection-map.png)
...
- [`benchmark/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/benchmark/README.ko.md)
...
- [Redis 백엔드](/ko/manual/bluetape4k-leader/0.5/backends/redis/)
- [etcd, Consul, Kubernetes Lease](/ko/manual/bluetape4k-leader/0.5/backends/control-plane-leases/)
