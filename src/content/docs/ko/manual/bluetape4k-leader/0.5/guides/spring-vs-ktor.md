---
slug: "ko/manual/bluetape4k-leader/0.5/guides/spring-vs-ktor"
...
![프레임워크와 관측 흐름의 소유권 경계](/manual-assets/bluetape4k-leader/0.5/frameworks/framework-observability-flow.png)
...
- [`leader-ktor/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/leader-ktor/README.ko.md)
...
- [Spring Boot 연동](/ko/manual/bluetape4k-leader/0.5/frameworks/spring-boot/)
- [Ktor 연동](/ko/manual/bluetape4k-leader/0.5/frameworks/ktor/)
- [스케줄 작업 마이그레이션](/ko/manual/bluetape4k-leader/0.5/guides/scheduled-job-migration/)
