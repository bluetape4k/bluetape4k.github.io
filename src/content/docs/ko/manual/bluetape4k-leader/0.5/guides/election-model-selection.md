---
slug: "ko/manual/bluetape4k-leader/0.5/guides/election-model-selection"
title: "선출 모델 선택"
...
![선출 모델과 실행 API 선택 지도](/manual-assets/bluetape4k-leader/0.5/architecture/model-decision-map.png)
...
- [단일·그룹·전략 선출 계약](/ko/manual/bluetape4k-leader/0.5/core/single-group-strategic/)
