---
slug: "ko/manual/bluetape4k-leader/0.5/guides/scheduled-job-migration"
title: "스케줄 작업 마이그레이션"
...
manual:
  ...
  sourcePath: "docs/manual/ko/guides/scheduled-job-migration.md"
  minorVersion: "0.5"
  releaseRef: "0.5.0"
  releaseCommit: "721a9a3808f67489d2bdb8177734325981c24977"
...
- [`examples/batch-scheduler/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/batch-scheduler/README.ko.md)
- [`examples/migration-gate/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/migration-gate/README.ko.md)
- [`examples/ktor-app/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/ktor-app/README.ko.md)

## 이어서 읽기

- [Bluetape4k Leader 매뉴얼](/ko/manual/bluetape4k-leader/0.5/)
- [리스 수명 주기](/ko/manual/bluetape4k-leader/0.5/guides/lease-lifecycle/)
- [Spring Boot와 Ktor 선택](/ko/manual/bluetape4k-leader/0.5/guides/spring-vs-ktor/)
- [리더 선출 테스트](/ko/manual/bluetape4k-leader/0.5/guides/testing/)
