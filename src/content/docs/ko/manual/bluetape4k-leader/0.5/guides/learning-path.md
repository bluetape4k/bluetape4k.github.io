---
slug: "ko/manual/bluetape4k-leader/0.5/guides/learning-path"
title: "학습 경로"
...
- [`examples/prometheus-dashboard/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/prometheus-dashboard/README.ko.md)

## 이어서 읽기

- [Bluetape4k Leader 매뉴얼](/ko/manual/bluetape4k-leader/0.5/)
- [선출 모델 선택](/ko/manual/bluetape4k-leader/0.5/guides/election-model-selection/)
