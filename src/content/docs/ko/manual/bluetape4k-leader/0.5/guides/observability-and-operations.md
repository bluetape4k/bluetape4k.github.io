---
slug: "ko/manual/bluetape4k-leader/0.5/guides/observability-and-operations"
title: "관측과 운영"
...
- [`leader-micrometer/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/leader-micrometer/README.ko.md)
...
- [식별자, 상태, 이력](/ko/manual/bluetape4k-leader/0.5/guides/identity-state-and-history/)
