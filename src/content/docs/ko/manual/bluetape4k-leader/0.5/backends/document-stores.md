---
slug: "ko/manual/bluetape4k-leader/0.5/backends/document-stores"
...
- [`leader-mongodb/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/leader-mongodb/README.ko.md)
- [`leader-dynamodb/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/leader-dynamodb/README.ko.md)
- [`examples/dynamodb-export/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/dynamodb-export/README.ko.md)

## 이어서 읽기

- [Bluetape4k Leader 매뉴얼](/ko/manual/bluetape4k-leader/0.5/)
- [백엔드 선택](/ko/manual/bluetape4k-leader/0.5/guides/backend-selection/)
