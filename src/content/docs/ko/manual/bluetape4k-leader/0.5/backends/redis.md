---
slug: "ko/manual/bluetape4k-leader/0.5/backends/redis"
title: "Redis 백엔드"
...
manual:
  ...
  sourcePath: "docs/manual/ko/backends/redis.md"
  minorVersion: "0.5"
  releaseRef: "0.5.0"
  releaseCommit: "721a9a3808f67489d2bdb8177734325981c24977"
...
- [`leader-redis-lettuce/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/leader-redis-lettuce/README.ko.md)
- [`leader-redis-redisson/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/leader-redis-redisson/README.ko.md)
...
- [리스 연장](/ko/manual/bluetape4k-leader/0.5/core/lease-extension/)
