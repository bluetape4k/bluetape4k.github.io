---
slug: "ko/manual/bluetape4k-leader/0.5/modules/virtual-thread-runner"
...
> 실행 가능한 안정판 워크숍 · local 선출과 Java virtual thread · `0.5.0` 소스 기준
...
3. `VirtualThreadLeaderRunnerTest`에서 0.5.0 안정판이 보장하는 소유권 전이를 확인합니다.
...
_배포본 README: [`examples/virtual-thread-runner/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/virtual-thread-runner/README.ko.md)_
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/virtual-thread-runner/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/virtual-thread-runner/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/virtual-thread-runner/src/main/kotlin/io/bluetape4k/leader/examples/virtualthread/VirtualThreadLeaderRunner.kt)
- [데모 진입점](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/virtual-thread-runner/src/main/kotlin/io/bluetape4k/leader/examples/virtualthread/VirtualThreadRunnerDemo.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/virtual-thread-runner/src/test/kotlin/io/bluetape4k/leader/examples/virtualthread/VirtualThreadLeaderRunnerTest.kt)
