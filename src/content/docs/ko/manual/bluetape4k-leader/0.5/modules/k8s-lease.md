---
slug: "ko/manual/bluetape4k-leader/0.5/modules/k8s-lease"
manualId: "k8s-lease"
id: "k8s-lease"
...
> 실행 가능한 안정판 워크숍 · Kubernetes `coordination.k8s.io/v1` Lease · `0.5.0` 소스 기준
...
3. `K8sLeaseLeaderElectionExampleTest`에서 0.5.0 안정판이 보장하는 소유권 전이를 확인합니다.
...
_배포본 README: [`examples/k8s-lease/README.ko.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/k8s-lease/README.ko.md)_
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/src/main/kotlin/io/bluetape4k/leader/examples/k8slease/K8sLeaseLeaderElectionExample.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/src/test/kotlin/io/bluetape4k/leader/examples/k8slease/K8sLeaseLeaderElectionExampleTest.kt)
