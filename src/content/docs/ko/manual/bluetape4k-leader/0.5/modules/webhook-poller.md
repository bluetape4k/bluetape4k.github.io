---
slug: "ko/manual/bluetape4k-leader/0.5/modules/webhook-poller"
...
- [안정판 예제 README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/webhook-poller/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/webhook-poller/build.gradle.kts)
- [주요 구현](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/webhook-poller/src/main/kotlin/io/bluetape4k/leader/examples/webhook/WebhookPoller.kt)
- [데모 진입점](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/webhook-poller/src/main/kotlin/io/bluetape4k/leader/examples/webhook/WebhookPollerDemo.kt)
- [검증 테스트](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/webhook-poller/src/test/kotlin/io/bluetape4k/leader/examples/webhook/WebhookPollerTest.kt)
