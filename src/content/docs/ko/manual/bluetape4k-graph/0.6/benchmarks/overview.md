---
slug: "ko/manual/bluetape4k-graph/0.6/benchmarks/overview"
...
[그래프 연산](/ko/manual/bluetape4k-graph/0.6/benchmarks/graph-operations/), [그래프 입출력](/ko/manual/bluetape4k-graph/0.6/benchmarks/graph-io/), [AGE와 Neo4j](/ko/manual/bluetape4k-graph/0.6/benchmarks/age-and-neo4j/)로 이어가십시오. 벤치마크 프로젝트는 배포 라이브러리가 아니라 릴리스 고정 데이터입니다. 소비자 애플리케이션에서는 `bluetape4k-dependencies:<ecosystem-version>`을 선택하고 필요한 그래프 모듈은 개별 버전 없이 추가합니다.
