---
slug: "ko/manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-bom"
...
[저장소 구성](/ko/manual/bluetape4k-graph/0.6/architecture/repository-map/), [시작하기](/ko/manual/bluetape4k-graph/0.6/getting-started/), 실제로 선택한 모듈 문서를 이어서 읽는다. 이 페이지는 독립 그래프 버전을 추천하지 않으며, 데이터베이스 운영 호환성도 보장하지 않는다.
