---
slug: "ko/manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-falkordb"
...
[FalkorDB](/ko/manual/bluetape4k-graph/0.6/backends/falkordb/), [구현 선택](/ko/manual/bluetape4k-graph/0.6/backends/selection-guide/), [운영](/ko/manual/bluetape4k-graph/0.6/guides/operations/)을 참고한다. 이 모듈은 FalkorDB를 설치하거나 숨은 트랜잭션 대안을 제공하지 않는다.
