---
slug: "ko/manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-io-jackson2"
...
[파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/0.6/graph-io/formats/), [실행 방식](/ko/manual/bluetape4k-graph/0.6/graph-io/execution-model/), [Jackson 3 모듈](/ko/manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-io-jackson3/)을 참고한다. 이 모듈은 임의 mapper 설정을 변환하거나 파일 전체를 하나의 트랜잭션으로 만들지 않는다.
