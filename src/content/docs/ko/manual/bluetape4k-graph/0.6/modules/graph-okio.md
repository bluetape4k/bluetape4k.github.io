---
slug: "ko/manual/bluetape4k-graph/0.6/modules/graph-okio"
title: "graph-okio"
manual:
...
[OkIO 보안](/ko/manual/bluetape4k-graph/0.6/graph-io/okio-security/), [파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/0.6/graph-io/formats/), [운영](/ko/manual/bluetape4k-graph/0.6/guides/operations/)을 참고한다. 이 모듈은 key를 관리하거나 암호화된 CSV 묶음 형식을 정의하지 않는다.
