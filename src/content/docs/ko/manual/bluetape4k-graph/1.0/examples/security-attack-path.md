---
slug: "ko/manual/bluetape4k-graph/1.0/examples/security-attack-path"
title: "보안 공격 경로"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/examples/security-attack-path.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
공격 경로에 있는 exploit, 신뢰, 권한 상승, 차단 전이를 눈에 보이게 만듭니다. **TinkerGraph**를 써서 컨테이너와 네트워크 편차를 빼고 모델부터 검증합니다. 먼저 [핵심 모델](/ko/manual/bluetape4k-graph/1.0/architecture/core-model/)과 [TinkerPop](/ko/manual/bluetape4k-graph/1.0/backends/tinkerpop/)을 읽고, 운영 전에는 [선택 가이드](/ko/manual/bluetape4k-graph/1.0/backends/selection-guide/)를 적용합니다.
...
[fraud-detection](/ko/manual/bluetape4k-graph/1.0/examples/fraud-detection/) 다음에 읽고 [network-topology](/ko/manual/bluetape4k-graph/1.0/examples/network-topology/)로 이어가십시오. [동기·코루틴 API](/ko/manual/bluetape4k-graph/1.0/architecture/paired-apis/), [테스트](/ko/manual/bluetape4k-graph/1.0/guides/testing/), [운영](/ko/manual/bluetape4k-graph/1.0/guides/operations/)도 함께 보십시오.
