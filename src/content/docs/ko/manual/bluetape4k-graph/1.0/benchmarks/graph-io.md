---
slug: "ko/manual/bluetape4k-graph/1.0/benchmarks/graph-io"
title: "그래프 입출력 벤치마크"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/benchmarks/graph-io.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
가져온 정점·간선 수가 다르면 지연 시간보다 정확성 실패를 먼저 고쳐야 합니다. 이 결과는 원격 데이터베이스 처리량, 대규모 그래프 메모리 한계, 암호화 저장소, 장애 복구를 증명하지 않습니다. [graph-io 실행 방식](/ko/manual/bluetape4k-graph/1.0/graph-io/execution-model/)과 [개요](/ko/manual/bluetape4k-graph/1.0/benchmarks/overview/)를 보십시오.
