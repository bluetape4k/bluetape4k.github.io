---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-spring-boot"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-spring-boot.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[Spring Boot 연동](/ko/manual/bluetape4k-graph/1.0/frameworks/spring-boot/), [구현 선택](/ko/manual/bluetape4k-graph/1.0/backends/selection-guide/), [테스트](/ko/manual/bluetape4k-graph/1.0/guides/testing/)를 참고한다. 이 모듈은 그래프 서버를 설치하거나 여러 그래프를 자동으로 조정하지 않으며 사용자 bean을 덮어쓰지 않는다.
