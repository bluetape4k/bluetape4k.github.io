---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-memgraph"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-memgraph.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[Neo4j와 Memgraph](/ko/manual/bluetape4k-graph/1.0/backends/neo4j-and-memgraph/), [구현 선택](/ko/manual/bluetape4k-graph/1.0/backends/selection-guide/), [실패와 취소](/ko/manual/bluetape4k-graph/1.0/guides/failure-and-cancellation/)를 참고한다. 이 모듈은 Memgraph를 Neo4j의 일률적인 상위 집합으로 만들지 않는다.
