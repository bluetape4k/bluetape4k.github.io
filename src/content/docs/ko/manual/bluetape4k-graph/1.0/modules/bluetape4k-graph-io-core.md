---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-core"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-io-core.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[실행 방식](/ko/manual/bluetape4k-graph/1.0/graph-io/execution-model/), [파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/1.0/graph-io/formats/), [실패와 취소](/ko/manual/bluetape4k-graph/1.0/guides/failure-and-cancellation/)를 참고한다. core는 파일 형식을 정하거나 이미 기록한 batch를 rollback하지 않는다.
