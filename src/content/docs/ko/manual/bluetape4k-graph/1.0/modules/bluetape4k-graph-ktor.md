---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-ktor"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-ktor.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[Ktor 연동](/ko/manual/bluetape4k-graph/1.0/frameworks/ktor/), [짝을 이루는 API](/ko/manual/bluetape4k-graph/1.0/architecture/paired-apis/), [운영](/ko/manual/bluetape4k-graph/1.0/guides/operations/)을 참고한다. 플러그인은 요청 트랜잭션을 만들거나 호출자 자원을 기본으로 닫지 않는다.
