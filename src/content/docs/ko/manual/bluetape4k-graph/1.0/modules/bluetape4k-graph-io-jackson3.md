---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-jackson3"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-io-jackson3.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/1.0/graph-io/formats/), [실행 방식](/ko/manual/bluetape4k-graph/1.0/graph-io/execution-model/), [Jackson 2 모듈](/ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-jackson2/)을 참고한다. 이 모듈은 사용자 mapper의 의미까지 같다고 보장하거나 import를 원자적으로 만들지 않는다.
