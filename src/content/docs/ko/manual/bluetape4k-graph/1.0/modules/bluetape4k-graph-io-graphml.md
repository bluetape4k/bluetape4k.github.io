---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-graphml"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-io-graphml.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/1.0/graph-io/formats/), [OkIO 보안](/ko/manual/bluetape4k-graph/1.0/graph-io/okio-security/), [실패와 취소](/ko/manual/bluetape4k-graph/1.0/guides/failure-and-cancellation/)를 참고한다. 이 모듈은 모든 GraphML 확장을 보존하거나 무방향 edge를 임의로 두 개 만들지 않는다.
