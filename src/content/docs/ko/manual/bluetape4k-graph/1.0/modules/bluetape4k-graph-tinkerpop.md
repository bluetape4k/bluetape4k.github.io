---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-tinkerpop"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-tinkerpop.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[TinkerPop](/ko/manual/bluetape4k-graph/1.0/backends/tinkerpop/), [구현 선택](/ko/manual/bluetape4k-graph/1.0/backends/selection-guide/), [성능 자료로 선택하기](/ko/manual/bluetape4k-graph/1.0/guides/benchmark-based-selection/)를 참고한다. 이 모듈은 장애, 영속성, 원격 Gremlin, cluster를 흉내 내지 않는다.
