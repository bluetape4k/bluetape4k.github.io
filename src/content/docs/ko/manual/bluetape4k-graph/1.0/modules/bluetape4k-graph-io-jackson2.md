---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-jackson2"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-io-jackson2.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/1.0/graph-io/formats/), [실행 방식](/ko/manual/bluetape4k-graph/1.0/graph-io/execution-model/), [Jackson 3 모듈](/ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-jackson3/)을 참고한다. 이 모듈은 임의 mapper 설정을 변환하거나 파일 전체를 하나의 트랜잭션으로 만들지 않는다.
