---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-age"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-age.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[Apache AGE](/ko/manual/bluetape4k-graph/1.0/backends/apache-age/), [구현 선택](/ko/manual/bluetape4k-graph/1.0/backends/selection-guide/), [schema와 트랜잭션](/ko/manual/bluetape4k-graph/1.0/architecture/schema-and-transactions/)을 참고한다. 이 모듈은 PostgreSQL을 운영하거나 Bolt/Cypher 호환성을 보장하지 않는다.
