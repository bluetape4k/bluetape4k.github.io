---
slug: "ko/manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-core"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/modules/bluetape4k-graph-core.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[core model](/ko/manual/bluetape4k-graph/1.0/architecture/core-model/), [짝을 이루는 API](/ko/manual/bluetape4k-graph/1.0/architecture/paired-apis/), [schema와 트랜잭션](/ko/manual/bluetape4k-graph/1.0/architecture/schema-and-transactions/)을 참고한다. core는 모든 그래프 제품의 기능을 하나로 합치거나 데이터베이스를 설치하지 않는다.
