---
slug: "ko/manual/bluetape4k-graph/1.0/guides/operations"
title: "운영"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/ko/guides/operations.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
`GraphSession.close()`는 외부에서 주입한 자원의 소유권을 가져가지 않는다. [`GraphSession.kt`](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-core/src/main/kotlin/io/bluetape4k/graph/repository/GraphSession.kt)에 이 경계가 적혀 있고, 프레임워크 페이지는 컨테이너가 close action을 등록하는 때를 설명한다.
