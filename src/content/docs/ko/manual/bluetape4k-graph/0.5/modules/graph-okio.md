---
slug: "ko/manual/bluetape4k-graph/0.5/modules/graph-okio"
title: "graph-okio"
manual:
  ...
  sourcePath: "docs/manual/ko/modules/graph-okio.md"
  minorVersion: "0.5"
  releaseRef: "0.5.1"
...
고정된 [NegativePathTest](https://github.com/bluetape4k/bluetape4k-graph/blob/3e0fa7cb9e3bc70c2743aeebda2487f3e45e4907/graph-io/okio/src/test/kotlin/io/bluetape4k/graph/io/okio/NegativePathTest.kt)가 모든 fixture 변수를 정의한 완전한 실행 예제다. 다음 명령으로 확인한다.
...
[OkIO 보안](/ko/manual/bluetape4k-graph/0.5/graph-io/okio-security/), [파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/0.5/graph-io/formats/), [운영](/ko/manual/bluetape4k-graph/0.5/guides/operations/)을 참고한다. 이 모듈은 key를 관리하거나 암호화된 CSV 묶음 형식을 정의하지 않는다.
