---
slug: "ko/manual/bluetape4k-graph/0.5/modules/bluetape4k-graph-io-core"
...
[실행 방식](/ko/manual/bluetape4k-graph/0.5/graph-io/execution-model/), [파일 형식과 외부 ID](/ko/manual/bluetape4k-graph/0.5/graph-io/formats/), [실패와 취소](/ko/manual/bluetape4k-graph/0.5/guides/failure-and-cancellation/)를 참고한다. core는 파일 형식을 정하거나 이미 기록한 batch를 rollback하지 않는다.
