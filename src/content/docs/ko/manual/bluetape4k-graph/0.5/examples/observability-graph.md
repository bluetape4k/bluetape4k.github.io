...
[![observability graph examples 아키텍처](/manual-assets/bluetape4k-graph/0.5/readme-diagrams/examples-observability-graph-examples-architecture-01.png)](../../assets/readme-diagrams/examples-observability-graph-examples-architecture-01.svg)

_배포본 README: [`examples/observability-graph-examples/README.ko.md`](https://github.com/bluetape4k/bluetape4k-graph/blob/3e0fa7cb9e3bc70c2743aeebda2487f3e45e4907/examples/observability-graph-examples/README.ko.md)_

### observability graph examples data 흐름

[![observability graph examples data 흐름](/manual-assets/bluetape4k-graph/0.5/readme-diagrams/examples-observability-graph-examples-data-flow-03.png)](../../assets/readme-diagrams/examples-observability-graph-examples-data-flow-03.svg)
