---
slug: "ko/manual/bluetape4k-javers/0.2/architecture/repository-map"
title: "저장소 지도"
manual:
...
0.2.1에는 Exposed와 Redis를 함께 쓰거나 Kafka와 조회 저장소를 자동으로 묶는 복합 `CdoSnapshotRepository`가 없습니다. 두 번째 목적지를 추가하기 전에 [저장소 조합](/ko/manual/bluetape4k-javers/0.2/architecture/repository-composition/)을 읽어야 합니다.
