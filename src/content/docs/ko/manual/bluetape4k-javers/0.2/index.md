---
slug: "ko/manual/bluetape4k-javers/0.2"
...
- [시작하기](/ko/manual/bluetape4k-javers/0.2/getting-started/): 생태계 버전 하나로 의존성을 맞추고 Exposed 기반 감사 저장소를 구성합니다.
- [저장소 지도](/ko/manual/bluetape4k-javers/0.2/architecture/repository-map/): 모듈마다 맡는 책임과 맡지 않는 책임을 구분합니다.
- [영속 방식 선택](/ko/manual/bluetape4k-javers/0.2/persistence/selection-guide/): 복구와 조회 요구를 기준으로 Exposed, Redis, Kafka를 고릅니다.
- [학습 경로](/ko/manual/bluetape4k-javers/0.2/guides/learning-path/): 개발자, 연동 담당자, 운영자에게 맞는 읽기 순서를 안내합니다.

JaVers 데이터 구조가 먼저 궁금하면 [감사 모델](/ko/manual/bluetape4k-javers/0.2/architecture/audit-model/)을 읽으세요. 여러 저장 경로를 엮는다면 [저장소 조합](/ko/manual/bluetape4k-javers/0.2/architecture/repository-composition/)과 [실패 계약](/ko/manual/bluetape4k-javers/0.2/operations/failure-contracts/)을 먼저 확인해야 합니다. 명령에서 Redis 프로젝션까지 이어지는 흐름은 [DDD와 CQRS](/ko/manual/bluetape4k-javers/0.2/guides/ddd-and-cqrs/)에 있습니다.

## 구조, 영속 방식, 운영

- [감사 모델](/ko/manual/bluetape4k-javers/0.2/architecture/audit-model/)은 커밋, 스냅샷, 변경 내역, 섀도의 차이를 설명합니다.
- [저장소 조합](/ko/manual/bluetape4k-javers/0.2/architecture/repository-composition/)은 업무 원본과 각 어댑터의 책임 경계를 다룹니다.
- [영속 방식 선택](/ko/manual/bluetape4k-javers/0.2/persistence/selection-guide/)은 Exposed, Redis, Kafka의 복구 계약을 비교합니다.
- [Exposed](/ko/manual/bluetape4k-javers/0.2/persistence/exposed/), [Redis](/ko/manual/bluetape4k-javers/0.2/persistence/redis/), [Kafka](/ko/manual/bluetape4k-javers/0.2/persistence/kafka/) 문서에서는 각 어댑터의 구현과 운영 기준을 더 자세히 설명합니다.
- [실패 계약](/ko/manual/bluetape4k-javers/0.2/operations/failure-contracts/)과 [관측성](/ko/manual/bluetape4k-javers/0.2/operations/observability/)은 장애를 감지하고 복구하는 기준을 정리합니다.

## 모듈과 실행 예제

- 기반 모듈: [Javers BOM](/ko/manual/bluetape4k-javers/0.2/modules/bluetape4k-javers-bom/), [javers-core](/ko/manual/bluetape4k-javers/0.2/modules/javers-core/), [javers-ddd](/ko/manual/bluetape4k-javers/0.2/modules/javers-ddd/)
- 영속 모듈: [javers-exposed](/ko/manual/bluetape4k-javers/0.2/modules/javers-exposed/), [javers-persistence-redis](/ko/manual/bluetape4k-javers/0.2/modules/javers-persistence-redis/), [javers-persistence-kafka](/ko/manual/bluetape4k-javers/0.2/modules/javers-persistence-kafka/)
- 예제: [JaVers + Exposed DDD 주문 처리 흐름](/ko/manual/bluetape4k-javers/0.2/examples/javers-exposed-ddd/)
- 벤치마크: [측정 결과를 읽는 방법](/ko/manual/bluetape4k-javers/0.2/benchmarks/overview/), [JaVers·Exposed DDD·Envers 비교](/ko/manual/bluetape4k-javers/0.2/benchmarks/exposed-ddd-envers/)
- 생태계 확장: [Exposed와 애플리케이션 구조로 이어지는 경로](/ko/manual/bluetape4k-javers/0.2/guides/cross-repository-paths/)
