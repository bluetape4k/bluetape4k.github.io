---
slug: "ko/manual/bluetape4k-javers/1.0/persistence/exposed"
title: "Exposed 영속 저장"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-javers/ko/persistence/exposed.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[![Exposed 스냅샷 저장 흐름](/manual-assets/bluetape4k-javers/1.0/persistence/exposed-snapshot-flow.png)](../../assets/persistence/exposed-snapshot-flow.svg)
