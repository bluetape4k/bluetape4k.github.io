---
slug: "ko/manual/bluetape4k-javers/1.0/benchmarks/exposed-ddd-envers"
title: "JaVers + Exposed와 Hibernate Envers 비교"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-javers/ko/benchmarks/exposed-ddd-envers.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
측정 원칙은 [벤치마크 근거 읽기](/ko/manual/bluetape4k-javers/1.0/benchmarks/overview/), 기능 흐름은 [1.0.0 예제](/ko/manual/bluetape4k-javers/1.0/examples/javers-exposed-ddd/), 저장소 경계는 [Exposed 영속 방식](/ko/manual/bluetape4k-javers/1.0/persistence/exposed/)에서 이어집니다.
