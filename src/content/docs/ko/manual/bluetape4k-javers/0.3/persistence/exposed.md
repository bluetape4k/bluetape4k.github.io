---
slug: "ko/manual/bluetape4k-javers/0.3/persistence/exposed"
title: "Exposed 영속 저장"
manual:
...
[![Exposed 스냅샷 저장 흐름](/manual-assets/bluetape4k-javers/0.3/persistence/exposed-snapshot-flow.png)](../../assets/persistence/exposed-snapshot-flow.svg)
