---
slug: "ko/manual/bluetape4k-javers/0.3/persistence/kafka"
title: "Kafka 영속 경로"
manual:
...
Kafka 발행 자체가 저장소의 목적이고 소비자가 스냅샷 스키마를 이해할 때만 이 어댑터를 고르세요. JaVers 조회도 필요하면 Exposed나 Redis를 저장소로 두고 별도 실패 전략 아래 이벤트를 발행해야 합니다. [저장소 조합](/ko/manual/bluetape4k-javers/0.3/architecture/repository-composition/)을 함께 읽으세요.
