---
slug: "ko/manual/bluetape4k-javers/0.3/persistence/selection-guide"
title: "영속 방식 선택"
manual:
...
[![영속 방식 선택 지도](/manual-assets/bluetape4k-javers/0.3/persistence/persistence-decision-map.png)](../../assets/persistence/persistence-decision-map.svg)
...
감사 이력을 DB에 오래 남겨야 하면 [Exposed](/ko/manual/bluetape4k-javers/0.3/persistence/exposed/), Redis를 스냅샷 저장소로 운영할 준비가 돼 있으면 [Redis](/ko/manual/bluetape4k-javers/0.3/persistence/redis/)를 선택합니다. [Kafka](/ko/manual/bluetape4k-javers/0.3/persistence/kafka/)는 인코딩한 스냅샷 발행이 목적이고 별도 소비자와 조회 모델을 운영할 때만 고릅니다.
...
여러 방식을 섞기 전에는 [저장소 조합](/ko/manual/bluetape4k-javers/0.3/architecture/repository-composition/)과 [실패 계약](/ko/manual/bluetape4k-javers/0.3/operations/failure-contracts/)을 확인해야 합니다.
