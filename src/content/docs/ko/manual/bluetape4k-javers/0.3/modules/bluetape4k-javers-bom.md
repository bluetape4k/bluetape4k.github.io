---
slug: "ko/manual/bluetape4k-javers/0.3/modules/bluetape4k-javers-bom"
title: "Javers BOM"
manual:
...
다른 bluetape4k 저장소의 버전도 이 BOM의 범위 밖입니다. Projects, Exposed, Javers, Redis, Kafka 연동을 함께 쓴다면 [시작하기](/ko/manual/bluetape4k-javers/0.3/getting-started/)의 생태계 플랫폼을 권합니다.
...
Redis나 Kafka 어댑터를 쓴다면 해당 모듈 테스트도 추가합니다. 저장 방식마다 확인할 내용은 [테스트 안내](/ko/manual/bluetape4k-javers/0.3/guides/testing/)에 정리했습니다.
...
모듈을 고르기 전 [저장소 구성도](/ko/manual/bluetape4k-javers/0.3/architecture/repository-map/)를 먼저 읽어 보세요.
