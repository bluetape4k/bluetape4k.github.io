---
slug: "ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-mysql8"
...
[어댑터 표](/ko/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/)를 읽고 point 검색 하나부터 구현한 뒤 복잡한 geometry와 index로 넓히세요. 트랜잭션은 [트랜잭션 경계 가이드](/ko/manual/bluetape4k-exposed/1.12/guides/transaction-boundaries/)를 따릅니다.
...
- [Geometry 컬럼](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/mysql8/src/main/kotlin/io/bluetape4k/exposed/mysql8/gis/GeoColumnTypes.kt)
- [공간 함수](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/mysql8/src/main/kotlin/io/bluetape4k/exposed/mysql8/gis/SpatialFunctions.kt)
...
- [Geometry 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/mysql8/src/test/kotlin/io/bluetape4k/exposed/mysql8/gis/GeometryColumnTypeTest.kt)
...
_배포본 README: [`exposed/mysql8/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/exposed/mysql8/README.ko.md)_
