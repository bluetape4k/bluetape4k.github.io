---
slug: "ko/manual/bluetape4k-exposed/1.12/modules/examples-exposed-bigquery-dry-run"
...
[BigQuery 어댑터](/ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-bigquery/)와 [데이터베이스 어댑터 비교표](/ko/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/)를 읽은 뒤 [Exposed 워크숍](https://github.com/bluetape4k/exposed-workshop)에서 저장소 패턴을 익혀 보세요.
...
[BigQuery 어댑터](/ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-bigquery/)에서 실행과 paging을 익힌 뒤 [데이터베이스 어댑터 표](/ko/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/)에서 분석 어댑터를 비교하세요.
...
_배포본 README: [`examples/exposed-bigquery-dry-run/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/examples/exposed-bigquery-dry-run/README.ko.md)_

<!-- release-readme-diagrams:end -->

## 근거 자료

- [예제 소스](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/examples/exposed-bigquery-dry-run/README.ko.md)
- [Gradle 빌드](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/examples/exposed-bigquery-dry-run/build.gradle.kts)
