---
slug: "ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-bom"
...
[빠르게 시작하기](/ko/manual/bluetape4k-exposed/1.12/getting-started/)를 읽은 다음 [JDBC와 R2DBC 선택](/ko/manual/bluetape4k-exposed/1.12/guides/jdbc-vs-r2dbc/)으로 이어가세요. workshop 저장소도 같은 중앙 의존성 관리 방식을 사용합니다.
...
- [BOM 빌드](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/bom/build.gradle.kts)
- [저장소 설정](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/settings.gradle.kts)
