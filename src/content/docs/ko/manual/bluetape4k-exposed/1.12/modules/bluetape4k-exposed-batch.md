---
slug: "ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-batch"
...
![BatchStepRunner 실행 흐름](/manual-assets/bluetape4k-exposed/1.12/batch/runtime.png)
...
[트랜잭션 경계](/ko/manual/bluetape4k-exposed/1.12/guides/transaction-boundaries/)를 읽은 뒤 [Spring Boot Batch 연동](/ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-spring-boot-batch/)과 실행 모델을 비교하세요. 사용자 정의 reader나 writer를 만들기 전에 영속 저장소 테스트를 재시작 계약으로 삼는 것이 좋습니다.
...
_배포본 README: [`utils/batch/benchmark/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/utils/batch/benchmark/README.ko.md)_
...
_배포본 README: [`utils/batch/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/utils/batch/README.ko.md)_
