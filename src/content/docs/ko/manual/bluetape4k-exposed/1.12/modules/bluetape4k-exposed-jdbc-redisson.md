---
slug: "ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-jdbc-redisson"
...
캐시 백엔드로 Redisson 기반 Redis를 선택하고 영속성 경로가 동기 JDBC 또는 suspend JDBC일 때 사용합니다. 인프라를 추가하기 전에 [캐시 선택 가이드](/ko/manual/bluetape4k-exposed/1.12/guides/cache-selection/)에서 여섯 어댑터를 비교하세요.
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/jdbc-redisson/README.md)
- [추상 저장소](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/jdbc-redisson/src/main/kotlin/io/bluetape4k/exposed/redisson/repository/AbstractJdbcRedissonRepository.kt)
- [모듈 빌드](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/jdbc-redisson/build.gradle.kts)
