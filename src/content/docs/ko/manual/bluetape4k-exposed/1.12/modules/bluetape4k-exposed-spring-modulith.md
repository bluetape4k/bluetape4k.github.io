---
slug: "ko/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-spring-modulith"
...
![Spring Modulith 발행 생명주기](/manual-assets/bluetape4k-exposed/1.12/spring/modulith-publication.png)
...
[JaVers로 감사하기](/ko/manual/bluetape4k-exposed/1.12/guides/audit-with-javers/)를 읽어 전달 신뢰성과 감사·이력 요구를 구분하세요. 스냅숏과 diff가 필요하면 [bluetape4k JaVers 저장소](https://github.com/bluetape4k/bluetape4k-javers)로 이어 갑니다.
...
_배포본 README: [`spring-boot/spring-modulith/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/spring-boot/spring-modulith/README.ko.md)_
