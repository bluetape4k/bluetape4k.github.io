---
slug: "ko/manual/bluetape4k-exposed/1.12/guides/hibernate-vs-exposed"
...
[![JPA와 Exposed 아키텍처 비교](/manual-assets/bluetape4k-exposed/1.12/persistence/jpa-exposed-comparison.ko.png)](../../assets/persistence/jpa-exposed-comparison.ko.svg)
...
[JDBC와 R2DBC 선택](/ko/manual/bluetape4k-exposed/1.12/guides/jdbc-vs-r2dbc/), [트랜잭션 경계](/ko/manual/bluetape4k-exposed/1.12/guides/transaction-boundaries/)를 먼저 읽고 대표 저장소 하나를 만들어 본 뒤 전체 전환 여부를 결정하세요.
