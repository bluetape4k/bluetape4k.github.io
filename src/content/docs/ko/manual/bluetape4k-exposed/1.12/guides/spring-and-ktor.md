---
slug: "ko/manual/bluetape4k-exposed/1.12/guides/spring-and-ktor"
...
![Spring JDBC 자동 설정](/manual-assets/bluetape4k-exposed/1.12/spring/jdbc-auto-configuration.png)
...
![Spring R2DBC 연동 경계](/manual-assets/bluetape4k-exposed/1.12/spring/r2dbc-auto-configuration.png)
...
- [Spring JDBC 데모](/ko/manual/bluetape4k-exposed/1.12/modules/exposed-spring-boot-jdbc-demo/), [Spring R2DBC 데모](/ko/manual/bluetape4k-exposed/1.12/modules/exposed-spring-boot-r2dbc-demo/), [Ktor 데모](/ko/manual/bluetape4k-exposed/1.12/modules/examples-ktor-exposed-demo/) 중 하나를 실행합니다.
...
- [Spring Boot JDBC 모듈](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/spring-boot/jdbc/src/main/kotlin/io/bluetape4k/spring/data/exposed/jdbc/config/ExposedSpringDataAutoConfiguration.kt)
- [Spring Boot R2DBC 모듈](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/spring-boot/r2dbc/src/main/kotlin/io/bluetape4k/spring/data/exposed/r2dbc/config/ExposedR2dbcSpringDataAutoConfiguration.kt)
- [Ktor 모듈](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/ktor/exposed/src/main/kotlin/io/bluetape4k/exposed/ktor/Bluetape4kExposedKtor.kt)
