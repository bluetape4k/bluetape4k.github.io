---
slug: "ko/manual/bluetape4k-exposed/1.12/guides/testing-and-operations"
title: "테스트와 운영"
locale: "ko"
releaseRef: "1.12.1"
manual:
...
![배치 실행과 재시작 경계](/manual-assets/bluetape4k-exposed/1.12/batch/runtime.png)
...
정확한 실행 작업과 해석상의 제약은 [벤치마크 모듈](/ko/manual/bluetape4k-exposed/1.12/modules/benchmark-exposed-benchmark/)에서 확인할 수 있습니다.

## 근거 자료

- [모듈 등록](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/settings.gradle.kts)
- [경량 배치 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/utils/batch/src/test/kotlin/io/bluetape4k/batch/core/BatchStepRunnerTest.kt)
- [Spring Batch 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/spring-boot/batch-exposed/src/test/kotlin/io/bluetape4k/spring/batch/exposed/integration/RestartIntegrationTest.kt)
- [벤치마크 빌드](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/benchmark/exposed-benchmark/build.gradle.kts)
