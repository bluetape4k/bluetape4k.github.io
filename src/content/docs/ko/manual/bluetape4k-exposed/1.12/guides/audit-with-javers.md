---
slug: "ko/manual/bluetape4k-exposed/1.12/guides/audit-with-javers"
...
manual:
  ...
  sourcePath: "docs/manual/ko/guides/audit-with-javers.md"
  minorVersion: "1.12"
  releaseRef: "1.12.1"
...
![Spring Modulith publication 생명주기](/manual-assets/bluetape4k-exposed/1.12/spring/modulith-publication.png)
...
- [Spring Modulith 연동](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/spring-boot/spring-modulith/src/main/kotlin/io/bluetape4k/spring/modulith/exposed/ExposedEventPublicationRepository.kt)
