---
slug: "ko/manual/bluetape4k-exposed/2.0/guides/testing-and-operations"
title: "테스트와 운영"
locale: "ko"
releaseRef: "2.0.0"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/guides/testing-and-operations.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![배치 실행과 재시작 경계](/manual-assets/bluetape4k-exposed/2.0/batch/runtime.png)
...
정확한 실행 작업과 해석상의 제약은 [벤치마크 모듈](/ko/manual/bluetape4k-exposed/2.0/modules/benchmark-exposed-benchmark/)에서 확인할 수 있습니다.

## 근거 자료

- [모듈 등록](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/settings.gradle.kts)
...
- [Spring Batch 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/spring-boot/batch-exposed/src/test/kotlin/io/bluetape4k/spring/batch/exposed/integration/RestartIntegrationTest.kt)
- [벤치마크 빌드](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/benchmark/exposed-benchmark/build.gradle.kts)
