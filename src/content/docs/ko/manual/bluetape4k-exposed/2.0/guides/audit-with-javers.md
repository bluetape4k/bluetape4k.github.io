---
slug: "ko/manual/bluetape4k-exposed/2.0/guides/audit-with-javers"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/guides/audit-with-javers.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Spring Modulith publication 생명주기](/manual-assets/bluetape4k-exposed/2.0/spring/modulith-publication.png)
...
- [Spring Modulith 연동](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/spring-boot/spring-modulith/src/main/kotlin/io/bluetape4k/spring/modulith/exposed/ExposedEventPublicationRepository.kt)
