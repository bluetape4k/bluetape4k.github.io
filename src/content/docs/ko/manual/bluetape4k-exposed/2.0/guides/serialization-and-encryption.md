---
slug: "ko/manual/bluetape4k-exposed/2.0/guides/serialization-and-encryption"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/guides/serialization-and-encryption.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
4. [트랜잭션 경계](/ko/manual/bluetape4k-exposed/2.0/guides/transaction-boundaries/)에 맞춰 변환을 repository 경로에 넣습니다.
5. 이미 쓰는 컬럼 계약을 바꾸기 전에 마이그레이션과 rollback 증거를 작성합니다.

## 근거 자료

- [Jackson 2 컬럼](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jackson2/src/main/kotlin/io/bluetape4k/exposed/core/jackson/JacksonColumnType.kt)
- [Jackson 3 컬럼](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jackson3/src/main/kotlin/io/bluetape4k/exposed/core/jackson3/JacksonColumnType.kt)
- [Fastjson2 컬럼](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/fastjson2/src/main/kotlin/io/bluetape4k/exposed/core/fastjson2/FastjsonColumnType.kt)
- [Tink 테이블 DSL](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/main/kotlin/io/bluetape4k/exposed/core/tink/Tables.kt)
...
- [Measured 컬럼](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/measured/src/main/kotlin/io/bluetape4k/exposed/core/measured/MeasuredColumnTypes.kt)
