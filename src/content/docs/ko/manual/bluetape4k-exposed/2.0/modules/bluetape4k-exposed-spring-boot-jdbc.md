---
slug: "ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-spring-boot-jdbc"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/modules/bluetape4k-exposed-spring-boot-jdbc.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Spring Boot JDBC 자동 설정](/manual-assets/bluetape4k-exposed/2.0/spring/jdbc-auto-configuration.png)
...
_배포본 README: [`spring-boot/jdbc/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/d632a0bc0662ae616b786f552150a7fabd1cee3e/spring-boot/jdbc/README.ko.md)_
...
- [`ExposedConfig.kt` 데모 재정의](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/src/main/kotlin/io/bluetape4k/examples/exposed/mvc/config/ExposedConfig.kt)
