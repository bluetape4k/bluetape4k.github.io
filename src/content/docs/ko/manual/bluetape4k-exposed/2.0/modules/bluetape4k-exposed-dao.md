---
slug: "ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-dao"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/modules/bluetape4k-exposed-dao.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
[매핑 규칙](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-core/mapping-conventions/)을 읽은 뒤 [JDBC 저장소 경로](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/)로 이어가세요. Exposed DAO는 R2DBC 엔티티 모델이 아닙니다.
...
- [DAO 빌드](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/dao/build.gradle.kts)
