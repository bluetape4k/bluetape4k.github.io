---
slug: "ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-core/mapping-conventions"
title: 매핑 규칙
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/modules/bluetape4k-exposed-core/mapping-conventions.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
다음으로 [JDBC 저장소 패턴](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/repository-patterns/)이나 [R2DBC 저장소 가이드](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-r2dbc/repository-patterns/)를 읽으세요.

## 근거 자료

- [ResultRow 확장](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/core/src/main/kotlin/io/bluetape4k/exposed/core/ResultRowExtensions.kt)
- [엔티티 확장](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/dao/src/main/kotlin/io/bluetape4k/exposed/dao/EntityExtensions.kt)
- [감사 엔티티](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/dao/src/main/kotlin/io/bluetape4k/exposed/dao/auditable/AuditableEntity.kt)
- [페이지 값](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/core/src/main/kotlin/io/bluetape4k/exposed/core/ExposedPage.kt)
- [JDBC 저장소 계약](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/main/kotlin/io/bluetape4k/exposed/jdbc/repository/JdbcRepository.kt)
