---
slug: "ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/transaction-ownership"
title: JDBC 트랜잭션 소유권
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/modules/bluetape4k-exposed-jdbc/transaction-ownership.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
[저장소 패턴](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/repository-patterns/), [운영과 테스트](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/operations-testing/)로 이어가세요. 드라이버까지 논블로킹이어야 한다면 [R2DBC 매뉴얼](/ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-r2dbc/)과 비교하세요.

## 근거 자료

- [JDBC 저장소 사용 계약](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/main/kotlin/io/bluetape4k/exposed/jdbc/repository/JdbcRepository.kt)
- [가상 스레드 JDBC 트랜잭션](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/main/kotlin/io/bluetape4k/exposed/jdbc/VirtualThreadJdbcTransaction.kt)
- [JDBC 예제 controller](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/src/main/kotlin/io/bluetape4k/examples/exposed/mvc/controller/ProductController.kt)
- [JDBC 저장소 트랜잭션 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/test/kotlin/io/bluetape4k/exposed/jdbc/repository/MovieJdbcRepositoryTest.kt)
