---
slug: "ko/manual/bluetape4k-exposed/2.0/modules/benchmark-exposed-benchmark"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/modules/benchmark-exposed-benchmark.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
[테스트와 운영](/ko/manual/bluetape4k-exposed/2.0/guides/testing-and-operations/)을 읽고 한 작업을 재현한 뒤, 실제 데이터베이스와 workload를 명시한 실험을 [bluetape4k-workshop](https://github.com/bluetape4k/bluetape4k-workshop)으로 발전시키세요.
...
- [1.11 벤치마크 설명과 대표 결과](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/benchmark/exposed-benchmark/README.ko.md)
- [벤치마크 설정과 작업](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/benchmark/exposed-benchmark/build.gradle.kts)
