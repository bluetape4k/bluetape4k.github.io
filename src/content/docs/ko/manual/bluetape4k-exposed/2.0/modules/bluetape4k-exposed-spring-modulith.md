---
slug: "ko/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-spring-modulith"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/ko/modules/bluetape4k-exposed-spring-modulith.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Spring Modulith 발행 생명주기](/manual-assets/bluetape4k-exposed/2.0/spring/modulith-publication.png)
...
[JaVers로 감사하기](/ko/manual/bluetape4k-exposed/2.0/guides/audit-with-javers/)를 읽어 전달 신뢰성과 감사·이력 요구를 구분하세요. 스냅숏과 diff가 필요하면 [bluetape4k JaVers 저장소](https://github.com/bluetape4k/bluetape4k-javers)로 이어 갑니다.
