---
slug: "ko/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-jdbc-lettuce"
...
캐시 백엔드로 Lettuce 기반 Redis를 선택했고, 동기 JDBC와 코루틴용 suspend 저장소를 같이 제공해야 할 때 사용합니다. 인프라를 추가하기 전에 [캐시 선택 가이드](/ko/manual/bluetape4k-exposed/1.11/guides/cache-selection/)에서 여섯 어댑터를 비교하세요.
