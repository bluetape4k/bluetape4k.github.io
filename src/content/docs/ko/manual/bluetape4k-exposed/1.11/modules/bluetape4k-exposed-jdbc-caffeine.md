---
slug: "ko/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-jdbc-caffeine"
...
캐시 백엔드로 프로세스 내부 Caffeine을 선택하고 영속성 경로가 동기 JDBC 또는 suspend JDBC일 때 사용합니다. 인프라를 추가하기 전에 [캐시 선택 가이드](/ko/manual/bluetape4k-exposed/1.11/guides/cache-selection/)에서 여섯 어댑터를 비교하세요.
