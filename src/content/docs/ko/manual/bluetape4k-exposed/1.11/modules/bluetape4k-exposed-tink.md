---
slug: "ko/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-tink"
...
manual:
  ...
  sourcePath: "docs/manual/ko/modules/bluetape4k-exposed-tink.md"
  minorVersion: "1.11"
  releaseRef: "1.11.0"
...
[직렬화와 암호화 선택 가이드](/ko/manual/bluetape4k-exposed/1.11/guides/serialization-and-encryption/)를 먼저 읽으세요. 이어서 DSL 검증과 associated data는 `TinkTableTest`, AEAD는 `TinkColumnTypeTest`, 결정적 검색은 `TinkDaeadColumnTypeTest`에서 확인할 수 있습니다.
...
[![Tink encrypted column boundary 다이어그램](/manual-assets/bluetape4k-exposed/1.11/readme-diagrams/exposed-tink-diagram-01.png)](../../assets/readme-diagrams/exposed-tink-diagram-01.svg)
...
[![AEAD and DAEAD behavior 처리 흐름](/manual-assets/bluetape4k-exposed/1.11/readme-diagrams/exposed-tink-diagram-02.png)](../../assets/readme-diagrams/exposed-tink-diagram-02.svg)
...
- [Gradle 빌드 파일](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/tink/build.gradle.kts)
- [테이블 DSL](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/tink/src/main/kotlin/io/bluetape4k/exposed/core/tink/Tables.kt)
...
- [AEAD 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/tink/src/test/kotlin/io/bluetape4k/exposed/core/tink/TinkColumnTypeTest.kt)
- [DAEAD 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/tink/src/test/kotlin/io/bluetape4k/exposed/core/tink/TinkDaeadColumnTypeTest.kt)
