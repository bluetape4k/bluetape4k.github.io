---
slug: "ko/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-timefold-solver-persistence"
...
[![Timefold Score column families 다이어그램](/manual-assets/bluetape4k-exposed/1.11/readme-diagrams/exposed-timefold-solver-persistence-diagram-01.png)](../../assets/readme-diagrams/exposed-timefold-solver-persistence-diagram-01.svg)

_배포본 README: [`exposed/timefold-solver-persistence/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/0b494a5fd1e083006046764757342b68a397e4c5/exposed/timefold-solver-persistence/README.ko.md)_

### Score persistence round trip 다이어그램

[![Score persistence round trip 다이어그램](/manual-assets/bluetape4k-exposed/1.11/readme-diagrams/exposed-timefold-solver-persistence-flow-02.png)](../../assets/readme-diagrams/exposed-timefold-solver-persistence-flow-02.svg)
...
- [지원하는 Score 컬럼 계열](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/timefold-solver-persistence/README.ko.md)
- [`SimpleScore` Long 매핑](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/timefold-solver-persistence/src/main/kotlin/io/bluetape4k/timefold/solver/exposed/api/score/buildin/SimpleScore.kt)
- [`HardSoftScore` 문자열 매핑](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/timefold-solver-persistence/src/main/kotlin/io/bluetape4k/timefold/solver/exposed/api/score/buildin/HardSoftScore.kt)
- [왕복 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/timefold-solver-persistence/src/test/kotlin/io/bluetape4k/timefold/solver/exposed/api/score/buildin/SimpleScoreTest.kt)
