---
slug: "ko/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-fastjson2"
...
먼저 [직렬화와 암호화 선택 가이드](/ko/manual/bluetape4k-exposed/1.11/guides/serialization-and-encryption/)를 읽으세요. 이어서 모듈 테스트에서 JSON·JSONB round-trip과 행 reader의 동작을 확인하고, repository에 적용하기 전 [트랜잭션 경계](/ko/manual/bluetape4k-exposed/1.11/guides/transaction-boundaries/)로 넘어가면 됩니다.
...
_배포본 README: [`exposed/fastjson2/README.ko.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/0b494a5fd1e083006046764757342b68a397e4c5/exposed/fastjson2/README.ko.md)_
...
- [Gradle 빌드 파일](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/fastjson2/build.gradle.kts)
- [JSON 컬럼 타입](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/fastjson2/src/main/kotlin/io/bluetape4k/exposed/core/fastjson2/FastjsonColumnType.kt)
- [JSONB 컬럼 타입](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/fastjson2/src/main/kotlin/io/bluetape4k/exposed/core/fastjson2/FastjsonBColumnType.kt)
- [JSON 식](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/fastjson2/src/main/kotlin/io/bluetape4k/exposed/core/fastjson2/JsonFunctions.kt)
- [Round-trip 테스트](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/fastjson2/src/test/kotlin/io/bluetape4k/exposed/core/fastjson2/FastjsonColumnTest.kt)
