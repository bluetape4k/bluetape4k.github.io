---
slug: "ko/manual/bluetape4k-text/0.3/examples/tokenizer-safety-examples"
title: "토크나이저 안전 예제"
manual:
...
[입력 안전성](/ko/manual/bluetape4k-text/0.3/guides/input-safety/), [실패 계약](/ko/manual/bluetape4k-text/0.3/operations/failure-contracts/), [Tokenizer Core](/ko/manual/bluetape4k-text/0.3/modules/tokenizer-core/)로 이어서 살펴보자.
