---
slug: "ko/manual/bluetape4k-text/0.3/examples/text-search-examples"
title: "텍스트 검색 예제"
manual:
...
[텍스트 검색 모듈](/ko/manual/bluetape4k-text/0.3/modules/text-search/), [테스트 가이드](/ko/manual/bluetape4k-text/0.3/guides/testing/), [벤치마크 해석](/ko/manual/bluetape4k-text/0.3/quality/aho-corasick-benchmarks/)으로 이어서 학습하자.
