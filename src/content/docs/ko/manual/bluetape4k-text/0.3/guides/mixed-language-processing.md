---
slug: "ko/manual/bluetape4k-text/0.3/guides/mixed-language-processing"
title: "혼합 언어 처리"
manual:
...
![언어 감지 선택 흐름](/manual-assets/bluetape4k-text/0.3/guides/language-detection-selection.png)
...
[Lingua 예제](/ko/manual/bluetape4k-text/0.3/examples/lingua-examples/), [런타임 경계](/ko/manual/bluetape4k-text/0.3/architecture/runtime-boundaries/), [실패 계약](/ko/manual/bluetape4k-text/0.3/operations/failure-contracts/)으로 이어서 살펴보자.
