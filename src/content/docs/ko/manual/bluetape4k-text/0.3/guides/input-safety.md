---
slug: "ko/manual/bluetape4k-text/0.3/guides/input-safety"
title: "입력 안전성"
manual:
...
![요청 안전 경계](/manual-assets/bluetape4k-text/0.3/operations/request-safety-boundary.png)
...
빈 입력, 공백 입력, 정확히 최대 길이, 한 글자 초과, 프로세서 예외, 정제된 응답을 테스트한다. [토크나이저 안전 예제](/ko/manual/bluetape4k-text/0.3/examples/tokenizer-safety-examples/)가 실행 가능한 출발점이다.
