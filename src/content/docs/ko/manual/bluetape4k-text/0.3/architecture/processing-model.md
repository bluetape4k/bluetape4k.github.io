---
slug: "ko/manual/bluetape4k-text/0.3/architecture/processing-model"
title: "처리 모델"
manual:
...
![텍스트 처리 흐름](/manual-assets/bluetape4k-text/0.3/architecture/text-processing-pipeline.png)
...
이 경계를 분명히 하면 테스트와 오류 변환이 단순해진다. 다음으로 [런타임 경계](/ko/manual/bluetape4k-text/0.3/architecture/runtime-boundaries/), [테스트](/ko/manual/bluetape4k-text/0.3/guides/testing/), [실패 계약](/ko/manual/bluetape4k-text/0.3/operations/failure-contracts/)을 읽어 보자.
