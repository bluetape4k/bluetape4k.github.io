---
slug: "ko/manual/bluetape4k-text/0.3/operations/startup-and-memory"
title: "시작과 메모리"
manual:
...
[런타임 경계](/ko/manual/bluetape4k-text/0.3/architecture/runtime-boundaries/), [입력 안전성](/ko/manual/bluetape4k-text/0.3/guides/input-safety/), [실패 계약](/ko/manual/bluetape4k-text/0.3/operations/failure-contracts/)을 함께 읽자.
