---
slug: "ko/manual/bluetape4k-text/0.3/quality/aho-corasick-benchmarks"
...
[텍스트 검색 모듈](/ko/manual/bluetape4k-text/0.3/modules/text-search/), [검색 예제](/ko/manual/bluetape4k-text/0.3/examples/text-search-examples/), [시작과 메모리](/ko/manual/bluetape4k-text/0.3/operations/startup-and-memory/)로 이어서 읽자.
