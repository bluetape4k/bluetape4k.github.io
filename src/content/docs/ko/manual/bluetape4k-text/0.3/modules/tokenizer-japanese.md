---
slug: "ko/manual/bluetape4k-text/0.3/modules/tokenizer-japanese"
...
일본어 토큰 경계나 품사가 필요할 때 선택한다. 형태소와 무관한 정확한 패턴은 [텍스트 검색](/ko/manual/bluetape4k-text/0.3/modules/text-search/)을 사용한다. 입력 언어가 정해지지 않았을 때만 [Lingua](/ko/manual/bluetape4k-text/0.3/modules/lingua/)로 앞에서 분기한다.

## 다음 학습 경로

- [혼합 언어 처리](/ko/manual/bluetape4k-text/0.3/guides/mixed-language-processing/)
- [토크나이저 안전 예제](/ko/manual/bluetape4k-text/0.3/examples/tokenizer-safety-examples/)
- [시작과 메모리](/ko/manual/bluetape4k-text/0.3/operations/startup-and-memory/)
...
- [일본어 모듈 README](https://github.com/bluetape4k/bluetape4k-text/blob/0.3.0/tokenizer-japanese/README.md)
...
_배포본 README: [`tokenizer-japanese/README.ko.md`](https://github.com/bluetape4k/bluetape4k-text/blob/aead213d2d25307d7d3684226943a5f95c7411f2/tokenizer-japanese/README.ko.md)_
