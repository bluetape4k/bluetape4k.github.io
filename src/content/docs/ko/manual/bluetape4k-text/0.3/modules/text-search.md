---
slug: "ko/manual/bluetape4k-text/0.3/modules/text-search"
...
![텍스트 검색 흐름](/manual-assets/bluetape4k-text/0.3/text-search/search-flow.png)
...
- [텍스트 검색 실행 예제](/ko/manual/bluetape4k-text/0.3/examples/text-search-examples/)
- [Aho-Corasick 벤치마크](/ko/manual/bluetape4k-text/0.3/quality/aho-corasick-benchmarks/)
