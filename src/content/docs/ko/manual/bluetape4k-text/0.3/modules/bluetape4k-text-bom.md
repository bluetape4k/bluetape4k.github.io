---
slug: "ko/manual/bluetape4k-text/0.3/modules/bluetape4k-text-bom"
title: "Text BOM"
manual:
...
- [시작하기](/ko/manual/bluetape4k-text/0.3/getting-started/)
- [저장소 지도](/ko/manual/bluetape4k-text/0.3/architecture/repository-map/)
- [기능 선택](/ko/manual/bluetape4k-text/0.3/guides/capability-selection/)
