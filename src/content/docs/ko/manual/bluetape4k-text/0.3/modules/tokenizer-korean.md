---
slug: "ko/manual/bluetape4k-text/0.3/modules/tokenizer-korean"
...
한국어 형태소 분석이나 내장 정규화·구문 기능이 필요할 때 선택한다. 정확한 패턴만 여러 개 찾는다면 [텍스트 검색](/ko/manual/bluetape4k-text/0.3/modules/text-search/)이 알맞다. 입력 언어를 모르는 경우에만 [Lingua](/ko/manual/bluetape4k-text/0.3/modules/lingua/)를 앞단에 둔다.
...
- [사전과 금칙어](/ko/manual/bluetape4k-text/0.3/guides/dictionaries-and-blockwords/)
- [테스트](/ko/manual/bluetape4k-text/0.3/guides/testing/)
...
- [한국어 모듈 README](https://github.com/bluetape4k/bluetape4k-text/blob/0.3.0/tokenizer-korean/README.md)
...
_배포본 README: [`tokenizer-korean/README.ko.md`](https://github.com/bluetape4k/bluetape4k-text/blob/aead213d2d25307d7d3684226943a5f95c7411f2/tokenizer-korean/README.ko.md)_
