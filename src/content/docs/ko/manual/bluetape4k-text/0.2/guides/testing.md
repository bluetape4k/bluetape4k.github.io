---
slug: "ko/manual/bluetape4k-text/0.2/guides/testing"
title: "테스트"
manual:
  id: "guides/testing"
...
[품질 게이트](/ko/manual/bluetape4k-text/0.2/quality/quality-gates/)에서 배포 증거 범위를, [Aho-Corasick 벤치마크](/ko/manual/bluetape4k-text/0.2/quality/aho-corasick-benchmarks/)에서 검색 성능 사례를 확인할 수 있다.
...
- [안전 예제 테스트](https://github.com/bluetape4k/bluetape4k-text/blob/0.2.1/examples/tokenizer-safety-examples/src/test/kotlin/io/bluetape4k/text/examples/tokenizer/TokenizerSafetyExamplesTest.kt)
