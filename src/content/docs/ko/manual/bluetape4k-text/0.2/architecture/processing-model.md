---
slug: "ko/manual/bluetape4k-text/0.2/architecture/processing-model"
title: "처리 모델"
manual:
  ...
  sourcePath: "docs/manual/ko/architecture/processing-model.md"
  minorVersion: "0.2"
  releaseRef: "0.2.1"
...
![텍스트 처리 흐름](/manual-assets/bluetape4k-text/0.2/architecture/text-processing-pipeline.png)
...
이 경계를 분명히 하면 테스트와 오류 변환이 단순해진다. 다음으로 [런타임 경계](/ko/manual/bluetape4k-text/0.2/architecture/runtime-boundaries/), [테스트](/ko/manual/bluetape4k-text/0.2/guides/testing/), [실패 계약](/ko/manual/bluetape4k-text/0.2/operations/failure-contracts/)을 읽어 보자.

## 소스 근거

- [토크나이저 요청 모델](https://github.com/bluetape4k/bluetape4k-text/tree/0.2.1/tokenizer-core/src/main/kotlin/io/bluetape4k/tokenizer/model)
- [Lingua 소스](https://github.com/bluetape4k/bluetape4k-text/tree/0.2.1/lingua/src/main/kotlin/io/bluetape4k/lingua)
- [Aho-Corasick 구현](https://github.com/bluetape4k/bluetape4k-text/blob/0.2.1/text-search/src/main/kotlin/io/bluetape4k/text/search/AhoCorasickAutomaton.kt)
