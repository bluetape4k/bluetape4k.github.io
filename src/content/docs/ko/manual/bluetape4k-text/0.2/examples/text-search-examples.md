---
slug: "ko/manual/bluetape4k-text/0.2/examples/text-search-examples"
title: "텍스트 검색 예제"
manual:
  ...
  sourcePath: "docs/manual/ko/examples/text-search-examples.md"
  minorVersion: "0.2"
  releaseRef: "0.2.1"
...
[텍스트 검색 모듈](/ko/manual/bluetape4k-text/0.2/modules/text-search/), [테스트 가이드](/ko/manual/bluetape4k-text/0.2/guides/testing/), [벤치마크 해석](/ko/manual/bluetape4k-text/0.2/quality/aho-corasick-benchmarks/)으로 이어서 학습하자.

## 소스 근거

- [실행 소스](https://github.com/bluetape4k/bluetape4k-text/blob/0.2.1/examples/text-search-examples/src/main/kotlin/io/bluetape4k/text/examples/search/TextSearchExamples.kt)
- [예제 테스트](https://github.com/bluetape4k/bluetape4k-text/blob/0.2.1/examples/text-search-examples/src/test/kotlin/io/bluetape4k/text/examples/search/TextSearchExamplesTest.kt)
