---
slug: "ko/manual/bluetape4k-text/1.0/architecture/runtime-boundaries"
title: "런타임 경계"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/ko/architecture/runtime-boundaries.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[시작과 메모리](/ko/manual/bluetape4k-text/1.0/operations/startup-and-memory/)에서 배포 체크리스트를, [입력 안전성](/ko/manual/bluetape4k-text/1.0/guides/input-safety/)에서 요청 경계 규칙을 확인할 수 있다.
