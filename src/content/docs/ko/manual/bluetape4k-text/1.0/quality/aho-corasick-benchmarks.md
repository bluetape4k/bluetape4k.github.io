---
slug: "ko/manual/bluetape4k-text/1.0/quality/aho-corasick-benchmarks"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/ko/quality/aho-corasick-benchmarks.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[텍스트 검색 모듈](/ko/manual/bluetape4k-text/1.0/modules/text-search/), [검색 예제](/ko/manual/bluetape4k-text/1.0/examples/text-search-examples/), [시작과 메모리](/ko/manual/bluetape4k-text/1.0/operations/startup-and-memory/)로 이어서 읽자.
