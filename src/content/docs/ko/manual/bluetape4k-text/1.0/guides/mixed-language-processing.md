---
slug: "ko/manual/bluetape4k-text/1.0/guides/mixed-language-processing"
title: "혼합 언어 처리"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/ko/guides/mixed-language-processing.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
![언어 감지 선택 흐름](/manual-assets/bluetape4k-text/1.0/guides/language-detection-selection.png)
...
[Lingua 예제](/ko/manual/bluetape4k-text/1.0/examples/lingua-examples/), [런타임 경계](/ko/manual/bluetape4k-text/1.0/architecture/runtime-boundaries/), [실패 계약](/ko/manual/bluetape4k-text/1.0/operations/failure-contracts/)으로 이어서 살펴보자.
