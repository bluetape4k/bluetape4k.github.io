---
slug: "ko/manual/bluetape4k-text/1.0/examples/text-search-examples"
title: "텍스트 검색 예제"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/ko/examples/text-search-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[텍스트 검색 모듈](/ko/manual/bluetape4k-text/1.0/modules/text-search/), [테스트 가이드](/ko/manual/bluetape4k-text/1.0/guides/testing/), [벤치마크 해석](/ko/manual/bluetape4k-text/1.0/quality/aho-corasick-benchmarks/)으로 이어서 학습하자.
