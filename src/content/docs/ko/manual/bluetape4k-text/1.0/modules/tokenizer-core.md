---
slug: "ko/manual/bluetape4k-text/1.0/modules/tokenizer-core"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/ko/modules/tokenizer-core.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
HTTP나 메시지 요청 모델, 공통 사전 도구, 자체 프로세서가 필요하다면 core를 직접 사용한다. 실제 형태소 분석이 목적이라면 [한국어](/ko/manual/bluetape4k-text/1.0/modules/tokenizer-korean/) 또는 [일본어](/ko/manual/bluetape4k-text/1.0/modules/tokenizer-japanese/) 모듈을 선택한다.
...
- [입력 안전성](/ko/manual/bluetape4k-text/1.0/guides/input-safety/)
