---
slug: "ko/manual/bluetape4k-text/1.0/modules/tokenizer-japanese"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/ko/modules/tokenizer-japanese.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
일본어 토큰 경계나 품사가 필요할 때 선택한다. 형태소와 무관한 정확한 패턴은 [텍스트 검색](/ko/manual/bluetape4k-text/1.0/modules/text-search/)을 사용한다. 입력 언어가 정해지지 않았을 때만 [Lingua](/ko/manual/bluetape4k-text/1.0/modules/lingua/)로 앞에서 분기한다.

## 다음 학습 경로

- [혼합 언어 처리](/ko/manual/bluetape4k-text/1.0/guides/mixed-language-processing/)
- [토크나이저 안전 예제](/ko/manual/bluetape4k-text/1.0/examples/tokenizer-safety-examples/)
- [시작과 메모리](/ko/manual/bluetape4k-text/1.0/operations/startup-and-memory/)
