---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-cassandra/rows-data-mapping"
...
- [`RowSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/cql/RowSupport.kt): 문자열 기본값, 동적 map 변환, 컬럼 codec 조회
- [`GettableSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/data/GettableSupport.kt): 이름·인덱스·`CqlIdentifier` getter
- [`SettableSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/data/SettableSupport.kt): 이름·인덱스·`CqlIdentifier` setter
- [`EntitySupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/mapper/EntitySupport.kt): `EntityHelper` prepare와 bind
- [`CustomCodecExamples.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/examples/datatypes/CustomCodecExamples.kt): 사용자 codec 등록과 읽기·쓰기
- [`UserDefinedTypesSimpleExamples.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/examples/datatypes/UserDefinedTypesSimpleExamples.kt): UDT metadata와 값 처리
- [`TuplesSimpleExamples.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/examples/datatypes/TuplesSimpleExamples.kt): Tuple 생성과 읽기
- [`EntitySupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/mapper/EntitySupportTest.kt): prepare와 bind 위임 경계
- [`build.gradle.kts`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/cassandra/build.gradle.kts): mapper runtime과 annotation processor dependency

## 앞뒤로 읽기

- 이전: [코루틴 쿼리와 여러 페이지 읽기](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-cassandra/coroutine-queries/)
- 다음: [Statement와 QueryBuilder 선택](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-cassandra/statements-query-builder/)
