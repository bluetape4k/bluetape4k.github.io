---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/validation"
title: 검증과 불변식
...
![Caller argument, object state, domain rule 검증 경계](/manual-assets/bluetape4k-projects/1.12/core/validation-boundary.svg)
...
검증한 값을 고정된 memory budget에 보관하는 방법은 [Bounded collections](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/bounded-collections/)에서 이어집니다.
