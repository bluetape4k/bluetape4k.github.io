---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-r2dbc/sql-and-binding"
...
- [`ParameterSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/r2dbc/src/main/kotlin/io/bluetape4k/r2dbc/support/ParameterSupport.kt)
...
- [`DatabaseClientSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/r2dbc/src/test/kotlin/io/bluetape4k/r2dbc/support/DatabaseClientSupportTest.kt)

## 다음 읽을 장

실행과 binding을 익혔다면 [CRUD와 row mapping](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-r2dbc/crud-and-mapping/)에서 table DSL과 converter 경계를 확인합니다.
