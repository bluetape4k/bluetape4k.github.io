---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-core/testing-and-ecosystem-paths"
...
- Coroutine과 Flow 자체의 cancellation, dispatcher, context 규칙은 [`bluetape4k-coroutines`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/)에서 익힙니다.
- JDBC helper와 imperative transaction은 [`bluetape4k-jdbc`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/)로 이어갑니다.
- Spring Data R2DBC entity operation을 Flow와 suspend로 쓰려면 [`bluetape4k-spring-boot-r2dbc`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-r2dbc/)를 봅니다.
...
- [한국어 README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/spring-boot/core/README.ko.md)
...
[Spring Boot 애플리케이션 공통 경계](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-core/)에서 전체 API 지도와 1.12.1 제한 사항을 다시 확인합니다.
