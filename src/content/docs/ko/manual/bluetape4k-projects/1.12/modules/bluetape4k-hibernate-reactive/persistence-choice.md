---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate-reactive/persistence-choice"
...
| 중심 요구 | 먼저 볼 기술 | 이유 |
| --- | --- | --- |
| Spring JPA, blocking JDBC, 전통적 EntityManager | [bluetape4k-hibernate](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/) | 일반 Hibernate Session과 JPA 생태계를 사용합니다. |
...
| SQL·row mapping·pool·Flow를 직접 제어 | [bluetape4k-r2dbc](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-r2dbc/) | ORM persistence context 없이 R2DBC 경계를 직접 구성합니다. |
...
- [일반 Hibernate source](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/data/hibernate/src/main/kotlin)
...
- [JDBC 이후 기술 선택](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/ecosystem-paths/)
