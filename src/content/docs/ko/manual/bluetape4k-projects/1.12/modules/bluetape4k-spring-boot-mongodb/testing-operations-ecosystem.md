---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-mongodb/testing-operations-ecosystem"
title: 테스트, 운영과 생태계
...
| MongoDB Kotlin driver, codec, collection API 직접 제어 | [`bluetape4k-mongodb`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-mongodb/) |
...
도입할 계층을 정했다면 [자동 설정과 구성 경계](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-mongodb/auto-configuration-boundaries/)로 돌아가 애플리케이션이 소유할 bean과 설정을 고정합니다.
