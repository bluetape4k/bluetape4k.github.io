---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/flow"
...
![flow.async의 ordered emission과 mapParallel의 completion-order emission](/manual-assets/bluetape4k-projects/1.12/coroutines/ordered-parallel-flow.svg)
...
Callback 또는 hot stream의 delivery 의미가 필요하면 [Subject와 이벤트 계약](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/subjects/)으로 이어집니다.
