---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/operations"
title: 운영과 관측 가능성
...
![Coroutine boundary의 최소 운영 신호와 deterministic shutdown](/manual-assets/bluetape4k-projects/1.12/coroutines/observability-boundaries.svg)
...
- Lifecycle 구현: [`CloseableCoroutineScope.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/CloseableCoroutineScope.kt)
...
- Subject cancellation tests: [`SubjectCancellationTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/extensions/subject/SubjectCancellationTest.kt)

끝으로 이 계약들을 실행 가능한 조합으로 묶는 [실전 레시피와 Workshop](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/recipes/)을 봅니다.
