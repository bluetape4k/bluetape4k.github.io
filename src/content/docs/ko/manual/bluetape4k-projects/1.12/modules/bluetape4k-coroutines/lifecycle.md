---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/lifecycle"
title: 수명주기와 취소
...
![CloseableCoroutineScope의 생성, 자식 취소, dispatcher 종료 순서](/manual-assets/bluetape4k-projects/1.12/coroutines/scope-lifecycle.svg)
...
다음 장에서는 owner가 시작한 여러 `Deferred` 가운데 winner와 loser cleanup을 어떻게 정의하는지 설명합니다: [Deferred 조정](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/deferred/).
