---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-hibernate-lettuce/properties-and-hibernate-mapping"
...
1.12.1 테스트는 위 두 값이 각각 `500ms`, `1500ms`로 보존되는지 확인합니다. 즉, sub-second 값을 초로 반올림하지 않습니다.
