---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce"
...
1. [Client와 connection](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce/clients-and-connections/) — 공유 resource, cached connection, pipeline과 종료 책임을 정합니다.
2. [Command와 coroutine](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce/commands-and-coroutines/) — sync/async/coroutine 선택과 future 대기·취소를 다룹니다.
3. [Codec과 직렬화](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce/codecs-and-serialization/) — binary/JSON/primitive codec, 신뢰 경계와 migration을 설명합니다.
4. [Map과 cache loader](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce/maps-and-cache-loading/) — read-through, write-through, write-behind와 1.12.1 Near Cache 범위를 확인합니다.
5. [Filter, script와 분산 primitive](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce/filters-scripts-and-primitives/) — 확률 자료구조와 Lua 기반 원자 연산을 선택합니다.
6. [운영과 생태계 경로](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-lettuce/operations-and-ecosystem/) — 관측·테스트에서 cache, Hibernate, Exposed, workshop으로 이어갑니다.
...
Lettuce core는 API dependency입니다. coroutine, cache-core, Kryo, Fory와 압축 serializer는 선택 기능입니다. 함수 결과 memoization은 [`bluetape4k-cache-lettuce`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-lettuce/), Hibernate second-level cache는 [`bluetape4k-hibernate-cache-lettuce`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate-cache-lettuce/)에서 다룹니다.
...
- [`RedisFutureSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/infra/lettuce/src/main/kotlin/io/bluetape4k/redis/lettuce/RedisFutureSupport.kt)
...
- [`LettuceLoadedMap.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/infra/lettuce/src/main/kotlin/io/bluetape4k/redis/lettuce/map/LettuceLoadedMap.kt)
...
- [`LettuceSuspendedLoadedMapTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/infra/lettuce/src/test/kotlin/io/bluetape4k/redis/lettuce/map/LettuceSuspendedLoadedMapTest.kt)
