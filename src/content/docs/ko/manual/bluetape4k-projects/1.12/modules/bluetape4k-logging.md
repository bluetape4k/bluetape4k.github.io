---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging"
...
![Logger 생성, lazy message, MDC, 비동기 전달의 책임 지도](/manual-assets/bluetape4k-projects/1.12/logging/logger-api-map.svg)
...
1. [Logger foundation](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/logger-foundation/) — logger 이름과 provider 경계
2. [Lazy messages](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/lazy-messages/) — level guard와 supplier 실패
3. [Scoped MDC](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/scoped-mdc/) — 중첩 복원과 exception cleanup
4. [Coroutine MDC](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/coroutine-mdc/) — suspension과 child coroutine 전파
5. [Async channel](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/async-channel/) — buffer, collector, close와 event 유실
6. [Operations & recipes](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/operations-recipes/) — 설정, redaction, 진단과 테스트
...
- [모듈 source](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/bluetape4k/logging/src/main/kotlin/io/bluetape4k/logging)
- [대표 테스트](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/bluetape4k/logging/src/test/kotlin/io/bluetape4k/logging)
- [README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/logging/README.ko.md)
