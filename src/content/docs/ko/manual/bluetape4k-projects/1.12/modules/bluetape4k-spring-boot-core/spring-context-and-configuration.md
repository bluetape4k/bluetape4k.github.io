---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-core/spring-context-and-configuration"
...
[RestClient와 coroutine 경계](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-core/rest-client-and-coroutines/)에서 blocking HTTP client를 suspend API로 사용할 때 유지해야 할 경계를 다룹니다.
