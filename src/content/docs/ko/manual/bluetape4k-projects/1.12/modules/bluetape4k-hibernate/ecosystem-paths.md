---
slug: "ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/ecosystem-paths"
...
| 필요한 것 | 시작할 경로 | 선택 기준 |
| --- | --- | --- |
| SQL·connection·vendor 기능 직접 제어 | [bluetape4k-jdbc](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/) | 작은 adapter, 명시적 mapping과 transaction |
...
| non-blocking persistence | [bluetape4k-hibernate-reactive](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate-reactive/), [bluetape4k-r2dbc](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-r2dbc/) | blocking Session을 coroutine으로 감싸지 않음 |
...
- [JPA Querydsl demo](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-examples-jpa-querydsl-demo/): Spring Data repository, 동적 query와 DTO projection
- [Blaze-Persistence demo](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-examples-jpa-blazepersistence-demo/): Entity View, offset·keyset pagination과 count metadata
- [`SimpleQuerydslExamples`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/test/kotlin/io/bluetape4k/hibernate/querydsl/simple/SimpleQuerydslExamples.kt): 모듈 안에서 바로 실행하는 Querydsl 예제
- [`mapping` tests](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/data/hibernate/src/test/kotlin/io/bluetape4k/hibernate/mapping): association, inheritance, composite·natural id, tree와 localized entity
...
- [`bluetape4k-jdbc` 학습 경로](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/ecosystem-paths/)
- [`bluetape4k-hibernate-reactive`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate-reactive/)
- [`bluetape4k-r2dbc`](/ko/manual/bluetape4k-projects/1.12/modules/bluetape4k-r2dbc/)
