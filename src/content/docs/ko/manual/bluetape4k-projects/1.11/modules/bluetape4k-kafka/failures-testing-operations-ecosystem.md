---
slug: "ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-kafka/failures-testing-operations-ecosystem"
...
| Kafka 4.2.x, Spring Kafka 4.x, Jackson 3 | [`bluetape4k-kafka4`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-kafka4/) | 같은 package를 공유하므로 둘 중 하나만 선택 |
| Logback event를 Kafka로 export | [`bluetape4k-kafka-logback`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-kafka-logback/) | appender/exporter 전용, 일반 producer API 대체 아님 |
| coroutine·Flow 기본기 | [`bluetape4k-coroutines`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-coroutines/) | Kafka delivery 의미는 이 모듈이 설명 |
| Kafka Testcontainer 공통 기반 | [`bluetape4k-testcontainers`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-testcontainers/) | application fixture와 lifecycle은 caller가 구성 |
