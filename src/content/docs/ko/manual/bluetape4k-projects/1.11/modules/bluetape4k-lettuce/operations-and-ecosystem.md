---
slug: "ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-lettuce/operations-and-ecosystem"
title: 운영과 생태계 경로
...
- 함수 결과 memoization과 cache abstraction은 [`bluetape4k-cache-lettuce`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-cache-lettuce/)로 이어갑니다.
- Hibernate second-level cache는 [`bluetape4k-hibernate-cache-lettuce`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-hibernate-cache-lettuce/)를 사용합니다.
- DB read-through/write-through 경계를 직접 설계한다면 [`bluetape4k-jdbc`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-jdbc/), [`bluetape4k-hibernate`](/ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-hibernate/), Exposed repository와 함께 transaction 경계를 먼저 정합니다.
...
- [`Benchmark.ko.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/infra/lettuce/Benchmark.ko.md)
