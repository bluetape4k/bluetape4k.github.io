---
slug: "ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-csv"
...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`CsvRecordReader`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/CsvRecordReader.kt)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API

| Entry point | 확인할 내용 |
| --- | --- |
| [`CsvRecordReader`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/CsvRecordReader.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`CsvRecordWriter`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/CsvRecordWriter.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`CsvSettings`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/CsvSettings.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`CvsParserDefaults`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/CvsParserDefaults.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`Record`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/Record.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`RecordFactory`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/RecordFactory.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`RecordReader`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/RecordReader.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`RecordReaderSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/RecordReaderSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`RecordWriter`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/RecordWriter.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`RecordWriterSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/src/main/kotlin/io/bluetape4k/csv/RecordWriterSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
...
[![CSV/TSV 클래스 구조 다이어그램](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/io-csv-diagram-01.png)](../../assets/readme-diagrams/io-csv-diagram-01.svg)
...
[![CSV/TSV 처리 흐름 다이어그램](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/io-csv-diagram-02.png)](../../assets/readme-diagrams/io-csv-diagram-02.svg)
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/README.ko.md)
- [모듈 build](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/io/csv/build.gradle.kts)
