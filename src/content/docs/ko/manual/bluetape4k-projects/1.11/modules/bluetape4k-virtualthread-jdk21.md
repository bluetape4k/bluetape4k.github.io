---
slug: "ko/manual/bluetape4k-projects/1.11/modules/bluetape4k-virtualthread-jdk21"
...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`Jdk21VirtualThreadRuntime`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/virtualthread/jdk21/src/main/java/io/bluetape4k/concurrent/virtualthread/jdk21/Jdk21VirtualThreadRuntime.java)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API

| Entry point | 확인할 내용 |
| --- | --- |
| [`Jdk21VirtualThreadRuntime`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/virtualthread/jdk21/src/main/java/io/bluetape4k/concurrent/virtualthread/jdk21/Jdk21VirtualThreadRuntime.java) | constructor, function, ownership 계약을 확인합니다. |
| [`Jdk21StructuredTaskScopeProvider`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/virtualthread/jdk21/src/main/kotlin/io/bluetape4k/concurrent/virtualthread/jdk21/Jdk21StructuredTaskScopeProvider.kt) | constructor, function, ownership 계약을 확인합니다. |
...
[![JDK 21 Virtual Thread Runtime 및 StructuredTaskScope Provider 구조](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/virtualthread-jdk21-diagram-01.png)](../../assets/readme-diagrams/virtualthread-jdk21-diagram-01.svg)
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/virtualthread/jdk21/README.ko.md)
- [모듈 build](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/virtualthread/jdk21/build.gradle.kts)
