...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`AvroGenericRecordSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/AvroGenericRecordSerializer.kt)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API

| Entry point | 확인할 내용 |
| --- | --- |
| [`AvroGenericRecordSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/AvroGenericRecordSerializer.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`AvroReflectSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/AvroReflectSerializer.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`AvroSpecificRecordSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/AvroSpecificRecordSerializer.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`CodecFactorySupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/CodecFactorySupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`DefaultAvroGenericRecordSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/impl/DefaultAvroGenericRecordSerializer.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`DefaultAvroReflectSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/impl/DefaultAvroReflectSerializer.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`DefaultAvroSpecificRecordSerializer`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/src/main/kotlin/io/bluetape4k/avro/impl/DefaultAvroSpecificRecordSerializer.kt) | constructor, function, ownership 계약을 확인합니다. |
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/README.ko.md)
- [모듈 build](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/avro/build.gradle.kts)
