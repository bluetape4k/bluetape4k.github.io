...
![Validate at the boundary and preserve invariants](/manual-assets/bluetape4k-projects/core/validation-boundary.svg)
...
![BoundedStack and RingBuffer retain different read orders](/manual-assets/bluetape4k-projects/core/bounded-collection-ordering.svg)
...
![Bound active work and waiting work independently](/manual-assets/bluetape4k-projects/core/concurrent-reducer-capacity.svg)
...
![Register dependencies first so dependents close first](/manual-assets/bluetape4k-projects/core/shutdown-order.svg)
...
- [검증과 불변식](./validation.md)
- [Encoding과 데이터 경계](./encoding-data.md)
- [Bounded collections](./bounded-collections.md)
- [시간과 범위](./time-ranges.md)
- [Concurrency와 lifecycle](./concurrency-lifecycle.md)
- [`bluetape4k-core` tests](https://github.com/bluetape4k/bluetape4k-projects/blob/dda876503926aa16302b4416e3f3a3e2bff26526/bluetape4k/core/src/test/kotlin/io/bluetape4k)
