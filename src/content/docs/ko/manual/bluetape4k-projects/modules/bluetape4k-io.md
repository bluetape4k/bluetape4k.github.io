...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`BOMSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/BOMSupport.kt)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API

| Entry point | 확인할 내용 |
| --- | --- |
| [`BOMSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/BOMSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ByteBufferExtensions`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/ByteBufferExtensions.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ByteBufferInputStream`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/ByteBufferInputStream.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ByteBufferOutputStream`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/ByteBufferOutputStream.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`FileCoroutineSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/FileCoroutineSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`FileSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/FileSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`FileSupportResult`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/FileSupportResult.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`FlushableSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/FlushableSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`HexDumpSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/HexDumpSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`InputStreamSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/src/main/kotlin/io/bluetape4k/io/InputStreamSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/README.ko.md)
- [모듈 build](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/io/build.gradle.kts)
