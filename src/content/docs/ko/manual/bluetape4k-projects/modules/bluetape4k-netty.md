...
위 좌표를 추가하고 Gradle을 refresh한 뒤 필요한 작업을 소유한 가장 작은 entry point에서 시작합니다. 먼저 [`NettyTransportSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/NettyTransportSupport.kt)를 확인합니다. 이 파일이 모듈의 구체적인 source entry point입니다.

## 작업별 API

| Entry point | 확인할 내용 |
| --- | --- |
| [`NettyTransportSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/NettyTransportSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`BitBuf`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/BitBuf.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`BitBufImpl`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/BitBufImpl.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ByteBufExtensions`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/ByteBufExtensions.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`ByteBufUtilSupport`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/ByteBufUtilSupport.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`Medium`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/Medium.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`SmallLong`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/SmallLong.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`Smart`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/Smart.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`UMedium`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/UMedium.kt) | constructor, function, ownership 계약을 확인합니다. |
| [`USmallLong`](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/src/main/kotlin/io/bluetape4k/netty/buffer/USmallLong.kt) | constructor, function, ownership 계약을 확인합니다. |
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/README.ko.md)
- [모듈 build](https://github.com/bluetape4k/bluetape4k-projects/blob/ebe06db0b305bb2df767beb74bba95f79641bcc8/io/netty/build.gradle.kts)
