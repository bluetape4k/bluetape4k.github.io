---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/deferred"
title: Deferred 조정
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-coroutines/deferred.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![awaitAny, awaitAnyAndCancelOthers, firstSuccessTaskScope 비교](/manual-assets/bluetape4k-projects/2.0/coroutines/deferred-race-policy.svg)
...
여러 값이 아니라 stream item의 순서와 병렬도를 조정하려면 [순서 보장과 병렬 Flow](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/flow/)로 이어집니다.
