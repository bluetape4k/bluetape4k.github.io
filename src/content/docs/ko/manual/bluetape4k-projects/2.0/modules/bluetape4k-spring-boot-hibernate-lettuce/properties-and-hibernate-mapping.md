---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-hibernate-lettuce/properties-and-hibernate-mapping"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-spring-boot-hibernate-lettuce/properties-and-hibernate-mapping.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
2.0.0 테스트는 위 두 값이 각각 `500ms`, `1500ms`로 보존되는지 확인합니다. 즉, sub-second 값을 초로 반올림하지 않습니다.
