---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-cassandra/configuration-and-ownership"
title: "구성과 객체 소유권"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-spring-boot-cassandra/configuration-and-ownership.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
구성을 정했다면 [Reactive operations와 coroutine](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-cassandra/reactive-coroutine-operations/)에서 subscription과 빈 결과 계약을 확인합니다. 직접 CQL을 실행한다면 [Async와 저수준 CQL operations](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-cassandra/async-and-cql-operations/)로 이동합니다.
