---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-hibernate-lettuce/testing-and-failure-modes"
title: 테스트와 실패 동작
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-spring-boot-hibernate-lettuce/testing-and-failure-modes.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [`LettuceNearCachePropertiesCustomizerTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/hibernate-lettuce/src/test/kotlin/io/bluetape4k/spring/boot/autoconfigure/cache/lettuce/LettuceNearCachePropertiesCustomizerTest.kt)
...
- [`ReadmeDependencyContractTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/hibernate-lettuce/src/test/kotlin/io/bluetape4k/spring/boot/autoconfigure/cache/lettuce/ReadmeDependencyContractTest.kt)
