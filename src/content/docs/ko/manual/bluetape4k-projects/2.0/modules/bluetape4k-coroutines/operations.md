---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/operations"
title: 운영과 관측 가능성
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-coroutines/operations.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Coroutine boundary의 최소 운영 신호와 deterministic shutdown](/manual-assets/bluetape4k-projects/2.0/coroutines/observability-boundaries.svg)
...
- Lifecycle 구현: [`CloseableCoroutineScope.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/CloseableCoroutineScope.kt)
...
- Subject cancellation tests: [`SubjectCancellationTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/extensions/subject/SubjectCancellationTest.kt)

끝으로 이 계약들을 실행 가능한 조합으로 묶는 [실전 레시피와 Workshop](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/recipes/)을 봅니다.
