---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/cache-spring-separation"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-redis/cache-spring-separation.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
[Cache Core 매뉴얼](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/)은 cache-aside, stampede, Near Cache와 실패 계약을 provider와 분리해 설명합니다. provider 선택 전에 이 추상화가 필요한지 먼저 확인합니다.
...
- [Lettuce Cache](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-lettuce/)
- [Redisson Cache](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-redisson/)
- [Hibernate Cache Lettuce](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/)
- [Spring Boot Redis](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-redis/)
