---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/ecosystem-paths"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-jdbc/ecosystem-paths.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
| aggregate 중심 entity lifecycle, dirty checking, JPA 생태계 | [bluetape4k-hibernate](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate/) | Hibernate Session과 entity mapping을 중심으로 persistence를 구성합니다. |
| coroutine 호출 경로에서 blocking JDBC를 피함 | [bluetape4k-r2dbc](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/) 또는 Exposed R2DBC | non-blocking driver와 suspend transaction 경계를 선택합니다. |
| JPA query 예제를 실제 애플리케이션 형태로 확인 | [JPA QueryDSL demo](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-examples-jpa-querydsl-demo/), [Blaze-Persistence demo](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-examples-jpa-blazepersistence-demo/) | Spring Boot, repository와 query 도구의 결합을 확인할 수 있습니다. |
