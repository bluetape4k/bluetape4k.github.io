---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-logging/logger-foundation"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-logging/logger-foundation.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![KLogging, KotlinLogging, KLoggerFactory와 SLF4J의 책임 경계](/manual-assets/bluetape4k-projects/2.0/logging/logger-api-map.svg)
...
다음: message 계산 비용과 실패를 [Lazy messages](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-logging/lazy-messages/)에서 다룹니다.
