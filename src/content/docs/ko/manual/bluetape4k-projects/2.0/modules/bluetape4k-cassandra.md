---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-cassandra.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
1. **[CqlSession 수명주기와 캐시 경계](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/session-lifecycle/)**
...
2. **[코루틴 쿼리](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/coroutine-queries/)**
...
3. **[Row와 data mapping](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/rows-data-mapping/)**
   `Row`, collection, tuple, UDT와 `CqlDuration`을 Kotlin 값과 도메인 객체로 옮기는 예제를 제공합니다. null을 기본값으로 바꿀 때와 값이 없다는 사실을 보존할 때를 구분할 수 있습니다.
4. **[Statement와 query builder](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/statements-query-builder/)**
...
5. **[운영과 테스트](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/operations-testing/)**
...
keyspace create/drop은 실제 cluster side effect입니다. 운영 권한과 replication 정책을 배포 단계와 분리하고, session 종료 책임, query·paging 실패, batch 크기와 timeout을 관찰합니다. 자세한 기준은 [운영 경계와 Testcontainers 검증](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/operations-testing/)에 정리했습니다.
...
- [`CqlSessionProvider.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/CqlSessionProvider.kt)
- [`CqlSessionSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/CqlSessionSupport.kt)
- [`AsyncCqlSessionSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/cql/AsyncCqlSessionSupport.kt)
- [`RowSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/cql/RowSupport.kt)
- [`StatementSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/cql/StatementSupport.kt)
- [`CqlSessionProviderTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/CqlSessionProviderTest.kt)
- [`CqlSessionSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/CqlSessionSupportTest.kt)
