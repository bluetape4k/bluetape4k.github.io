---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/ecosystem-paths"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-r2dbc/ecosystem-paths.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
| 3 | [`bluetape4k-spring-boot-r2dbc`](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/) | `R2dbcEntityOperations`의 coroutine CRUD와 Flow repository 패턴 |
...
[`bluetape4k-jdbc`](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/)는 blocking driver 위에서 동작하며 단순한 adapter와 vendor SQL에는 여전히 적합합니다. R2DBC를 선택하는 이유는 coroutine 문법 자체가 아니라 요청당 thread를 점유하지 않는 driver와 backpressure-aware 실행 모델이 필요하기 때문입니다.
...
- [`bluetape4k-coroutines`](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/)
- [`bluetape4k-spring-boot-r2dbc`](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/)
- [`bluetape4k-testcontainers`](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-testcontainers/)
- [`bluetape4k-jdbc`](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/)
