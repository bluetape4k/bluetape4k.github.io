---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/bounded-collections"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-core/bounded-collections.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Capacity 3에서 BoundedStack과 RingBuffer의 ordering 비교](/manual-assets/bluetape4k-projects/2.0/core/bounded-collection-ordering.svg)
...
실행 중/대기 중 비동기 work의 capacity는 collection이 아니라 [Concurrency와 lifecycle](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/concurrency-lifecycle/)에서 다룹니다.
