---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/recipes"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-coroutines/recipes.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
| --- | --- | --- |
| Flow 병렬 enrichment | [`kotlin/flow-extensions-parallel-enrichment`](https://github.com/bluetape4k/bluetape4k-workshop/tree/develop/kotlin/flow-extensions-parallel-enrichment) | [Flow](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/flow/) |
| race와 fallback 차이 | [`kotlin/flow-extensions-race-fallback`](https://github.com/bluetape4k/bluetape4k-workshop/tree/develop/kotlin/flow-extensions-race-fallback) | [Deferred](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/deferred/) |
| Subject delivery 비교 | [`kotlin/flow-extensions-subject-bridge`](https://github.com/bluetape4k/bluetape4k-workshop/tree/develop/kotlin/flow-extensions-subject-bridge) | [Subjects](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/subjects/) |
| Web request lifecycle | [`spring-boot/webflux-coroutines`](https://github.com/bluetape4k/bluetape4k-workshop/tree/develop/spring-boot/webflux-coroutines) | [Lifecycle](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/lifecycle/) |
| trace/metric propagation | [`observability/micrometer-tracing-coroutines`](https://github.com/bluetape4k/bluetape4k-workshop/tree/develop/observability/micrometer-tracing-coroutines) | [Operations](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/operations/) |
...
모듈 전체 선택 지도로 돌아가려면 [Coroutine과 Flow 확장](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/)을 봅니다.
