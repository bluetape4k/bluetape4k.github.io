---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/flow"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-coroutines/flow.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![flow.async의 ordered emission과 mapParallel의 completion-order emission](/manual-assets/bluetape4k-projects/2.0/coroutines/ordered-parallel-flow.svg)
...
Callback 또는 hot stream의 delivery 의미가 필요하면 [Subject와 이벤트 계약](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/subjects/)으로 이어집니다.
