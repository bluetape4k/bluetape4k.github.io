---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/structured-concurrency"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-coroutines/structured-concurrency.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![taskScope, firstSuccessTaskScope, supervisedTaskScope 정책 비교](/manual-assets/bluetape4k-projects/2.0/coroutines/structured-policies.svg)
...
선택한 정책을 production에서 관찰하고 종료하는 방법은 [운영과 관측 가능성](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/operations/)에서 다룹니다.
