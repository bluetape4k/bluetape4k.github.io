---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/validation"
title: 검증과 불변식
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-core/validation.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Caller argument, object state, domain rule 검증 경계](/manual-assets/bluetape4k-projects/2.0/core/validation-boundary.svg)
...
검증한 값을 고정된 memory budget에 보관하는 방법은 [Bounded collections](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/bounded-collections/)에서 이어집니다.
