---
slug: "ko/manual/bluetape4k-projects/2.0/modules/web-framework-benchmark"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/web-framework-benchmark.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [모듈 README](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/benchmark/web-framework-benchmark/README.ko.md)
- [모듈 build](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/benchmark/web-framework-benchmark/build.gradle.kts)
