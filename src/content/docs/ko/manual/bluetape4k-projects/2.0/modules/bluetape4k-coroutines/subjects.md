---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/subjects"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-coroutines/subjects.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Publish, Behavior, Replay, Multicast, UnicastWork Subject 계약 비교](/manual-assets/bluetape4k-projects/2.0/coroutines/subject-contracts.svg)
...
다음은 child failure의 의미를 scope 수준에서 정하는 [Structured concurrency 정책](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/structured-concurrency/)입니다.
