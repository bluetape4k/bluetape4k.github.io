---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/resultset-mapping"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-jdbc/resultset-mapping.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
조회 결과를 값으로 옮기는 규칙을 정했다면 [트랜잭션과 상태 복원](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/transactions/)에서 여러 statement의 성공·실패 경계를 묶습니다.
