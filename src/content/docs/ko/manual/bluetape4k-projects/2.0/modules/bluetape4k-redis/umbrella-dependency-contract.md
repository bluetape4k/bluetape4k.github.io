---
slug: "ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/umbrella-dependency-contract"
title: 우산 의존성 계약
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/ko/modules/bluetape4k-redis/umbrella-dependency-contract.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
2.0.0의 [`infra/redis/build.gradle.kts`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/infra/redis/build.gradle.kts)는 다음 두 의존성만 선언합니다.
...
실제 client API와 실패 계약은 [Lettuce 매뉴얼](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-lettuce/)과 [Redisson 매뉴얼](/ko/manual/bluetape4k-projects/2.0/modules/bluetape4k-redisson/)에 있습니다.
