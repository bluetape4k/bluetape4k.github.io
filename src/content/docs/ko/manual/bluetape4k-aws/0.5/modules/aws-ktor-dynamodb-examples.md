---
slug: "ko/manual/bluetape4k-aws/0.5/modules/aws-ktor-dynamodb-examples"
...
_배포본 README: [`examples/aws-ktor-dynamodb-examples/README.ko.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/664e4dfb544a3c19db484b0f9a8e023a73774b49/examples/aws-ktor-dynamodb-examples/README.ko.md)_

<!-- release-readme-diagrams:end -->

## 근거 소스

- [Route, table, mapper와 repository](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-ktor-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutes.kt)
- [Emulator 기반 route 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-ktor-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutesLocalStackTest.kt)
- [예제 설명](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-ktor-dynamodb-examples/README.ko.md)
