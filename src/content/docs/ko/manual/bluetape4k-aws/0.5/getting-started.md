---
slug: "ko/manual/bluetape4k-aws/0.5/getting-started"
...
자세한 기준은 [SDK 선택 가이드](/ko/manual/bluetape4k-aws/0.5/guides/sdk-selection/)에 정리했다.
...
문법 취향보다는 설정과 자원의 수명 주기를 누가 맡는지 보고 선택해야 한다. [Spring Boot와 Ktor 비교](/ko/manual/bluetape4k-aws/0.5/guides/spring-vs-ktor/)에 차이를 정리했다.
