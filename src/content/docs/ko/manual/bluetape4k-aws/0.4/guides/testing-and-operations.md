---
slug: "ko/manual/bluetape4k-aws/0.4/guides/testing-and-operations"
...
![Floci 우선 emulator 테스트 흐름](/manual-assets/bluetape4k-aws/0.4/testing/emulator-flow.png)
...
- [Java 모듈 emulator 선택](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/aws-java/src/test/kotlin/io/bluetape4k/aws/AbstractAwsTest.kt)
- [Kotlin 모듈 emulator 선택](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/aws-kotlin/src/test/kotlin/io/bluetape4k/aws/kotlin/AbstractAwsTest.kt)
- [Kotlin client lifecycle 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/aws-kotlin/src/test/kotlin/io/bluetape4k/aws/kotlin/lifecycle/ClientLifecycleTest.kt)
- [Spring emulator 선택기](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/aws-spring-boot/src/test/kotlin/io/bluetape4k/aws/spring/test/AwsSpringBootTestEmulator.kt)
- [Ktor SQS 종료 계약](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/aws-ktor/src/main/kotlin/io/bluetape4k/aws/ktor/sqs/SqsConsumerRuntime.kt)
