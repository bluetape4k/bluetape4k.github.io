---
slug: "ko/manual/bluetape4k-aws/0.4/modules/aws-ktor-sqs-examples"
...
manual:
  ...
  sourcePath: "docs/manual/ko/modules/aws-ktor-sqs-examples.md"
  minorVersion: "0.4"
  releaseRef: "0.4.0"
...
[![Bluetape4k AWS ktor sqs examples 아키텍처](/manual-assets/bluetape4k-aws/0.4/readme-diagrams/examples-aws-ktor-sqs-examples-architecture-01.png)](../../assets/readme-diagrams/examples-aws-ktor-sqs-examples-architecture-01.svg)
...
- [Consumer와 route](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/examples/aws-ktor-sqs-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/sqs/SqsExampleRoutes.kt)
- [Floci 통합 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/examples/aws-ktor-sqs-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/sqs/SqsExampleRoutesFlociTest.kt)
- [예제 설명](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/examples/aws-ktor-sqs-examples/README.ko.md)
