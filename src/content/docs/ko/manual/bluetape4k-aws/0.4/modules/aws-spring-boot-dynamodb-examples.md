---
slug: "ko/manual/bluetape4k-aws/0.4/modules/aws-spring-boot-dynamodb-examples"
...
[![Bluetape4k AWS spring boot dynamodb examples 아키텍처](/manual-assets/bluetape4k-aws/0.4/readme-diagrams/examples-aws-spring-boot-dynamodb-examples-architecture-01.png)](../../assets/readme-diagrams/examples-aws-spring-boot-dynamodb-examples-architecture-01.svg)
...
- [Application과 controller](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/examples/aws-spring-boot-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderController.kt)
...
- [Emulator 기반 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/0.4.0/examples/aws-spring-boot-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderControllerLocalStackTest.kt)
