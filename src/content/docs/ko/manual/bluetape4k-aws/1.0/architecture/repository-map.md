---
slug: "ko/manual/bluetape4k-aws/1.0/architecture/repository-map"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/ko/architecture/repository-map.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
`1.0.0` 릴리스에는 Gradle 프로젝트 14개가 있다. 배포하는 라이브러리와 플랫폼이 6개이고, 직접 실행해 볼 수 있는 예제가 8개다. 이름순으로 훑기보다 역할에 따라 다섯 층으로 나누어 보면 흐름이 선명해진다.

![AWS 저장소 모듈 지도](/manual-assets/bluetape4k-aws/1.0/overview/repository-module-map.png)
...
이 지도에는 `1.0.0` 태그의 `settings.gradle.kts`에 등록된 프로젝트만 포함한다. `develop`에서 이미 보이는 새 프로젝트라도 다음 안정 버전이 나오기 전에는 이 매뉴얼의 기준에 넣지 않는다.
...
_배포본 README: [`README.ko.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/632e0f346b807c4d50e3195f7b2b72082def9460/README.ko.md)_
...
- [Gradle 프로젝트 등록부](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/settings.gradle.kts)
- [AWS platform 설정](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/bom/build.gradle.kts)
- [저장소 모듈 개요](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/README.ko.md)
