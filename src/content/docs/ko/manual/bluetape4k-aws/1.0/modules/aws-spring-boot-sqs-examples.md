---
slug: "ko/manual/bluetape4k-aws/1.0/modules/aws-spring-boot-sqs-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/ko/modules/aws-spring-boot-sqs-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [AWS resource 관리 service](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-spring-boot-sqs-examples/src/main/kotlin/io/bluetape4k/aws/examples/spring/sqs/SqsSnsExampleService.kt)
- [SQS/SNS 통합 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-spring-boot-sqs-examples/src/test/kotlin/io/bluetape4k/aws/examples/spring/sqs/SqsSnsExampleLocalStackTest.kt)
