---
slug: "ko/manual/bluetape4k-aws/1.0/modules/aws-ktor-dynamodb-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/ko/modules/aws-ktor-dynamodb-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
_배포본 README: [`examples/aws-ktor-dynamodb-examples/README.ko.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/632e0f346b807c4d50e3195f7b2b72082def9460/examples/aws-ktor-dynamodb-examples/README.ko.md)_

<!-- release-readme-diagrams:end -->

## 근거 소스

- [Route, table, mapper와 repository](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutes.kt)
- [Emulator 기반 route 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutesLocalStackTest.kt)
- [예제 설명](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-dynamodb-examples/README.ko.md)
