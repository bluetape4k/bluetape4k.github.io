---
slug: "ko/manual/bluetape4k-aws/1.0/modules/aws-ktor-exposed-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/ko/modules/aws-ktor-exposed-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [Application과 plugin 설정](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-exposed-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/exposed/ExposedExampleApplication.kt)
- [Table과 repository](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-exposed-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/exposed/OrderDomain.kt)
- [PostgreSQL route 테스트](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-exposed-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/exposed/ExposedExampleApplicationTest.kt)
