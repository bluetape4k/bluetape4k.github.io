...
blog:
  ...
  imageAlt: 많은 lightweight execution path를 명시적 한계 안에서 다루는 소개용 일러스트
  cardDescription: "Blocking code를 다시 꺼내도 된다는 반가운 소식. 단, timeout과 resource limit까지 같이 챙길 때만."
---

<figure class="bt4k-blog-hero">
  <img src="/assets/virtual-threads-part1-hero.png" alt="많은 lightweight execution path를 명시적 한계 안에서 다루는 소개용 일러스트" loading="eager" />
  <figcaption>Virtual thread는 값싼 thread이지, blocking 무제한 이용권은 아니다.</figcaption>
</figure>
