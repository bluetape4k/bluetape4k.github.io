...
blog:
  ...
  imageAlt: 실전 virtual thread rule이 checklist로 정리되는 소개용 일러스트
  cardDescription: "Virtual Threads를 켰다고 끝이 아니다. pool, semaphore, context, lock에서 바로 티가 나는 실전 규칙들."
---

<figure class="bt4k-blog-hero">
  <img src="/assets/virtual-threads-part2-hero.png" alt="실전 virtual thread rule이 checklist로 정리되는 소개용 일러스트" loading="eager" />
  <figcaption>쓸모 있는 rule은 JDBC pool, lock, shutdown path와 부딪혀도 살아남는 rule이다.</figcaption>
</figure>
