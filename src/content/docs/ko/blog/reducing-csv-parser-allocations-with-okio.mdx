...
blog:
  ...
  cardDescription: "#651 CSV parser 최적화 작업을 Reader 기반 파싱에서 Okio UnsafeCursor segment scanning까지 benchmark와 함께 정리합니다."
---
...
<figure class="bt4k-architecture">
  ...
  <figcaption>#651 CSV parser 최적화 작업을 Reader 기반 파싱에서 Okio UnsafeCursor segment scanning까지 benchmark와 함께 정리합니다.</figcaption>
</figure>
