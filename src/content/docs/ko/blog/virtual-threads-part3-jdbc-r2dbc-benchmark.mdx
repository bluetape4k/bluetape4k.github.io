...
<figure class="bt4k-blog-hero">
  ...
  <figcaption>첫 이미지는 database concurrency 이야기를 열고, chart는 benchmark evidence 쪽에 둔다.</figcaption>
</figure>
...
<figure class="bt4k-architecture">
  ...
  <figcaption>R2DBC가 당연히 이길 줄 알았는데, benchmark 결과는 꽤 달랐다. JDBC + Virtual Threads의 반격.</figcaption>
</figure>
