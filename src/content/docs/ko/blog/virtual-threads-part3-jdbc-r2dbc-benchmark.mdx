...
sidebar:
  order: -202605291102
blog:
  date: 2026-05-29T11:23:59+09:00
...
<figure class="bt4k-architecture">
  <img src="/assets/virtual-threads-part3-exposed-jdbc-01-ko.png" alt="일반 Exposed JDBC 벤치마크의 baseline부터 tuning 이후까지 총 처리량 차트" loading="lazy" />
...
<figure class="bt4k-architecture">
  <img src="/assets/virtual-threads-part3-benchmark-01-ko.png" alt="대형 end-to-end batch job의 JDBC vs R2DBC 벤치마크 차트" loading="lazy" />
