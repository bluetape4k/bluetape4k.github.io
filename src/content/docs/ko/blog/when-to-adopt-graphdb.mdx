...
<figure class="bt4k-architecture">
  <img src="/assets/graphdb-adoption-latency-chart-ko.png" alt="Neo4j, AGE, PostgreSQL recursive CTE, PostgreSQL iterative traversal을 비교한 authorization inheritance benchmark chart" loading="lazy" />
