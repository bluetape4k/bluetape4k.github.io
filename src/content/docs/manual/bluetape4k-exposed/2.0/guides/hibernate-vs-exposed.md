---
slug: "manual/bluetape4k-exposed/2.0/guides/hibernate-vs-exposed"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/guides/hibernate-vs-exposed.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
[![JPA and Exposed architecture comparison](/manual-assets/bluetape4k-exposed/2.0/persistence/jpa-exposed-comparison.en.png)](../../assets/persistence/jpa-exposed-comparison.en.svg)
...
Start with [JDBC vs R2DBC](/manual/bluetape4k-exposed/2.0/guides/jdbc-vs-r2dbc/) and [transaction boundaries](/manual/bluetape4k-exposed/2.0/guides/transaction-boundaries/), then build one representative repository before choosing a broad migration.
