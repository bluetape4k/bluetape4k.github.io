---
slug: "manual/bluetape4k-exposed/2.0/guides/serialization-and-encryption"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/guides/serialization-and-encryption.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
4. Place the transformation inside the transaction model described by [transaction boundaries](/manual/bluetape4k-exposed/2.0/guides/transaction-boundaries/).
5. Write migration and rollback evidence before changing an established column contract.

## Sources

- [Jackson 2 column](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jackson2/src/main/kotlin/io/bluetape4k/exposed/core/jackson/JacksonColumnType.kt)
- [Jackson 3 column](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jackson3/src/main/kotlin/io/bluetape4k/exposed/core/jackson3/JacksonColumnType.kt)
- [Fastjson2 column](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/fastjson2/src/main/kotlin/io/bluetape4k/exposed/core/fastjson2/FastjsonColumnType.kt)
- [Tink table DSL](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/main/kotlin/io/bluetape4k/exposed/core/tink/Tables.kt)
- [Tink associated data](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/main/kotlin/io/bluetape4k/exposed/core/tink/TinkColumnAssociatedDataProvider.kt)
- [Measured columns](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/measured/src/main/kotlin/io/bluetape4k/exposed/core/measured/MeasuredColumnTypes.kt)
