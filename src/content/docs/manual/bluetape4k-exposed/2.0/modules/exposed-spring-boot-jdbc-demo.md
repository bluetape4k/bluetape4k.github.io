---
slug: "manual/bluetape4k-exposed/2.0/modules/exposed-spring-boot-jdbc-demo"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/exposed-spring-boot-jdbc-demo.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [Demo overview](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/README.md)
- [Transaction configuration](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/src/main/kotlin/io/bluetape4k/examples/exposed/mvc/config/ExposedConfig.kt)
- [Controller transaction and DTO boundary](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/src/main/kotlin/io/bluetape4k/examples/exposed/mvc/controller/ProductController.kt)
- [Repository contract](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/src/main/kotlin/io/bluetape4k/examples/exposed/mvc/repository/ProductJdbcRepository.kt)
- [Controller tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/examples/jdbc-demo/src/test/kotlin/io/bluetape4k/examples/exposed/mvc/ProductControllerTest.kt)
