---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-mysql8"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-mysql8.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Read the [database adapter matrix](/manual/bluetape4k-exposed/2.0/guides/database-adapter-matrix/), implement one point query, then add complex geometry and indexes. Follow the JDBC [transaction boundary guide](/manual/bluetape4k-exposed/2.0/guides/transaction-boundaries/).
...
- [Geometry column types](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/mysql8/src/main/kotlin/io/bluetape4k/exposed/mysql8/gis/GeoColumnTypes.kt)
- [Spatial functions](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/mysql8/src/main/kotlin/io/bluetape4k/exposed/mysql8/gis/SpatialFunctions.kt)
...
- [Geometry release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/mysql8/src/test/kotlin/io/bluetape4k/exposed/mysql8/gis/GeometryColumnTypeTest.kt)
