---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-cache"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-cache.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Start by choosing the concrete backend in the [cache selection guide](/manual/bluetape4k-exposed/2.0/guides/cache-selection/), then implement the table mapping in that backend's abstract repository.
...
1. Read the [cache selection guide](/manual/bluetape4k-exposed/2.0/guides/cache-selection/) to choose local, remote, or near cache.
...
- [Module overview](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/cache/README.md)
