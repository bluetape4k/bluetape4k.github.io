---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/operations-testing"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-jdbc/operations-testing.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [JDBC `withDb`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-tests/src/main/kotlin/io/bluetape4k/exposed/tests/WithDB.kt)
- [JDBC `withTables`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-tests/src/main/kotlin/io/bluetape4k/exposed/tests/WithTables.kt)
- [Suspending JDBC test helper](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-tests/src/main/kotlin/io/bluetape4k/exposed/tests/WithDBSuspending.kt)
- [JDBC assertions](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-tests/src/main/kotlin/io/bluetape4k/exposed/tests/Assertions.kt)
- [Repository integration tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/test/kotlin/io/bluetape4k/exposed/jdbc/repository/MovieJdbcRepositoryTest.kt)
