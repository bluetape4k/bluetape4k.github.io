---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-jdbc.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![JDBC or R2DBC decision](/manual-assets/bluetape4k-exposed/2.0/persistence/path-decision.png)
...
- [JDBC build](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/build.gradle.kts)
...
- [Auditable repository](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/main/kotlin/io/bluetape4k/exposed/jdbc/repository/AuditableJdbcRepository.kt)
- [Repository tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc/src/test/kotlin/io/bluetape4k/exposed/jdbc/repository/ActorJdbcRepositoryTest.kt)
