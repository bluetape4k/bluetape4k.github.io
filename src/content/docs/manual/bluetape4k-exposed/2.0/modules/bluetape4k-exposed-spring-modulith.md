---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-spring-modulith"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-spring-modulith.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Spring Modulith publication lifecycle](/manual-assets/bluetape4k-exposed/2.0/spring/modulith-publication.png)
...
Read [Audit with JaVers](/manual/bluetape4k-exposed/2.0/guides/audit-with-javers/) to separate delivery reliability from audit/history requirements. Continue with the [bluetape4k JaVers repository](https://github.com/bluetape4k/bluetape4k-javers) when snapshots and diffs are required.
...
_Release README: [`spring-boot/spring-modulith/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/d632a0bc0662ae616b786f552150a7fabd1cee3e/spring-boot/spring-modulith/README.md)_
...
- [`ExposedEventPublicationRepository.kt`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/spring-boot/spring-modulith/src/main/kotlin/io/bluetape4k/spring/modulith/exposed/ExposedEventPublicationRepository.kt)
- [`ExposedEventPublicationTable.kt`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/spring-boot/spring-modulith/src/main/kotlin/io/bluetape4k/spring/modulith/exposed/ExposedEventPublicationTable.kt)
- [`ExposedModulithAutoConfiguration.kt`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/spring-boot/spring-modulith/src/main/kotlin/io/bluetape4k/spring/modulith/exposed/config/ExposedModulithAutoConfiguration.kt)
- [`ExposedModulithProperties.kt`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/spring-boot/spring-modulith/src/main/kotlin/io/bluetape4k/spring/modulith/exposed/config/ExposedModulithProperties.kt)
