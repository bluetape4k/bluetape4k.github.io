---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc-caffeine"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-jdbc-caffeine.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Use this module when in-process Caffeine is the chosen backend and the persistence path is blocking JDBC or suspended JDBC. Compare all six adapters in the [cache selection guide](/manual/bluetape4k-exposed/2.0/guides/cache-selection/) before adding infrastructure.
...
- [Module README](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-caffeine/README.md)
- [Abstract repository](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-caffeine/src/main/kotlin/io/bluetape4k/exposed/jdbc/caffeine/repository/AbstractJdbcCaffeineRepository.kt)
- [Module build](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-caffeine/build.gradle.kts)
