---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-measured"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-measured.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Start with the [serialization and encryption guide](/manual/bluetape4k-exposed/2.0/guides/serialization-and-encryption/) for the broader typed-column boundary. Then read the table DSL tests, which cover every convenience unit, and the column-type tests for error and precision behavior.
...
_Release README: [`exposed/measured/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/d632a0bc0662ae616b786f552150a7fabd1cee3e/exposed/measured/README.md)_
...
- [Gradle build file](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/measured/build.gradle.kts)
- [Measured column types](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/measured/src/main/kotlin/io/bluetape4k/exposed/core/measured/MeasuredColumnTypes.kt)
- [DSL coverage](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/measured/src/test/kotlin/io/bluetape4k/exposed/core/measured/TableDslMeasuredColumnsTest.kt)
- [Round-trip tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/measured/src/test/kotlin/io/bluetape4k/exposed/core/measured/MeasuredColumnTypesTest.kt)
