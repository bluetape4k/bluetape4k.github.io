---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-tink"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-tink.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Read the [serialization and encryption guide](/manual/bluetape4k-exposed/2.0/guides/serialization-and-encryption/) first, then inspect `TinkTableTest` for DSL validation and associated-data behavior, `TinkColumnTypeTest` for AEAD, and `TinkDaeadColumnTypeTest` for deterministic lookup behavior.
...
_Release README: [`exposed/tink/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/d632a0bc0662ae616b786f552150a7fabd1cee3e/exposed/tink/README.md)_
...
- [Gradle build file](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/build.gradle.kts)
- [Table DSL](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/main/kotlin/io/bluetape4k/exposed/core/tink/Tables.kt)
- [Associated-data provider](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/main/kotlin/io/bluetape4k/exposed/core/tink/TinkColumnAssociatedDataProvider.kt)
- [AEAD tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/test/kotlin/io/bluetape4k/exposed/core/tink/TinkColumnTypeTest.kt)
- [DAEAD tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/tink/src/test/kotlin/io/bluetape4k/exposed/core/tink/TinkDaeadColumnTypeTest.kt)
