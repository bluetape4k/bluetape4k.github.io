---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-duckdb"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-duckdb.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Start with the [database adapter matrix](/manual/bluetape4k-exposed/2.0/guides/database-adapter-matrix/), then compare the workload in [OLTP vs OLAP](/manual/bluetape4k-exposed/2.0/guides/oltp-vs-olap/). Move to a server adapter only when shared availability or database-managed concurrency becomes part of the requirement.
...
- [Database release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/duckdb/src/test/kotlin/io/bluetape4k/exposed/duckdb/DuckDBDatabaseTest.kt)
