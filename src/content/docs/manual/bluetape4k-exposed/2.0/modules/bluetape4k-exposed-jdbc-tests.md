---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc-tests"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-jdbc-tests.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Use it with [JDBC operations and testing](/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/operations-testing/) after learning [transaction ownership](/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-jdbc/transaction-ownership/).
...
- [Test module build](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/jdbc-tests/build.gradle.kts)
