---
slug: "manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-r2dbc/coroutine-transactions"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-exposed/en/modules/bluetape4k-exposed-r2dbc/coroutine-transactions.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [`R2dbcRepository.kt`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/r2dbc/src/main/kotlin/io/bluetape4k/exposed/r2dbc/repository/R2dbcRepository.kt)
- [`VirtualThreadTransaction.kt`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/r2dbc/src/main/kotlin/io/bluetape4k/exposed/r2dbc/VirtualThreadTransaction.kt)
...
- [`exposed/r2dbc/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/2.0.0/exposed/r2dbc/README.md)

Continue with [repository patterns](/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-r2dbc/repository-patterns/), then validate failure behavior in [cancellation and testing](/manual/bluetape4k-exposed/2.0/modules/bluetape4k-exposed-r2dbc/cancellation-and-testing/).
