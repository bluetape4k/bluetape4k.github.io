---
slug: "manual/bluetape4k-exposed/1.11/guides/database-adapter-matrix"
...
![Release 1.11 database adapter map](/manual-assets/bluetape4k-exposed/1.11/database/adapter-map.png)
...
Continue with [OLTP vs OLAP](/manual/bluetape4k-exposed/1.11/guides/oltp-vs-olap/) before mixing a transactional source and analytical sink.

## Sources

- [Release manifest](../../manifest.yaml)
- [Release project registry](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/settings.gradle.kts)
- [ClickHouse example](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/examples/exposed-clickhouse-oltp-olap/README.md)
- [BigQuery dry-run example](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/examples/exposed-bigquery-dry-run/README.md)
