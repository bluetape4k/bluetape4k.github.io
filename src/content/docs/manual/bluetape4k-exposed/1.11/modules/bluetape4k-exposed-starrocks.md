---
slug: "manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-starrocks"
...
Read the [database adapter matrix](/manual/bluetape4k-exposed/1.11/guides/database-adapter-matrix/) and [OLTP vs OLAP guide](/manual/bluetape4k-exposed/1.11/guides/oltp-vs-olap/). Expand from connection → DDL → one insert → one read, adding evidence before relying on any new feature.
...
- [Database release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/starrocks/src/test/kotlin/io/bluetape4k/exposed/starrocks/StarRocksDatabaseTest.kt)
