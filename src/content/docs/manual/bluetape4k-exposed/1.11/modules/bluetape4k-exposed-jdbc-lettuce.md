---
slug: "manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-jdbc-lettuce"
...
Use this module when Redis through Lettuce is the chosen backend and the persistence path is blocking JDBC; a separate suspended repository supports coroutine calls. Compare all six adapters in the [cache selection guide](/manual/bluetape4k-exposed/1.11/guides/cache-selection/) before adding infrastructure.
...
- [Module README](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/jdbc-lettuce/README.md)
- [Abstract repository](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/jdbc-lettuce/src/main/kotlin/io/bluetape4k/exposed/lettuce/repository/AbstractJdbcLettuceRepository.kt)
- [Module build](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/jdbc-lettuce/build.gradle.kts)
