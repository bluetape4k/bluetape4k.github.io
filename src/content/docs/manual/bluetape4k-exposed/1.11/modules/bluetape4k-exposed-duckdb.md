---
slug: "manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-duckdb"
...
Start with the [database adapter matrix](/manual/bluetape4k-exposed/1.11/guides/database-adapter-matrix/), then compare the workload in [OLTP vs OLAP](/manual/bluetape4k-exposed/1.11/guides/oltp-vs-olap/). Move to a server adapter only when shared availability or database-managed concurrency becomes part of the requirement.
...
[![DuckDB query flow materialization](/manual-assets/bluetape4k-exposed/1.11/readme-diagrams/exposed-duckdb-flow-02.png)](../../assets/readme-diagrams/exposed-duckdb-flow-02.svg)
...
- [Database release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/duckdb/src/test/kotlin/io/bluetape4k/exposed/duckdb/DuckDBDatabaseTest.kt)
