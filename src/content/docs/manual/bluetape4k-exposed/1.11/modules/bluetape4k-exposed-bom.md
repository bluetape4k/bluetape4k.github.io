---
slug: "manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-bom"
...
Continue with [Getting started](/manual/bluetape4k-exposed/1.11/getting-started/), then choose [JDBC or R2DBC](/manual/bluetape4k-exposed/1.11/guides/jdbc-vs-r2dbc/). Workshop repositories use the same central dependency-management entry point.
...
- [BOM build](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/exposed/bom/build.gradle.kts)
- [Repository settings](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/settings.gradle.kts)
