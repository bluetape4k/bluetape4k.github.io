---
slug: "manual/bluetape4k-exposed/1.11/modules/examples-exposed-clickhouse-oltp-olap"
...
Read [ClickHouse adapter](/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-clickhouse/), [OLTP vs OLAP](/manual/bluetape4k-exposed/1.11/guides/oltp-vs-olap/), and the [bluetape4k workshop](https://github.com/bluetape4k/bluetape4k-workshop).
...
Continue with the [ClickHouse adapter](/manual/bluetape4k-exposed/1.11/modules/bluetape4k-exposed-clickhouse/) for supported DDL and transactions, then use [OLTP vs OLAP](/manual/bluetape4k-exposed/1.11/guides/oltp-vs-olap/) to design the production handoff.
...
[![OLTP to OLAP integration test flow](/manual-assets/bluetape4k-exposed/1.11/readme-diagrams/examples-exposed-clickhouse-oltp-olap-flow-02.png)](../../assets/readme-diagrams/examples-exposed-clickhouse-oltp-olap-flow-02.svg)
...
- [Example sources](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/examples/exposed-clickhouse-oltp-olap/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.11.0/examples/exposed-clickhouse-oltp-olap/build.gradle.kts)
