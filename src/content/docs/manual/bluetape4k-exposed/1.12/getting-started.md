---
slug: "manual/bluetape4k-exposed/1.12/getting-started"
...
1. Read [`core`](/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-core/) and [`dao`](/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-dao/) for IDs, entities, and mapping.
2. Build repository and transaction boundaries with either [`jdbc`](/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-jdbc/) or [`r2dbc`](/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-r2dbc/).
3. Add caches, database adapters, and Spring Boot or Ktor integration only after the base path is tested.
4. Use the [learning path](/manual/bluetape4k-exposed/1.12/guides/learning-path/) for runnable follow-up material.
