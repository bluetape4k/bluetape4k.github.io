---
slug: "manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-measured"
...
Start with the [serialization and encryption guide](/manual/bluetape4k-exposed/1.12/guides/serialization-and-encryption/) for the broader typed-column boundary. Then read the table DSL tests, which cover every convenience unit, and the column-type tests for error and precision behavior.
...
- [Gradle build file](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/measured/build.gradle.kts)
- [Measured column types](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/measured/src/main/kotlin/io/bluetape4k/exposed/core/measured/MeasuredColumnTypes.kt)
- [DSL coverage](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/measured/src/test/kotlin/io/bluetape4k/exposed/core/measured/TableDslMeasuredColumnsTest.kt)
- [Round-trip tests](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/measured/src/test/kotlin/io/bluetape4k/exposed/core/measured/MeasuredColumnTypesTest.kt)
