---
slug: "manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-bigquery"
...
Begin with [the BigQuery dry-run example](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/examples/exposed-bigquery-dry-run/README.md), then use the [adapter matrix](/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/) and [OLTP vs OLAP guide](/manual/bluetape4k-exposed/1.12/guides/oltp-vs-olap/) to decide whether BigQuery owns execution or is reached through Trino.
...
_Release README: [`exposed/bigquery/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/exposed/bigquery/README.md)_
...
- [`BigQueryContext`](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/bigquery/src/main/kotlin/io/bluetape4k/exposed/bigquery/BigQueryContext.kt)
- [`BigQueryQueryExecutor`](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/bigquery/src/main/kotlin/io/bluetape4k/exposed/bigquery/BigQueryQueryExecutor.kt)
- [`BigQueryQueryOptions`](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/bigquery/src/main/kotlin/io/bluetape4k/exposed/bigquery/BigQueryQueryOptions.kt)
- [Context release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/bigquery/src/test/kotlin/io/bluetape4k/exposed/bigquery/BigQueryContextUnitTest.kt)
