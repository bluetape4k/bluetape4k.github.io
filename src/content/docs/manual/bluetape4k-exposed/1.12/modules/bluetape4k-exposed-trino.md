---
slug: "manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-trino"
...
Compare the adapter in the [database matrix](/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/) and read [OLTP vs OLAP](/manual/bluetape4k-exposed/1.12/guides/oltp-vs-olap/). Validate one representative query and one unsupported write against the actual production connector before broad adoption.
...
_Release README: [`exposed/trino/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/exposed/trino/README.md)_
...
- [Database release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/trino/src/test/kotlin/io/bluetape4k/exposed/trino/TrinoDatabaseTest.kt)
