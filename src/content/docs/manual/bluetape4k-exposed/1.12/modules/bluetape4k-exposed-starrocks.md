---
slug: "manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-starrocks"
...
Read the [database adapter matrix](/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/) and [OLTP vs OLAP guide](/manual/bluetape4k-exposed/1.12/guides/oltp-vs-olap/). Expand from connection → DDL → one insert → one read, adding evidence before relying on any new feature.
...
_Release README: [`exposed/starrocks/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/exposed/starrocks/README.md)_
...
- [Database release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/starrocks/src/test/kotlin/io/bluetape4k/exposed/starrocks/StarRocksDatabaseTest.kt)
