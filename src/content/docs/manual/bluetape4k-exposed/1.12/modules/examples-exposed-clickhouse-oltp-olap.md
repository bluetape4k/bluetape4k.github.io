---
slug: "manual/bluetape4k-exposed/1.12/modules/examples-exposed-clickhouse-oltp-olap"
...
Read [ClickHouse adapter](/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-clickhouse/), [OLTP vs OLAP](/manual/bluetape4k-exposed/1.12/guides/oltp-vs-olap/), and the [bluetape4k workshop](https://github.com/bluetape4k/bluetape4k-workshop).
...
Continue with the [ClickHouse adapter](/manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-clickhouse/) for supported DDL and transactions, then use [OLTP vs OLAP](/manual/bluetape4k-exposed/1.12/guides/oltp-vs-olap/) to design the production handoff.
...
_Release README: [`examples/exposed-clickhouse-oltp-olap/README.md`](https://github.com/bluetape4k/bluetape4k-exposed/blob/4cc2cce07087241ec24a597d8464615434ea2b81/examples/exposed-clickhouse-oltp-olap/README.md)_
...
- [Example sources](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/examples/exposed-clickhouse-oltp-olap/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/examples/exposed-clickhouse-oltp-olap/build.gradle.kts)
