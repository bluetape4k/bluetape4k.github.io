---
slug: "manual/bluetape4k-exposed/1.12/modules/bluetape4k-exposed-cockroachdb"
...
Compare CockroachDB with PostgreSQL in the [adapter matrix](/manual/bluetape4k-exposed/1.12/guides/database-adapter-matrix/), then read [OLTP vs OLAP](/manual/bluetape4k-exposed/1.12/guides/oltp-vs-olap/). Add the retry helper only after the ordinary JDBC transaction boundary is understood.
...
- [Database release test](https://github.com/bluetape4k/bluetape4k-exposed/blob/1.12.1/exposed/cockroachdb/src/test/kotlin/io/bluetape4k/exposed/cockroachdb/CockroachDatabaseTest.kt)
