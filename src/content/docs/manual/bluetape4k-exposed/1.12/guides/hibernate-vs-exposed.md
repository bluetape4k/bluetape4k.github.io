---
slug: "manual/bluetape4k-exposed/1.12/guides/hibernate-vs-exposed"
...
[![JPA and Exposed architecture comparison](/manual-assets/bluetape4k-exposed/1.12/persistence/jpa-exposed-comparison.en.png)](../../assets/persistence/jpa-exposed-comparison.en.svg)
...
Start with [JDBC vs R2DBC](/manual/bluetape4k-exposed/1.12/guides/jdbc-vs-r2dbc/) and [transaction boundaries](/manual/bluetape4k-exposed/1.12/guides/transaction-boundaries/), then build one representative repository before choosing a broad migration.
