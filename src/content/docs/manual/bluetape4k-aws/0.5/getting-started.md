---
slug: "manual/bluetape4k-aws/0.5/getting-started"
...
See [SDK selection](/manual/bluetape4k-aws/0.5/guides/sdk-selection/) for the complete decision table.
...
Use [Spring Boot or Ktor](/manual/bluetape4k-aws/0.5/guides/spring-vs-ktor/) to choose by lifecycle and configuration ownership, not by syntax preference.
