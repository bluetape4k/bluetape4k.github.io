---
slug: "manual/bluetape4k-aws/0.5/architecture/repository-map"
...
![AWS repository module map](/manual-assets/bluetape4k-aws/0.5/overview/repository-module-map.png)
...
- [Gradle project registry](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/settings.gradle.kts)
- [Published AWS platform](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/bom/build.gradle.kts)
- [Repository module overview](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/README.md)
