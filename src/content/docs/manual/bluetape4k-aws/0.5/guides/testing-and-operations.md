---
slug: "manual/bluetape4k-aws/0.5/guides/testing-and-operations"
...
![Floci-first emulator test flow](/manual-assets/bluetape4k-aws/0.5/testing/emulator-flow.png)
...
- [Java module emulator selection](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/aws-java/src/test/kotlin/io/bluetape4k/aws/AbstractAwsTest.kt)
- [Kotlin module emulator selection](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/aws-kotlin/src/test/kotlin/io/bluetape4k/aws/kotlin/AbstractAwsTest.kt)
- [Kotlin client lifecycle tests](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/aws-kotlin/src/test/kotlin/io/bluetape4k/aws/kotlin/lifecycle/ClientLifecycleTest.kt)
- [Spring emulator selector](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/aws-spring-boot/src/test/kotlin/io/bluetape4k/aws/spring/test/AwsSpringBootTestEmulator.kt)
- [Ktor SQS shutdown contract](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/aws-ktor/src/main/kotlin/io/bluetape4k/aws/ktor/sqs/SqsConsumerRuntime.kt)
