---
slug: "manual/bluetape4k-aws/0.5/modules/aws-spring-boot-dynamodb-examples"
...
_Release README: [`examples/aws-spring-boot-dynamodb-examples/README.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/664e4dfb544a3c19db484b0f9a8e023a73774b49/examples/aws-spring-boot-dynamodb-examples/README.md)_

<!-- release-readme-diagrams:end -->

## Sources

- [Application and controller](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-spring-boot-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderController.kt)
...
- [Emulator-backed test](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-spring-boot-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderControllerLocalStackTest.kt)
