---
slug: "manual/bluetape4k-aws/0.5/modules/aws-ktor-dynamodb-examples"
...
- [Routes, table, mapper, and repository](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-ktor-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutes.kt)
- [Emulator-backed route test](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-ktor-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutesLocalStackTest.kt)
- [Example notes](https://github.com/bluetape4k/bluetape4k-aws/blob/0.5.0/examples/aws-ktor-dynamodb-examples/README.md)
