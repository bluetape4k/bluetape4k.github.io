---
slug: "manual/bluetape4k-aws/1.0/getting-started"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/en/getting-started.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [SDK selection](/manual/bluetape4k-aws/1.0/guides/sdk-selection/) for the complete decision table.
...
Use [Spring Boot or Ktor](/manual/bluetape4k-aws/1.0/guides/spring-vs-ktor/) to choose by lifecycle and configuration ownership, not by syntax preference.
