---
slug: "manual/bluetape4k-aws/1.0/modules/aws-ktor-sqs-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/en/modules/aws-ktor-sqs-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [Consumer and routes](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-sqs-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/sqs/SqsExampleRoutes.kt)
- [Floci integration test](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-sqs-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/sqs/SqsExampleRoutesFlociTest.kt)
- [Example notes](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-sqs-examples/README.md)
