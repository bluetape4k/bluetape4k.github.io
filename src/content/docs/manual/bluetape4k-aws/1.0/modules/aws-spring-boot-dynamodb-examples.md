---
slug: "manual/bluetape4k-aws/1.0/modules/aws-spring-boot-dynamodb-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/en/modules/aws-spring-boot-dynamodb-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
_Release README: [`examples/aws-spring-boot-dynamodb-examples/README.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/632e0f346b807c4d50e3195f7b2b72082def9460/examples/aws-spring-boot-dynamodb-examples/README.md)_

<!-- release-readme-diagrams:end -->

## Sources

- [Application and controller](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-spring-boot-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderController.kt)
...
- [Emulator-backed test](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-spring-boot-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/spring/dynamodb/OrderControllerLocalStackTest.kt)
