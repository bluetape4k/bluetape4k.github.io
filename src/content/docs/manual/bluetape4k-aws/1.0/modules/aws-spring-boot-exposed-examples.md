---
slug: "manual/bluetape4k-aws/1.0/modules/aws-spring-boot-exposed-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/en/modules/aws-spring-boot-exposed-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
_Release README: [`examples/aws-spring-boot-exposed-examples/README.md`](https://github.com/bluetape4k/bluetape4k-aws/blob/632e0f346b807c4d50e3195f7b2b72082def9460/examples/aws-spring-boot-exposed-examples/README.md)_
...
- [Transaction-owning service](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-spring-boot-exposed-examples/src/main/kotlin/io/bluetape4k/aws/examples/spring/exposed/OrderService.kt)
- [PostgreSQL integration test](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-spring-boot-exposed-examples/src/test/kotlin/io/bluetape4k/aws/examples/spring/exposed/SpringBootExposedExampleApplicationTest.kt)
