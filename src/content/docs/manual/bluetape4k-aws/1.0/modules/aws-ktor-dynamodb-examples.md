---
slug: "manual/bluetape4k-aws/1.0/modules/aws-ktor-dynamodb-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-aws/en/modules/aws-ktor-dynamodb-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [Routes, table, mapper, and repository](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-dynamodb-examples/src/main/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutes.kt)
- [Emulator-backed route test](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-dynamodb-examples/src/test/kotlin/io/bluetape4k/aws/examples/ktor/dynamodb/DynamoDbExampleRoutesLocalStackTest.kt)
- [Example notes](https://github.com/bluetape4k/bluetape4k-aws/blob/1.0.0/examples/aws-ktor-dynamodb-examples/README.md)
