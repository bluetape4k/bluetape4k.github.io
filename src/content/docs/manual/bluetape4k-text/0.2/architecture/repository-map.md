---
slug: "manual/bluetape4k-text/0.2/architecture/repository-map"
...
![Capability and module map](/manual-assets/bluetape4k-text/0.2/architecture/capability-map.png)
...
Use `lingua` to identify likely languages, then send supported text to `tokenizer-korean` or `tokenizer-japanese`. Keep an explicit fallback for unknown or ambiguous input. The [mixed-language guide](/manual/bluetape4k-text/0.2/guides/mixed-language-processing/) explains why detection should guide routing rather than act as unquestionable truth.

### Tokenize and filter

Use a language processor for morphology and its blockword facilities for dictionary-backed filtering. Use `tokenizer-core` request models at the external boundary. The [dictionary guide](/manual/bluetape4k-text/0.2/guides/dictionaries-and-blockwords/) covers runtime updates and ownership.
...
[![text Architecture diagram](/manual-assets/bluetape4k-text/0.2/readme-diagrams/bluetape4k-text-architecture-01.png)](../../assets/readme-diagrams/bluetape4k-text-architecture-01.svg)
...
[![Bluetape4k Text module composition chart](/manual-assets/bluetape4k-text/0.2/readme-diagrams/root-readme-module-chart-01.png)](../../assets/readme-diagrams/root-readme-module-chart-01.svg)

_Release README: [`README.md`](https://github.com/bluetape4k/bluetape4k-text/blob/2db7671afad20045afdcb5793c0113b8b23b972b/README.md)_

### Bluetape4k Text overview diagram

[![Bluetape4k Text overview diagram](/manual-assets/bluetape4k-text/0.2/readme-diagrams/root-readme-overview-01.png)](../../assets/readme-diagrams/root-readme-overview-01.svg)
