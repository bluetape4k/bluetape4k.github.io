---
slug: "manual/bluetape4k-text/0.2/modules/tokenizer-korean"
...
Choose this module for Korean morphology or its built-in normalization and phrase operations. Use [text-search](/manual/bluetape4k-text/0.2/modules/text-search/) instead when you only need exact multi-pattern matching. Use [Lingua](/manual/bluetape4k-text/0.2/modules/lingua/) before this processor only when the service must route unknown-language input.
