---
slug: "manual/bluetape4k-text/0.2/examples/text-search-examples"
title: "Text search example"
manual:
  id: "examples/text-search-examples"
  repository: "bluetape4k-text"
  group: "overview"
  kind: "guide"
  sourceCommit: "5bdcab0887cf27ce79348d08e64db6d196b9cc89"
  sourcePath: "docs/manual/en/examples/text-search-examples.md"
  minorVersion: "0.2"
  releaseRef: "0.2.1"
...
Continue with the [Text search module](/manual/bluetape4k-text/0.2/modules/text-search/), [testing guide](/manual/bluetape4k-text/0.2/guides/testing/), and [benchmark interpretation](/manual/bluetape4k-text/0.2/quality/aho-corasick-benchmarks/).

## Source evidence

- [Runnable source](https://github.com/bluetape4k/bluetape4k-text/blob/0.2.1/examples/text-search-examples/src/main/kotlin/io/bluetape4k/text/examples/search/TextSearchExamples.kt)
- [Example tests](https://github.com/bluetape4k/bluetape4k-text/blob/0.2.1/examples/text-search-examples/src/test/kotlin/io/bluetape4k/text/examples/search/TextSearchExamplesTest.kt)
