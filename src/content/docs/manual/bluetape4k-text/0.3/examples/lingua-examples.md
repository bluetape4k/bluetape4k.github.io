---
slug: "manual/bluetape4k-text/0.3/examples/lingua-examples"
...
Continue with [mixed-language processing](/manual/bluetape4k-text/0.3/guides/mixed-language-processing/), [runtime boundaries](/manual/bluetape4k-text/0.3/architecture/runtime-boundaries/), and the [Lingua module](/manual/bluetape4k-text/0.3/modules/lingua/).
