---
slug: "manual/bluetape4k-text/0.3/guides/learning-path"
title: "Learning path"
manual:
...
Read [Getting started](/manual/bluetape4k-text/0.3/getting-started/) and run one Korean normalization and tokenization call.
...
Read [Lingua](/manual/bluetape4k-text/0.3/modules/lingua/) and [mixed-language processing](/manual/bluetape4k-text/0.3/guides/mixed-language-processing/), then run the [Lingua example](/manual/bluetape4k-text/0.3/examples/lingua-examples/).
...
Read the [Korean](/manual/bluetape4k-text/0.3/modules/tokenizer-korean/) and [Japanese](/manual/bluetape4k-text/0.3/modules/tokenizer-japanese/) module pages. Compare their smallest examples, then inspect the [tokenizer safety example](/manual/bluetape4k-text/0.3/examples/tokenizer-safety-examples/).
...
Read [Text search](/manual/bluetape4k-text/0.3/modules/text-search/), then run the [text search example](/manual/bluetape4k-text/0.3/examples/text-search-examples/). Change one keyword value and observe the builder result, DSL result, replacement text, and first Flow alert.
...
Read [input safety](/manual/bluetape4k-text/0.3/guides/input-safety/), [startup and memory](/manual/bluetape4k-text/0.3/operations/startup-and-memory/), [failure contracts](/manual/bluetape4k-text/0.3/operations/failure-contracts/), and [quality gates](/manual/bluetape4k-text/0.3/quality/quality-gates/).
...
|---|---|
| custom dictionaries or moderation policy | [Dictionaries and blockwords](/manual/bluetape4k-text/0.3/guides/dictionaries-and-blockwords/) |
| mixed Korean, Japanese, and Latin input | [Mixed-language processing](/manual/bluetape4k-text/0.3/guides/mixed-language-processing/) |
| regression coverage | [Testing](/manual/bluetape4k-text/0.3/guides/testing/) |
| exact module choice | [Capability selection](/manual/bluetape4k-text/0.3/guides/capability-selection/) |
| performance interpretation | [Aho-Corasick benchmarks](/manual/bluetape4k-text/0.3/quality/aho-corasick-benchmarks/) |
