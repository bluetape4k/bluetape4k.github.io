---
slug: "manual/bluetape4k-text/0.3/guides/mixed-language-processing"
...
![Language detection selection](/manual-assets/bluetape4k-text/0.3/guides/language-detection-selection.png)
...
Continue with the [Lingua example](/manual/bluetape4k-text/0.3/examples/lingua-examples/), [runtime boundaries](/manual/bluetape4k-text/0.3/architecture/runtime-boundaries/), and [failure contracts](/manual/bluetape4k-text/0.3/operations/failure-contracts/).
