---
slug: "manual/bluetape4k-text/0.3/architecture/runtime-boundaries"
...
See [startup and memory](/manual/bluetape4k-text/0.3/operations/startup-and-memory/) for a deployment checklist and [input safety](/manual/bluetape4k-text/0.3/guides/input-safety/) for request-boundary rules.
