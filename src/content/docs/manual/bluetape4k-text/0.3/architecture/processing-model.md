---
slug: "manual/bluetape4k-text/0.3/architecture/processing-model"
...
![Text processing pipeline](/manual-assets/bluetape4k-text/0.3/architecture/text-processing-pipeline.png)
...
Keeping these boundaries visible makes testing and failure mapping much simpler. Continue with [runtime boundaries](/manual/bluetape4k-text/0.3/architecture/runtime-boundaries/), [testing](/manual/bluetape4k-text/0.3/guides/testing/), and [failure contracts](/manual/bluetape4k-text/0.3/operations/failure-contracts/).
