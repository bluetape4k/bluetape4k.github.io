---
slug: "manual/bluetape4k-text/0.3/modules/text-search"
...
![Text search flow](/manual-assets/bluetape4k-text/0.3/text-search/search-flow.png)
...
- [Text search runnable example](/manual/bluetape4k-text/0.3/examples/text-search-examples/)
- [Aho-Corasick benchmarks](/manual/bluetape4k-text/0.3/quality/aho-corasick-benchmarks/)
