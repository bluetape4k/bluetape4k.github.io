---
slug: "manual/bluetape4k-text/0.3/modules/tokenizer-core"
...
Use core models at an HTTP or message boundary, for shared dictionary tooling, or when implementing a processor. Choose [Korean](/manual/bluetape4k-text/0.3/modules/tokenizer-korean/) or [Japanese](/manual/bluetape4k-text/0.3/modules/tokenizer-japanese/) modules when you need actual morphological analysis.
...
- [Input safety](/manual/bluetape4k-text/0.3/guides/input-safety/)
