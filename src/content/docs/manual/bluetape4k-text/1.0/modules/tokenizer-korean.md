---
slug: "manual/bluetape4k-text/1.0/modules/tokenizer-korean"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/modules/tokenizer-korean.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Choose this module for Korean morphology or its built-in normalization and phrase operations. Use [text-search](/manual/bluetape4k-text/1.0/modules/text-search/) instead when you only need exact multi-pattern matching. Use [Lingua](/manual/bluetape4k-text/1.0/modules/lingua/) before this processor only when the service must route unknown-language input.
...
- [Testing](/manual/bluetape4k-text/1.0/guides/testing/)
