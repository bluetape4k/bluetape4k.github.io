---
slug: "manual/bluetape4k-text/1.0/modules/tokenizer-japanese"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/modules/tokenizer-japanese.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Choose this module when Japanese token boundaries or POS matter. Choose [text-search](/manual/bluetape4k-text/1.0/modules/text-search/) for exact patterns independent of morphology. Route unknown-language input through [Lingua](/manual/bluetape4k-text/1.0/modules/lingua/) only when routing is required.
...
- [Mixed-language processing](/manual/bluetape4k-text/1.0/guides/mixed-language-processing/)
- [Tokenizer safety example](/manual/bluetape4k-text/1.0/examples/tokenizer-safety-examples/)
- [Startup and memory](/manual/bluetape4k-text/1.0/operations/startup-and-memory/)
