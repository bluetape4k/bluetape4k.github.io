---
slug: "manual/bluetape4k-text/1.0/architecture/processing-model"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/architecture/processing-model.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
![Text processing pipeline](/manual-assets/bluetape4k-text/1.0/architecture/text-processing-pipeline.png)
...
Keeping these boundaries visible makes testing and failure mapping much simpler. Continue with [runtime boundaries](/manual/bluetape4k-text/1.0/architecture/runtime-boundaries/), [testing](/manual/bluetape4k-text/1.0/guides/testing/), and [failure contracts](/manual/bluetape4k-text/1.0/operations/failure-contracts/).
