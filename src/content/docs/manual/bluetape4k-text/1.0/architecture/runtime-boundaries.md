---
slug: "manual/bluetape4k-text/1.0/architecture/runtime-boundaries"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/architecture/runtime-boundaries.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [startup and memory](/manual/bluetape4k-text/1.0/operations/startup-and-memory/) for a deployment checklist and [input safety](/manual/bluetape4k-text/1.0/guides/input-safety/) for request-boundary rules.
