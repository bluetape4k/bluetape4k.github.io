---
slug: "manual/bluetape4k-text/1.0/examples/lingua-examples"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/examples/lingua-examples.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Continue with [mixed-language processing](/manual/bluetape4k-text/1.0/guides/mixed-language-processing/), [runtime boundaries](/manual/bluetape4k-text/1.0/architecture/runtime-boundaries/), and the [Lingua module](/manual/bluetape4k-text/1.0/modules/lingua/).
