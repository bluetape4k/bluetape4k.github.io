---
slug: "manual/bluetape4k-text/1.0/guides/capability-selection"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/guides/capability-selection.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
|---|---|---|---|
| align all Text artifacts | `bluetape4k-text-bom` | Gradle `platform(...)` | [Getting started](/manual/bluetape4k-text/1.0/getting-started/) |
| validate tokenizer request boundaries | `tokenizer-core` | `tokenizeRequestOf`, `blockwordRequestOf` | [Safety example](/manual/bluetape4k-text/1.0/examples/tokenizer-safety-examples/) |
| normalize or morphologically analyze Korean | `tokenizer-korean` | `KoreanProcessor` | [Korean module](/manual/bluetape4k-text/1.0/modules/tokenizer-korean/) |
| morphologically analyze Japanese | `tokenizer-japanese` | `JapaneseProcessor` | [Japanese module](/manual/bluetape4k-text/1.0/modules/tokenizer-japanese/) |
| estimate languages or filter by script | `lingua` | `LanguageDetector`, `UnicodeDetector` | [Lingua example](/manual/bluetape4k-text/1.0/examples/lingua-examples/) |
| find or replace many exact patterns | `text-search` | `AhoCorasickAutomaton` | [Search example](/manual/bluetape4k-text/1.0/examples/text-search-examples/) |
...
See the [processing model](/manual/bluetape4k-text/1.0/architecture/processing-model/) for composition and [runtime boundaries](/manual/bluetape4k-text/1.0/architecture/runtime-boundaries/) for lifetime choices.
