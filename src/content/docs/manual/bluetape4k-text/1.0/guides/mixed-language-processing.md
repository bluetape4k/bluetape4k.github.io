---
slug: "manual/bluetape4k-text/1.0/guides/mixed-language-processing"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-text/en/guides/mixed-language-processing.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
![Language detection selection](/manual-assets/bluetape4k-text/1.0/guides/language-detection-selection.png)
...
Continue with the [Lingua example](/manual/bluetape4k-text/1.0/examples/lingua-examples/), [runtime boundaries](/manual/bluetape4k-text/1.0/architecture/runtime-boundaries/), and [failure contracts](/manual/bluetape4k-text/1.0/operations/failure-contracts/).
