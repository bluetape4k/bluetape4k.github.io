---
slug: "manual/bluetape4k-leader/0.5/guides/backend-selection"
...
![Leader backend selection map](/manual-assets/bluetape4k-leader/0.5/backends/backend-selection-map.png)
...
- [`benchmark/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/benchmark/README.md)
...
- [Redis backends](/manual/bluetape4k-leader/0.5/backends/redis/)
- [etcd, Consul, and Kubernetes Lease](/manual/bluetape4k-leader/0.5/backends/control-plane-leases/)
