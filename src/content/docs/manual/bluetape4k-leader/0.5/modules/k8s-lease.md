---
slug: "manual/bluetape4k-leader/0.5/modules/k8s-lease"
manualId: "k8s-lease"
id: "k8s-lease"
...
> Runnable release workshop · Kubernetes `coordination.k8s.io/v1` Lease · source pinned to `0.5.0`
...
_Release README: [`examples/k8s-lease/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/k8s-lease/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/src/main/kotlin/io/bluetape4k/leader/examples/k8slease/K8sLeaseLeaderElectionExample.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-lease/src/test/kotlin/io/bluetape4k/leader/examples/k8slease/K8sLeaseLeaderElectionExampleTest.kt)
