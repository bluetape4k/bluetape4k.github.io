---
slug: "manual/bluetape4k-leader/0.5/modules/migration-gate"
...
> Runnable release workshop · Exposed JDBC · source pinned to `0.5.0`
...
_Release README: [`examples/migration-gate/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/migration-gate/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/migration-gate/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/migration-gate/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/migration-gate/src/main/kotlin/io/bluetape4k/leader/examples/migration/MigrationGate.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/migration-gate/src/main/kotlin/io/bluetape4k/leader/examples/migration/MigrationGateDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/migration-gate/src/test/kotlin/io/bluetape4k/leader/examples/migration/MigrationGateTest.kt)
