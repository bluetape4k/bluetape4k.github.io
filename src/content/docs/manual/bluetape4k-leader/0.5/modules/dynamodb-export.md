---
slug: "manual/bluetape4k-leader/0.5/modules/dynamodb-export"
...
> Runnable release workshop · DynamoDB conditional writes · source pinned to `0.5.0`
...
_Release README: [`examples/dynamodb-export/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/dynamodb-export/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/dynamodb-export/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/dynamodb-export/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/dynamodb-export/src/main/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbScheduledExportRunner.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/dynamodb-export/src/main/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbExportDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/dynamodb-export/src/test/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbScheduledExportRunnerTest.kt)
