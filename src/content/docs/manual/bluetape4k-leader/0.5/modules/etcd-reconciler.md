---
slug: "manual/bluetape4k-leader/0.5/modules/etcd-reconciler"
...
> Runnable release workshop · etcd v3 lease and lock · source pinned to `0.5.0`
...
_Release README: [`examples/etcd-reconciler/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/etcd-reconciler/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/etcd-reconciler/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/etcd-reconciler/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconciler.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/EtcdReconcilerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/etcd-reconciler/src/test/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconcilerTest.kt)
