---
slug: "manual/bluetape4k-leader/0.5/modules/rate-limiter"
...
> Runnable release workshop · Redis leader election and Redis-backed Bucket4j · source pinned to `0.5.0`
...
_Release README: [`examples/rate-limiter/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/rate-limiter/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/rate-limiter/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/rate-limiter/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/rate-limiter/src/main/kotlin/io/bluetape4k/leader/examples/ratelimit/LeaderDispatchScheduler.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/rate-limiter/src/main/kotlin/io/bluetape4k/leader/examples/ratelimit/RateLimiterDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/rate-limiter/src/test/kotlin/io/bluetape4k/leader/examples/ratelimit/RateLimiterDemoTest.kt)
