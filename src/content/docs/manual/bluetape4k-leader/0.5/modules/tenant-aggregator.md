---
slug: "manual/bluetape4k-leader/0.5/modules/tenant-aggregator"
...
> Runnable release workshop · Exposed R2DBC suspend election · source pinned to `0.5.0`
...
_Release README: [`examples/tenant-aggregator/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/tenant-aggregator/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/tenant-aggregator/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/tenant-aggregator/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/tenant-aggregator/src/main/kotlin/io/bluetape4k/leader/examples/tenant/TenantAggregator.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/tenant-aggregator/src/main/kotlin/io/bluetape4k/leader/examples/tenant/TenantAggregatorDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/tenant-aggregator/src/test/kotlin/io/bluetape4k/leader/examples/tenant/TenantAggregatorTest.kt)
