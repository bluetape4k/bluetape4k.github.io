---
slug: "manual/bluetape4k-leader/0.5/modules/k8s-operator"
...
> Runnable release workshop · Kubernetes Lease with Spring scheduling · source pinned to `0.5.0`
...
_Release README: [`examples/k8s-operator/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/721a9a3808f67489d2bdb8177734325981c24977/examples/k8s-operator/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-operator/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-operator/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-operator/src/main/kotlin/io/bluetape4k/leader/examples/k8soperator/OperatorController.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-operator/src/main/kotlin/io/bluetape4k/leader/examples/k8soperator/K8sOperatorApp.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.5.0/examples/k8s-operator/src/test/kotlin/io/bluetape4k/leader/examples/k8soperator/OperatorControllerTest.kt)
