---
slug: "manual/bluetape4k-leader/0.4/modules/batch-scheduler"
...
manual:
  ...
  sourcePath: "docs/manual/en/modules/batch-scheduler.md"
  minorVersion: "0.4"
  releaseRef: "0.4.0"
...
[![Batch scheduler architecture diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-batch-scheduler-architecture-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-architecture-01.svg)
...
[![Batch scheduler flow diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-batch-scheduler-flow-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-flow-01.svg)

_Release README: [`examples/batch-scheduler/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/batch-scheduler/README.md)_

### Batch scheduler scenario diagram

[![Batch scheduler scenario diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-batch-scheduler-scenario-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-scenario-01.svg)

_Release README: [`examples/batch-scheduler/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/batch-scheduler/README.md)_

### Batch scheduler sequence diagram

[![Batch scheduler sequence diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-batch-scheduler-sequence-01.png)](../../assets/readme-diagrams/examples-batch-scheduler-sequence-01.svg)
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/batch-scheduler/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/batch-scheduler/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/batch-scheduler/src/main/kotlin/io/bluetape4k/leader/examples/batch/BatchScheduler.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/batch-scheduler/src/main/kotlin/io/bluetape4k/leader/examples/batch/BatchSchedulerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/batch-scheduler/src/test/kotlin/io/bluetape4k/leader/examples/batch/BatchSchedulerTest.kt)
