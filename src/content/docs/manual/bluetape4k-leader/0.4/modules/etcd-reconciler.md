---
slug: "manual/bluetape4k-leader/0.4/modules/etcd-reconciler"
...
manual:
  ...
  sourcePath: "docs/manual/en/modules/etcd-reconciler.md"
  minorVersion: "0.4"
  releaseRef: "0.4.0"
...
[![etcd Reconciler Architecture diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-etcd-reconciler-architecture-01.png)](../../assets/readme-diagrams/examples-etcd-reconciler-architecture-01.svg)
...
[![Etcd reconciler flow diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-etcd-reconciler-flow-01.png)](../../assets/readme-diagrams/examples-etcd-reconciler-flow-01.svg)

_Release README: [`examples/etcd-reconciler/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/etcd-reconciler/README.md)_

### Etcd reconciler scenario diagram

[![Etcd reconciler scenario diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-etcd-reconciler-scenario-01.png)](../../assets/readme-diagrams/examples-etcd-reconciler-scenario-01.svg)

_Release README: [`examples/etcd-reconciler/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/17ab7f872c1f96318c73d3580729cac20a67e017/examples/etcd-reconciler/README.md)_

### etcd Reconciler Sequence Flow diagram

[![etcd Reconciler Sequence Flow diagram](/manual-assets/bluetape4k-leader/0.4/readme-diagrams/examples-etcd-reconciler-sequence-01.png)](../../assets/readme-diagrams/examples-etcd-reconciler-sequence-01.svg)
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/etcd-reconciler/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/etcd-reconciler/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconciler.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/EtcdReconcilerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/0.4.0/examples/etcd-reconciler/src/test/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconcilerTest.kt)
