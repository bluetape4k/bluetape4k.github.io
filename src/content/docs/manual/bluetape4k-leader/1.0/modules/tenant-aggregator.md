---
slug: "manual/bluetape4k-leader/1.0/modules/tenant-aggregator"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/tenant-aggregator.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · Exposed R2DBC suspend election · source pinned to `1.0.0`
...
_Release README: [`examples/tenant-aggregator/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/tenant-aggregator/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/tenant-aggregator/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/tenant-aggregator/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/tenant-aggregator/src/main/kotlin/io/bluetape4k/leader/examples/tenant/TenantAggregator.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/tenant-aggregator/src/main/kotlin/io/bluetape4k/leader/examples/tenant/TenantAggregatorDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/tenant-aggregator/src/test/kotlin/io/bluetape4k/leader/examples/tenant/TenantAggregatorTest.kt)
