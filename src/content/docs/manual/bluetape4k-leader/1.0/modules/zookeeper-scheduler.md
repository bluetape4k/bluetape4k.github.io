---
slug: "manual/bluetape4k-leader/1.0/modules/zookeeper-scheduler"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/zookeeper-scheduler.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/zookeeper-scheduler/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/zookeeper-scheduler/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/zookeeper-scheduler/src/main/kotlin/io/bluetape4k/leader/examples/zookeeperscheduler/ZooKeeperLegacyScheduler.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/zookeeper-scheduler/src/main/kotlin/io/bluetape4k/leader/examples/zookeeperscheduler/ZooKeeperSchedulerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/zookeeper-scheduler/src/test/kotlin/io/bluetape4k/leader/examples/zookeeperscheduler/ZooKeeperLegacySchedulerTest.kt)
