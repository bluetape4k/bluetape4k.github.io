---
slug: "manual/bluetape4k-leader/1.0/modules/ktor-app"
manualId: "ktor-app"
id: "ktor-app"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/ktor-app.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · Lettuce Redis with Ktor `LeaderElectionPlugin` · source pinned to `1.0.0`
...
_Release README: [`examples/ktor-app/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/ktor-app/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/ktor-app/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/ktor-app/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/ktor-app/src/main/kotlin/io/bluetape4k/leader/examples/ktor/StatsAggregator.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/ktor-app/src/main/kotlin/io/bluetape4k/leader/examples/ktor/KtorAppMain.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/ktor-app/src/test/kotlin/io/bluetape4k/leader/examples/ktor/KtorAppTest.kt)
