---
slug: "manual/bluetape4k-leader/1.0/modules/virtual-thread-runner"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/virtual-thread-runner.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/virtual-thread-runner/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/virtual-thread-runner/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/virtual-thread-runner/src/main/kotlin/io/bluetape4k/leader/examples/virtualthread/VirtualThreadLeaderRunner.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/virtual-thread-runner/src/main/kotlin/io/bluetape4k/leader/examples/virtualthread/VirtualThreadRunnerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/virtual-thread-runner/src/test/kotlin/io/bluetape4k/leader/examples/virtualthread/VirtualThreadLeaderRunnerTest.kt)
