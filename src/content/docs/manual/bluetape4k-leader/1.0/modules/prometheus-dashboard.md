---
slug: "manual/bluetape4k-leader/1.0/modules/prometheus-dashboard"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/prometheus-dashboard.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · Spring Boot, Lettuce Redis, Micrometer, Prometheus, and Grafana · source pinned to `1.0.0`
...
_Release README: [`examples/prometheus-dashboard/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/prometheus-dashboard/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/prometheus-dashboard/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/prometheus-dashboard/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/prometheus-dashboard/src/main/kotlin/io/bluetape4k/leader/examples/prometheus/PrometheusDashboardApp.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/prometheus-dashboard/src/test/kotlin/io/bluetape4k/leader/examples/prometheus/PrometheusScrapeTest.kt)
