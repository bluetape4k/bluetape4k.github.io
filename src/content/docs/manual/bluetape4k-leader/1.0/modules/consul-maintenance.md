---
slug: "manual/bluetape4k-leader/1.0/modules/consul-maintenance"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/consul-maintenance.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · Consul Session and KV · source pinned to `1.0.0`
...
_Release README: [`examples/consul-maintenance/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/consul-maintenance/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/src/main/kotlin/io/bluetape4k/leader/examples/consulmaintenance/ServiceMaintenanceCoordinator.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/src/main/kotlin/io/bluetape4k/leader/examples/consulmaintenance/ConsulMaintenanceDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/consul-maintenance/src/test/kotlin/io/bluetape4k/leader/examples/consulmaintenance/ServiceMaintenanceCoordinatorTest.kt)
