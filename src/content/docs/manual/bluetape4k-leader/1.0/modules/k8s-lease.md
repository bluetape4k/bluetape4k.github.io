---
slug: "manual/bluetape4k-leader/1.0/modules/k8s-lease"
manualId: "k8s-lease"
id: "k8s-lease"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/k8s-lease.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · Kubernetes `coordination.k8s.io/v1` Lease · source pinned to `1.0.0`
...
_Release README: [`examples/k8s-lease/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/k8s-lease/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/k8s-lease/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/k8s-lease/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/k8s-lease/src/main/kotlin/io/bluetape4k/leader/examples/k8slease/K8sLeaseLeaderElectionExample.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/k8s-lease/src/test/kotlin/io/bluetape4k/leader/examples/k8slease/K8sLeaseLeaderElectionExampleTest.kt)
