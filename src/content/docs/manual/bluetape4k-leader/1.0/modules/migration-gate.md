---
slug: "manual/bluetape4k-leader/1.0/modules/migration-gate"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/migration-gate.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · Exposed JDBC · source pinned to `1.0.0`
...
_Release README: [`examples/migration-gate/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/migration-gate/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/migration-gate/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/migration-gate/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/migration-gate/src/main/kotlin/io/bluetape4k/leader/examples/migration/MigrationGate.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/migration-gate/src/main/kotlin/io/bluetape4k/leader/examples/migration/MigrationGateDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/migration-gate/src/test/kotlin/io/bluetape4k/leader/examples/migration/MigrationGateTest.kt)
