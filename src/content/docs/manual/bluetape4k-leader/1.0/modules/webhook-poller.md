---
slug: "manual/bluetape4k-leader/1.0/modules/webhook-poller"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/webhook-poller.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · MongoDB suspend election and atomic event claims · source pinned to `1.0.0`
...
_Release README: [`examples/webhook-poller/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/webhook-poller/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/webhook-poller/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/webhook-poller/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/webhook-poller/src/main/kotlin/io/bluetape4k/leader/examples/webhook/WebhookPoller.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/webhook-poller/src/main/kotlin/io/bluetape4k/leader/examples/webhook/WebhookPollerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/webhook-poller/src/test/kotlin/io/bluetape4k/leader/examples/webhook/WebhookPollerTest.kt)
