---
slug: "manual/bluetape4k-leader/1.0/modules/dynamodb-export"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/dynamodb-export.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · DynamoDB conditional writes · source pinned to `1.0.0`
...
_Release README: [`examples/dynamodb-export/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/dynamodb-export/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/src/main/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbScheduledExportRunner.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/src/main/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbExportDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/dynamodb-export/src/test/kotlin/io/bluetape4k/leader/examples/dynamodbexport/DynamoDbScheduledExportRunnerTest.kt)
