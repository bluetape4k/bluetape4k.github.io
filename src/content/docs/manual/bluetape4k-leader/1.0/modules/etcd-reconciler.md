---
slug: "manual/bluetape4k-leader/1.0/modules/etcd-reconciler"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-leader/en/modules/etcd-reconciler.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
> Runnable release workshop · etcd v3 lease and lock · source pinned to `1.0.0`
...
_Release README: [`examples/etcd-reconciler/README.md`](https://github.com/bluetape4k/bluetape4k-leader/blob/e70146330302758f563a46b7286e3ce25f1bac49/examples/etcd-reconciler/README.md)_
...
- [Stable example README](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/README.md)
- [Gradle build](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/build.gradle.kts)
- [Main implementation](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconciler.kt)
- [Demo entry point](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/src/main/kotlin/io/bluetape4k/leader/examples/etcdreconciler/EtcdReconcilerDemo.kt)
- [Verification test](https://github.com/bluetape4k/bluetape4k-leader/blob/1.0.0/examples/etcd-reconciler/src/test/kotlin/io/bluetape4k/leader/examples/etcdreconciler/ControlPlaneReconcilerTest.kt)
