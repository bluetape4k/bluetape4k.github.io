---
slug: "manual/bluetape4k-graph/0.6/examples/recommendation"
...
This example turns user-item interactions into candidates and a deterministic ranking that tests can explain. It uses **TinkerGraph** to isolate modeling from container and network variance. Read [core model](/manual/bluetape4k-graph/0.6/architecture/core-model/) and [TinkerPop](/manual/bluetape4k-graph/0.6/backends/tinkerpop/) first; use the [selection guide](/manual/bluetape4k-graph/0.6/backends/selection-guide/) before production.
...
Continue [from knowledge-graph](/manual/bluetape4k-graph/0.6/examples/knowledge-graph/), then read [linkedin-graph](/manual/bluetape4k-graph/0.6/examples/linkedin-graph/). Also see [paired APIs](/manual/bluetape4k-graph/0.6/architecture/paired-apis/), [testing](/manual/bluetape4k-graph/0.6/guides/testing/), and [operations](/manual/bluetape4k-graph/0.6/guides/operations/).
