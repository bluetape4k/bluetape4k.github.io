---
slug: "manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-tinkerpop"
...
See [TinkerPop guide](/manual/bluetape4k-graph/0.6/backends/tinkerpop/), [backend selection](/manual/bluetape4k-graph/0.6/backends/selection-guide/), and [benchmark-based selection](/manual/bluetape4k-graph/0.6/guides/benchmark-based-selection/). This module does not emulate database outages, remote Gremlin servers, persistence, or clustering.
