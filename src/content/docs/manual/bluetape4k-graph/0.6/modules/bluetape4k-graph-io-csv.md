---
slug: "manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-io-csv"
...
See [formats and external IDs](/manual/bluetape4k-graph/0.6/graph-io/formats/), [execution model](/manual/bluetape4k-graph/0.6/graph-io/execution-model/), and [OkIO security](/manual/bluetape4k-graph/0.6/graph-io/okio-security/). CSV does not preserve arbitrary nested values automatically, provide a single-file boundary, or make a two-file publication atomic.
