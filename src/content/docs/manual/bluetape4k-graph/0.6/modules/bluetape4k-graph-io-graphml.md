---
slug: "manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-io-graphml"
...
See [formats](/manual/bluetape4k-graph/0.6/graph-io/formats/), [OkIO security](/manual/bluetape4k-graph/0.6/graph-io/okio-security/), and [failure/cancellation](/manual/bluetape4k-graph/0.6/guides/failure-and-cancellation/). The module does not preserve every GraphML extension, invent reverse edges for undirected data, or make XML input safe without limits.
