---
slug: "manual/bluetape4k-graph/0.6/modules/bluetape4k-graph-ktor"
...
See [Ktor integration](/manual/bluetape4k-graph/0.6/frameworks/ktor/), [paired APIs](/manual/bluetape4k-graph/0.6/architecture/paired-apis/), and [operations](/manual/bluetape4k-graph/0.6/guides/operations/). The plugin does not create request transactions, close caller-owned resources by default, or make blocking calls nonblocking.
