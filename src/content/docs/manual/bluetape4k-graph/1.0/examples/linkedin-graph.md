---
slug: "manual/bluetape4k-graph/1.0/examples/linkedin-graph"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/examples/linkedin-graph.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
This example connects people, employers, skills, and endorsements to exercise several social-graph lookup shapes. It uses **TinkerGraph** to isolate modeling from container and network variance. Read [core model](/manual/bluetape4k-graph/1.0/architecture/core-model/) and [TinkerPop](/manual/bluetape4k-graph/1.0/backends/tinkerpop/) first; use the [selection guide](/manual/bluetape4k-graph/1.0/backends/selection-guide/) before production.
...
Continue [from recommendation](/manual/bluetape4k-graph/1.0/examples/recommendation/), then read [iam-access-graph](/manual/bluetape4k-graph/1.0/examples/iam-access-graph/). Also see [paired APIs](/manual/bluetape4k-graph/1.0/architecture/paired-apis/), [testing](/manual/bluetape4k-graph/1.0/guides/testing/), and [operations](/manual/bluetape4k-graph/1.0/guides/operations/).
