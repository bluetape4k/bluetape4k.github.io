---
slug: "manual/bluetape4k-graph/1.0/examples/data-lineage"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/examples/data-lineage.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Continue [from observability-graph](/manual/bluetape4k-graph/1.0/examples/observability-graph/), then read [supply-chain-graph](/manual/bluetape4k-graph/1.0/examples/supply-chain-graph/). Also see [paired APIs](/manual/bluetape4k-graph/1.0/architecture/paired-apis/), [testing](/manual/bluetape4k-graph/1.0/guides/testing/), and [operations](/manual/bluetape4k-graph/1.0/guides/operations/).
