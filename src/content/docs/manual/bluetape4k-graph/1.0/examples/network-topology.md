---
slug: "manual/bluetape4k-graph/1.0/examples/network-topology"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/examples/network-topology.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Continue [from security-attack-path](/manual/bluetape4k-graph/1.0/examples/security-attack-path/), then read [observability-graph](/manual/bluetape4k-graph/1.0/examples/observability-graph/). Also see [paired APIs](/manual/bluetape4k-graph/1.0/architecture/paired-apis/), [testing](/manual/bluetape4k-graph/1.0/guides/testing/), and [operations](/manual/bluetape4k-graph/1.0/guides/operations/).
