---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-csv"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-io-csv.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [formats and external IDs](/manual/bluetape4k-graph/1.0/graph-io/formats/), [execution model](/manual/bluetape4k-graph/1.0/graph-io/execution-model/), and [OkIO security](/manual/bluetape4k-graph/1.0/graph-io/okio-security/). CSV does not preserve arbitrary nested values automatically, provide a single-file boundary, or make a two-file publication atomic.
