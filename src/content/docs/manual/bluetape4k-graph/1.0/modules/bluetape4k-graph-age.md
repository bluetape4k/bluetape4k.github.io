---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-age"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-age.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
AGE keeps graph data inside PostgreSQL and executes Cypher through SQL. Choose it when PostgreSQL ownership, backup, and transaction boundaries are required. Avoid it when the workload requires Bolt-native behavior, vendor-specific procedures, or a uniform superset of Neo4j capabilities. The adapter is [AgeGraphOperations.kt](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-age/src/main/kotlin/io/bluetape4k/graph/age/AgeGraphOperations.kt).
...
AGE relies on Exposed/JDBC transaction context. `transaction { }` shares the PostgreSQL atomic boundary; pooled connections must run `LOAD 'age'` and set `search_path`. Merge is translated for AGE and must be verified with [AgeGraphMergeOperationsTest.kt](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-age/src/test/kotlin/io/bluetape4k/graph/age/AgeGraphMergeOperationsTest.kt). Schema behavior is narrower than a generic graph DDL surface; inspect [AgeGraphSchemaManager.kt](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-age/src/main/kotlin/io/bluetape4k/graph/age/AgeGraphSchemaManager.kt).
...
The pinned [AgeGraphOperationsTest](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-age/src/test/kotlin/io/bluetape4k/graph/age/AgeGraphOperationsTest.kt) defines the fixture values and is the complete executable release example. Run:
...
See [Apache AGE guide](/manual/bluetape4k-graph/1.0/backends/apache-age/), [backend selection](/manual/bluetape4k-graph/1.0/backends/selection-guide/), and [schema and transactions](/manual/bluetape4k-graph/1.0/architecture/schema-and-transactions/). This module does not manage PostgreSQL, hide AGE type limits, or promise Bolt/Cypher parity.
...
_Release README: [`graph/graph-age/README.md`](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-age/README.md)_
...
_Release README: [`graph/graph-age/README.ko.md`](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph/graph-age/README.ko.md)_
