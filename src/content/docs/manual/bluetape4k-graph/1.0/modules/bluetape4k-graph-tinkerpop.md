---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-tinkerpop"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-tinkerpop.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [TinkerPop guide](/manual/bluetape4k-graph/1.0/backends/tinkerpop/), [backend selection](/manual/bluetape4k-graph/1.0/backends/selection-guide/), and [benchmark-based selection](/manual/bluetape4k-graph/1.0/guides/benchmark-based-selection/). This module does not emulate database outages, remote Gremlin servers, persistence, or clustering.
