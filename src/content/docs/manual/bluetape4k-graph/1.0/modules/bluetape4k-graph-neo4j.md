---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-neo4j"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-neo4j.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [Neo4j and Memgraph](/manual/bluetape4k-graph/1.0/backends/neo4j-and-memgraph/), [testing](/manual/bluetape4k-graph/1.0/guides/testing/), and [operations](/manual/bluetape4k-graph/1.0/guides/operations/). This module does not provision Neo4j, own injected drivers, or guarantee that every Cypher statement is portable to another Bolt server.
