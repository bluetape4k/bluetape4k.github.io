---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-io-graphml"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-io-graphml.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
The pinned [GraphMlRoundTripTest](https://github.com/bluetape4k/bluetape4k-graph/blob/a405300799b36d4d6edb7267ad07ff34d4ad3afe/graph-io/graphml/src/test/kotlin/io/bluetape4k/graph/io/graphml/GraphMlRoundTripTest.kt) defines every fixture variable and is the complete executable release example. Run:
...
See [formats](/manual/bluetape4k-graph/1.0/graph-io/formats/), [OkIO security](/manual/bluetape4k-graph/1.0/graph-io/okio-security/), and [failure/cancellation](/manual/bluetape4k-graph/1.0/guides/failure-and-cancellation/). The module does not preserve every GraphML extension, invent reverse edges for undirected data, or make XML input safe without limits.
