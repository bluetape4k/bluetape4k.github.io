---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-ktor"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-ktor.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [Ktor integration](/manual/bluetape4k-graph/1.0/frameworks/ktor/), [paired APIs](/manual/bluetape4k-graph/1.0/architecture/paired-apis/), and [operations](/manual/bluetape4k-graph/1.0/guides/operations/). The plugin does not create request transactions, close caller-owned resources by default, or make blocking calls nonblocking.
