---
slug: "manual/bluetape4k-graph/1.0/modules/graph-okio"
title: "graph-okio"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/graph-okio.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [OkIO security](/manual/bluetape4k-graph/1.0/graph-io/okio-security/), [formats](/manual/bluetape4k-graph/1.0/graph-io/formats/), and [operations](/manual/bluetape4k-graph/1.0/guides/operations/). This module does not manage keys, define an encrypted CSV bundle, make deterministic encryption randomized, or own caller-supplied streams by default.
