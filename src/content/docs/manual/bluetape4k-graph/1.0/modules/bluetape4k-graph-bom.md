---
slug: "manual/bluetape4k-graph/1.0/modules/bluetape4k-graph-bom"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/modules/bluetape4k-graph-bom.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
See [repository map](/manual/bluetape4k-graph/1.0/architecture/repository-map/), [getting started](/manual/bluetape4k-graph/1.0/getting-started/), and the page for each selected module. This page does not recommend a standalone graph version, document backend APIs, or promise compatibility for examples and benchmark projects.
