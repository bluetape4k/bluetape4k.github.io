---
slug: "manual/bluetape4k-graph/1.0/guides/learning-path"
title: "Learning path"
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-graph/en/guides/learning-path.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Use the [selection guide](/manual/bluetape4k-graph/1.0/backends/selection-guide/). Run the same example against two candidates and record schema, property types, transaction and traversal differences. A compile success is not semantic proof.

## Stage 5: transfer and operate

Round-trip a small dataset with [graph-io](/manual/bluetape4k-graph/1.0/graph-io/formats/), inject malformed/truncated input, then establish metrics and recovery steps from [Operations](/manual/bluetape4k-graph/1.0/guides/operations/). Only then benchmark the representative workload.
