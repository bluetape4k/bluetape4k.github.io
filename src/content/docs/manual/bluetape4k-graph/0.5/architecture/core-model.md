---
slug: "manual/bluetape4k-graph/0.5/architecture/core-model"
title: "Core model"
manual:
...
`GraphPath` contains alternating `PathStep.VertexStep` and `PathStep.EdgeStep` values for full paths. `vertices`, `edges`, `length`, and `totalWeight` are derived views; a path created only from vertices has no inferred edges. See [`GraphPath.kt`](https://github.com/bluetape4k/bluetape4k-graph/blob/3e0fa7cb9e3bc70c2743aeebda2487f3e45e4907/graph/graph-core/src/main/kotlin/io/bluetape4k/graph/model/GraphPath.kt) and [`GraphPathTest.kt`](https://github.com/bluetape4k/bluetape4k-graph/blob/3e0fa7cb9e3bc70c2743aeebda2487f3e45e4907/graph/graph-core/src/test/kotlin/io/bluetape4k/graph/model/GraphPathTest.kt).
