---
slug: "manual/bluetape4k-graph/0.5/modules/graph-okio"
title: "graph-okio"
manual:
...
See [OkIO security](/manual/bluetape4k-graph/0.5/graph-io/okio-security/), [formats](/manual/bluetape4k-graph/0.5/graph-io/formats/), and [operations](/manual/bluetape4k-graph/0.5/guides/operations/). This module does not manage keys, define an encrypted CSV bundle, make deterministic encryption randomized, or own caller-supplied streams by default.
