...
[![code graph examples architecture](/manual-assets/bluetape4k-graph/0.5/readme-diagrams/examples-code-graph-examples-architecture-01.png)](../../assets/readme-diagrams/examples-code-graph-examples-architecture-01.svg)
...
[![code graph examples data flow](/manual-assets/bluetape4k-graph/0.5/readme-diagrams/examples-code-graph-examples-data-flow-03.png)](../../assets/readme-diagrams/examples-code-graph-examples-data-flow-03.svg)

_Release README: [`examples/code-graph-examples/README.md`](https://github.com/bluetape4k/bluetape4k-graph/blob/3e0fa7cb9e3bc70c2743aeebda2487f3e45e4907/examples/code-graph-examples/README.md)_

### code graph examples ERD

[![code graph examples ERD](/manual-assets/bluetape4k-graph/0.5/readme-diagrams/examples-code-graph-examples-erd-02.png)](../../assets/readme-diagrams/examples-code-graph-examples-erd-02.svg)
