---
slug: "manual/bluetape4k-javers/1.0/persistence/exposed"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-javers/en/persistence/exposed.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
[![Exposed snapshot persistence flow](/manual-assets/bluetape4k-javers/1.0/persistence/exposed-snapshot-flow.png)](../../assets/persistence/exposed-snapshot-flow.svg)
...
The repository implementation is pinned at [`ExposedCdoSnapshotRepository.kt`](https://github.com/bluetape4k/bluetape4k-javers/blob/6648b73333cb665ecba0340588dbc3556c308a52/javers-exposed/src/main/kotlin/io/bluetape4k/javers/persistence/exposed/repository/ExposedCdoSnapshotRepository.kt). Continue with [testing](/manual/bluetape4k-javers/1.0/guides/testing/).
