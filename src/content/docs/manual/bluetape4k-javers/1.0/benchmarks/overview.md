---
slug: "manual/bluetape4k-javers/1.0/benchmarks/overview"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-javers/en/benchmarks/overview.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
## Evidence included in 1.0.0

Release 1.0.0 contains one benchmark artifact:
...
It was generated by the released [`EnversComparisonBenchmark`](https://github.com/bluetape4k/bluetape4k-javers/blob/6648b73333cb665ecba0340588dbc3556c308a52/benchmark/javers-exposed-benchmark/src/main/kotlin/io/bluetape4k/javers/benchmark/exposed/EnversComparisonBenchmark.kt). Later benchmark modules or result files are outside this manual's release boundary.
...
Continue with the detailed [JaVers + Exposed and Envers comparison](/manual/bluetape4k-javers/1.0/benchmarks/exposed-ddd-envers/) and the [released order example](/manual/bluetape4k-javers/1.0/examples/javers-exposed-ddd/).
