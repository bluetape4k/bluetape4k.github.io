---
slug: "manual/bluetape4k-javers/1.0/architecture/repository-map"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-javers/en/architecture/repository-map.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Release 1.0.0 has no composite `CdoSnapshotRepository` that automatically writes to Exposed and Redis or couples Kafka with a query repository. Composition is an application responsibility. Read [repository composition](/manual/bluetape4k-javers/1.0/architecture/repository-composition/) before adding a second destination.
