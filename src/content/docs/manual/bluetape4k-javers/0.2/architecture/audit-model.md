---
slug: "manual/bluetape4k-javers/0.2/architecture/audit-model"
title: "Audit model"
manual:
...
[![JaVers audit snapshot model](/manual-assets/bluetape4k-javers/0.2/architecture/audit-snapshot-model.png)](../../assets/architecture/audit-snapshot-model.svg)
...
Continue with [repository composition](/manual/bluetape4k-javers/0.2/architecture/repository-composition/) to map this model onto storage.
