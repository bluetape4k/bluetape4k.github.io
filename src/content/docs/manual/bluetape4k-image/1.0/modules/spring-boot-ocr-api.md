---
slug: "manual/bluetape4k-image/1.0/modules/spring-boot-ocr-api"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/en/modules/spring-boot-ocr-api.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
The workshop uses [`bluetape4k-images-ocr`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images-ocr/) and core image decoding. Pair it with [`spring-boot-image-api`](/manual/bluetape4k-image/1.0/modules/spring-boot-image-api/) only after deciding whether OCR runs before or after durable storage.
...
4. Compare [`ktor-ocr-api`](/manual/bluetape4k-image/1.0/modules/ktor-ocr-api/) to see the same domain boundary with explicit multipart streaming.
...
_Release README: [`examples/spring-boot-ocr-api/README.md`](https://github.com/bluetape4k/bluetape4k-image/blob/b38d4891b66dff8bc63db0018b5e41810d1da9bc/examples/spring-boot-ocr-api/README.md)_
...
- [Release README](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-ocr-api/README.md)
- [Application source](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-ocr-api/src/main/kotlin/io/bluetape4k/images/examples/spring/ocr/SpringBootOcrApiApplication.kt)
- [Integration test](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-ocr-api/src/test/kotlin/io/bluetape4k/images/examples/spring/ocr/SpringBootOcrApiApplicationTest.kt)
- [Gradle build file](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-ocr-api/build.gradle.kts)
