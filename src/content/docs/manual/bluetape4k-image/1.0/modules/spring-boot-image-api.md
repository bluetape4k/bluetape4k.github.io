---
slug: "manual/bluetape4k-image/1.0/modules/spring-boot-image-api"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/en/modules/spring-boot-image-api.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
The example combines [`bluetape4k-images-spring-boot`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images-spring-boot/) and [`bluetape4k-images`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images/). Replace local storage with an application-approved backend only after defining bucket ownership, credentials, URLs, retention, and CDN policy.
...
1. Run [`basic-processing`](/manual/bluetape4k-image/1.0/modules/basic-processing/) to understand the transform.
2. Run this workshop and inspect the storage directory and both downloads.
3. Read the Spring Boot storage module manual.
4. Continue to [`spring-boot-ocr-api`](/manual/bluetape4k-image/1.0/modules/spring-boot-ocr-api/) or a larger workshop before adding native OCR or S3/CDN concerns.
...
_Release README: [`examples/spring-boot-image-api/README.md`](https://github.com/bluetape4k/bluetape4k-image/blob/b38d4891b66dff8bc63db0018b5e41810d1da9bc/examples/spring-boot-image-api/README.md)_
...
- [Release README](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-image-api/README.md)
- [Controller and service](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-image-api/src/main/kotlin/io/bluetape4k/images/examples/spring/SpringBootImageApiApplication.kt)
- [Application configuration](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-image-api/src/main/resources/application.yml)
- [Integration test](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-image-api/src/test/kotlin/io/bluetape4k/images/examples/spring/SpringBootImageApiApplicationTest.kt)
- [Gradle build file](https://github.com/bluetape4k/bluetape4k-image/blob/1.0.0/examples/spring-boot-image-api/build.gradle.kts)
