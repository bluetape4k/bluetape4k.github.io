---
slug: "manual/bluetape4k-image/1.0/modules/ktor-image-api"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/en/modules/ktor-image-api.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
The application combines [`bluetape4k-images-ktor`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images-ktor/), [`bluetape4k-images-captcha`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images-captcha/), and [`bluetape4k-images`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images/). Add storage through an application-owned service rather than making the thumbnail route imply persistence.
...
1. Run [`basic-processing`](/manual/bluetape4k-image/1.0/modules/basic-processing/) to learn the underlying image operations.
...
4. Continue to [`ktor-ocr-api`](/manual/bluetape4k-image/1.0/modules/ktor-ocr-api/) for a custom streamed multipart route and native-service error mapping.
