---
slug: "manual/bluetape4k-image/1.0/modules/ktor-ocr-api"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/en/modules/ktor-ocr-api.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
The workshop uses [`bluetape4k-images-ocr`](/manual/bluetape4k-image/1.0/modules/bluetape4k-images-ocr/) and core image decoding. Compare [`spring-boot-ocr-api`](/manual/bluetape4k-image/1.0/modules/spring-boot-ocr-api/) to choose framework wiring without changing the OCR domain boundary.
...
1. Learn multipart route conventions in [`ktor-image-api`](/manual/bluetape4k-image/1.0/modules/ktor-image-api/).
