---
slug: "manual/bluetape4k-image/1.0/guides/codec-and-format-selection"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/en/guides/codec-and-format-selection.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
The common [Vips API](/manual/bluetape4k-image/1.0/native/vips-api/) exposes image formats and encoding options, while the two JDK 25 implementations delegate capability to their native binding and installed libvips. AVIF and HEIC are incubating paths. Verify the target machine with real encode and decode fixtures; do not infer support from a developer laptop.
