---
slug: "manual/bluetape4k-image/1.0/guides/performance-selection"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-image/en/guides/performance-selection.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Do not extrapolate current JDK 25 FFM results to the historical JDK 21 JNI rows, or a natural-photo fixture to documents and alpha-heavy graphics. The published JNI backend now also requires JDK 25. See [interpreting benchmark results](/manual/bluetape4k-image/1.0/benchmarks/interpreting-results/).
