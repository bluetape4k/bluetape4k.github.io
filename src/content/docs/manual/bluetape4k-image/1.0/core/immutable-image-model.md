---
slug: "manual/bluetape4k-image/1.0/core/immutable-image-model"
manualId: "immutable-image-model"
title: "Immutable Image Model"
locale: "en"
releaseRef: "1.0.0"
manual:
  id: "core/immutable-image-model"
  repository: "bluetape4k-image"
  group: "overview"
  kind: "guide"
  sourceCommit: "b38d4891b66dff8bc63db0018b5e41810d1da9bc"
  sourcePath: "docs/manual/bluetape4k-image/en/core/immutable-image-model.md"
  minorVersion: "1.0"
  releaseRef: "1.0.0"
...
Use <code>immutableImageOf</code> overloads for byte arrays, streams, Okio sources, files, and paths. These helpers centralize decoding and keep callers on the same image type. [Loading and writing](/manual/bluetape4k-image/1.0/core/loading-and-writing/) explains ownership at I/O boundaries.
...
- [ImmutableImage factories](https://github.com/bluetape4k/bluetape4k-image/blob/b38d4891b66dff8bc63db0018b5e41810d1da9bc/images/src/main/kotlin/io/bluetape4k/images/ImmutableImageSupport.kt)
- [Module reference](/manual/bluetape4k-image/1.0/modules/bluetape4k-images/)
