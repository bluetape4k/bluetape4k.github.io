---
slug: "manual/bluetape4k-image/0.4/guides/performance-selection"
...
Do not extrapolate Java 25 FFM results to Java 21 JNI, or a natural-photo fixture to documents and alpha-heavy graphics. See [interpreting benchmark results](/manual/bluetape4k-image/0.4/benchmarks/interpreting-results/).
