---
slug: "manual/bluetape4k-image/0.4/architecture/runtime-boundaries"
...
![Resource ownership across decode, transform, encode, and native processing](/manual-assets/bluetape4k-image/0.4/architecture/processing-lifecycle.svg)
...
The Java 21 implementation requires JVips/JNI and a visible system libvips installation. The Java 25 implementation requires JDK 25, system libvips, and <code>--enable-native-access=ALL-UNNAMED</code>. See [native resource lifecycle](/manual/bluetape4k-image/0.4/guides/native-resource-lifecycle/).
