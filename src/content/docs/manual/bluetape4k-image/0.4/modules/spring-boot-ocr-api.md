---
slug: "manual/bluetape4k-image/0.4/modules/spring-boot-ocr-api"
...
The workshop uses [`bluetape4k-images-ocr`](/manual/bluetape4k-image/0.4/modules/bluetape4k-images-ocr/) and core image decoding. Pair it with [`spring-boot-image-api`](/manual/bluetape4k-image/0.4/modules/spring-boot-image-api/) only after deciding whether OCR runs before or after durable storage.
...
4. Compare [`ktor-ocr-api`](/manual/bluetape4k-image/0.4/modules/ktor-ocr-api/) to see the same domain boundary with explicit multipart streaming.
