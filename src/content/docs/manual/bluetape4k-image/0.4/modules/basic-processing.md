---
slug: "manual/bluetape4k-image/0.4/modules/basic-processing"
...
2. Read the [`bluetape4k-images` module](/manual/bluetape4k-image/0.4/modules/bluetape4k-images/) to understand the underlying load, transform, and writer APIs.
3. Choose [`spring-boot-image-api`](/manual/bluetape4k-image/0.4/modules/spring-boot-image-api/) or [`ktor-image-api`](/manual/bluetape4k-image/0.4/modules/ktor-image-api/) for HTTP integration.
4. Use the [image benchmark](/manual/bluetape4k-image/0.4/modules/bluetape4k-images-benchmark/) before moving a production workload to libvips.
