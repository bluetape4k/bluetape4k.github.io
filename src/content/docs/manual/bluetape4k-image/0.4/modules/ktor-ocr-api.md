---
slug: "manual/bluetape4k-image/0.4/modules/ktor-ocr-api"
...
The workshop uses [`bluetape4k-images-ocr`](/manual/bluetape4k-image/0.4/modules/bluetape4k-images-ocr/) and core image decoding. Compare [`spring-boot-ocr-api`](/manual/bluetape4k-image/0.4/modules/spring-boot-ocr-api/) to choose framework wiring without changing the OCR domain boundary.
...
1. Learn multipart route conventions in [`ktor-image-api`](/manual/bluetape4k-image/0.4/modules/ktor-image-api/).
