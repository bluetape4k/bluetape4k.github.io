---
slug: "manual/bluetape4k-image/0.4/core/immutable-image-model"
...
Use <code>immutableImageOf</code> overloads for byte arrays, streams, Okio sources, files, and paths. These helpers centralize decoding and keep callers on the same image type. [Loading and writing](/manual/bluetape4k-image/0.4/core/loading-and-writing/) explains ownership at I/O boundaries.
...
- [Module reference](/manual/bluetape4k-image/0.4/modules/bluetape4k-images/)
