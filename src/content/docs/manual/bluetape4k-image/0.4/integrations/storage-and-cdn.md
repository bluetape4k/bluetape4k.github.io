---
slug: "manual/bluetape4k-image/0.4/integrations/storage-and-cdn"
...
The [Spring Boot image API workshop](/manual/bluetape4k-image/0.4/modules/spring-boot-image-api/) starts with local storage. Extend it to S3 only after the same storage contract and failure behavior are tested.
