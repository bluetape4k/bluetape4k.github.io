---
slug: "manual/bluetape4k-image/0.3/core/immutable-image-model"
...
manual:
  ...
  sourcePath: "docs/manual/en/core/immutable-image-model.md"
  minorVersion: "0.3"
  releaseRef: "0.3.0"
...
Use <code>immutableImageOf</code> overloads for byte arrays, streams, Okio sources, files, and paths. These helpers centralize decoding and keep callers on the same image type. [Loading and writing](/manual/bluetape4k-image/0.3/core/loading-and-writing/) explains ownership at I/O boundaries.
...
- [Module reference](/manual/bluetape4k-image/0.3/modules/bluetape4k-images/)
