---
slug: "manual/bluetape4k-projects/1.11"
...
- **Build:** Start with [Getting started](/manual/bluetape4k-projects/1.11/getting-started/), then choose a foundation, data, infrastructure, web, or utility module.
...
See the [repository map](/manual/bluetape4k-projects/1.11/architecture/repository-map/) for the module groups and the [getting started guide](/manual/bluetape4k-projects/1.11/getting-started/) for the first dependency and code path.
