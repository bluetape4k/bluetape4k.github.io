---
slug: "manual/bluetape4k-projects/1.11/modules/bluetape4k-annotations"
...
| Question | Chapter |
| --- | --- |
| Which marker fits this contract? | [Marker selection](/manual/bluetape4k-projects/1.11/modules/bluetape4k-annotations/marker-selection/) |
| Should `@OptIn` live on a function, class, or file? | [Opt-in scope](/manual/bluetape4k-projects/1.11/modules/bluetape4k-annotations/opt-in-scope/) |
| How do I permit calls but restrict third-party implementations? | [Implementation-sensitive SPI](/manual/bluetape4k-projects/1.11/modules/bluetape4k-annotations/implementation-spi/) |
| What happens when an API stabilizes or becomes obsolete? | [Compatibility lifecycle](/manual/bluetape4k-projects/1.11/modules/bluetape4k-annotations/compatibility-lifecycle/) |
| Where are complete declaration and caller examples? | [Practical recipes](/manual/bluetape4k-projects/1.11/modules/bluetape4k-annotations/recipes/) |
...
- [Module README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/bluetape4k/annotations/README.md)
- [Annotation source directory](https://github.com/bluetape4k/bluetape4k-projects/tree/1.11.0/bluetape4k/annotations/src/main/kotlin/io/bluetape4k/annotations)
- [Marker contract tests](https://github.com/bluetape4k/bluetape4k-projects/blob/1.11.0/bluetape4k/annotations/src/test/kotlin/io/bluetape4k/annotations/BluetapeApiMarkersTest.kt)
