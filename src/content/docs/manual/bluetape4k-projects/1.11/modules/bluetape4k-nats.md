...
1. [Connection and options ownership](/manual/bluetape4k-projects/1.11/modules/bluetape4k-nats/connection-options-ownership/) — assign option, connection, reconnect, and shutdown responsibilities.
2. [Core pub-sub and request-reply](/manual/bluetape4k-projects/1.11/modules/bluetape4k-nats/core-pubsub-request-reply/) — distinguish ephemeral delivery, flush, timeouts, and no responders.
3. [Messages, subscriptions, and dispatchers](/manual/bluetape4k-projects/1.11/modules/bluetape4k-nats/messages-subscriptions-dispatchers/) — build messages and choose blocking pulls or callback dispatch.
4. [JetStream streams and consumers](/manual/bluetape4k-projects/1.11/modules/bluetape4k-nats/jetstream-streams-consumers/) — use publish acknowledgments, stream reconciliation, durable consumers, and fetch limits.
5. [KeyValue, ObjectStore, and Service APIs](/manual/bluetape4k-projects/1.11/modules/bluetape4k-nats/keyvalue-objectstore-services/) — separate revisioned state, chunked objects, and request handlers.
6. [Failures, testing, operations, and ecosystem boundaries](/manual/bluetape4k-projects/1.11/modules/bluetape4k-nats/failures-testing-operations-ecosystem/) — handle not-found, Testcontainers, telemetry, and Spring integration ownership.
