...
For direct SQL or connection and pool helpers, start with [`bluetape4k-r2dbc`](/manual/bluetape4k-projects/1.11/modules/bluetape4k-r2dbc/). If you need table DSLs and repository abstractions, compare Exposed R2DBC in the [ecosystem path](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/ecosystem-paths/).
...
1. [Start with entity operations](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/entity-operations/) — Understand receiver types, ID helpers, and the configuration this module does not own.
2. [Flow and result cardinality](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/flow-and-cardinality/) — Distinguish multi-row, exactly-one, first-row, and nullable results.
3. [Insert, update, and delete](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/write-operations/) — Interpret inserted entities and affected row counts without confusing insert with save.
4. [Queries and repositories](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/queries-and-repositories/) — Build repositories and WebFlux endpoints with Spring Data `Query` and `Criteria`.
5. [Transactions, failures, and testing](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/transactions-and-testing/) — Connect external transaction ownership, cancellation, H2 integration tests, and failure assertions.
6. [R2DBC ecosystem path](/manual/bluetape4k-projects/1.11/modules/bluetape4k-spring-boot-r2dbc/ecosystem-paths/) — Choose the next step among core R2DBC, JDBC, Exposed R2DBC, and workshops.
...
Continue to the [Exposed R2DBC Workshop](https://github.com/bluetape4k/exposed-r2dbc-workshop) for a higher-level SQL DSL and repository exercises. To start from raw R2DBC, follow the [`bluetape4k-r2dbc` learning path](/manual/bluetape4k-projects/1.11/modules/bluetape4k-r2dbc/ecosystem-paths/).
...
[![Core Class Structure diagram](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/spring-boot-r2dbc-diagram-01.png)](../../assets/readme-diagrams/spring-boot-r2dbc-diagram-01.svg)
...
[![R2DBC + Coroutines Data Flow diagram](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/spring-boot-r2dbc-diagram-02.png)](../../assets/readme-diagrams/spring-boot-r2dbc-diagram-02.svg)

_Release README: [`spring-boot/r2dbc/README.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/6187173b58e8b4c5c435c145e00e94708f31ef75/spring-boot/r2dbc/README.md)_

### CRUD Operation Hierarchy diagram

[![CRUD Operation Hierarchy diagram](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/spring-boot-r2dbc-diagram-03.png)](../../assets/readme-diagrams/spring-boot-r2dbc-diagram-03.svg)

_Release README: [`spring-boot/r2dbc/README.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/6187173b58e8b4c5c435c145e00e94708f31ef75/spring-boot/r2dbc/README.md)_

### Coroutine Conversion Sequence diagram

[![Coroutine Conversion Sequence diagram](/manual-assets/bluetape4k-projects/1.11/readme-diagrams/spring-boot-r2dbc-sequence-01.png)](../../assets/readme-diagrams/spring-boot-r2dbc-sequence-01.svg)
