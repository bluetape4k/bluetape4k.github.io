---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-core/validation"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-core/validation.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Validation boundaries for caller arguments, object state, and domain rules](/manual-assets/bluetape4k-projects/2.0/core/validation-boundary.svg)
...
- [`RequireSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/main/kotlin/io/bluetape4k/support/RequireSupport.kt)
- [`RequireSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/test/kotlin/io/bluetape4k/support/RequireSupportTest.kt)

Next, keep validated data inside a fixed memory budget with [Bounded collections](/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/bounded-collections/).
