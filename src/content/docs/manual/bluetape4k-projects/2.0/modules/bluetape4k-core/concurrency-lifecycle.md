---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-core/concurrency-lifecycle"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-core/concurrency-lifecycle.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![ConcurrentReducer capacity and failure paths](/manual-assets/bluetape4k-projects/2.0/core/concurrent-reducer-capacity.svg)
...
![Shutdown resources in reverse registration order](/manual-assets/bluetape4k-projects/2.0/core/shutdown-order.svg)
...
- [`ConcurrentReducer.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/main/kotlin/io/bluetape4k/concurrent/ConcurrentReducer.kt)
- [`ConcurrentReducerTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/test/kotlin/io/bluetape4k/concurrent/ConcurrentReducerTest.kt)
- [`ShutdownQueue.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/main/kotlin/io/bluetape4k/utils/ShutdownQueue.kt)
- [`ShutdownQueueTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/test/kotlin/io/bluetape4k/utils/ShutdownQueueTest.kt)

Continue with [Bounded collections](/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/bounded-collections/) for process-local state and [Core recipes](/manual/bluetape4k-projects/2.0/modules/bluetape4k-core/recipes/) for the assembled flow.
