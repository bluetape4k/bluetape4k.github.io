---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-logging/scoped-mdc"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-logging/scoped-mdc.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Lifecycle of outer, inner, and restored MDC state](/manual-assets/bluetape4k-projects/2.0/logging/mdc-scope-lifecycle.svg)
...
- [`MdcSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/logging/src/main/kotlin/io/bluetape4k/logging/MdcSupport.kt)
- [`MdcSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/logging/src/test/kotlin/io/bluetape4k/logging/MdcSupportTest.kt)

Use [Coroutine MDC](/manual/bluetape4k-projects/2.0/modules/bluetape4k-logging/coroutine-mdc/) when suspend code can switch threads.
