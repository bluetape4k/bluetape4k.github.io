---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-logging/async-channel"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-logging/async-channel.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![KLoggingChannel send, collect, close, and post-close flow](/manual-assets/bluetape4k-projects/2.0/logging/async-channel-sequence.svg)
...
- [`KLoggingChannel.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/logging/src/main/kotlin/io/bluetape4k/logging/coroutines/KLoggingChannel.kt)
- [`KLoggingChannelTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/logging/src/test/kotlin/io/bluetape4k/logging/coroutines/KLoggingChannelTest.kt)

Finish with configuration and diagnostics in [Operations & recipes](/manual/bluetape4k-projects/2.0/modules/bluetape4k-logging/operations-recipes/).
