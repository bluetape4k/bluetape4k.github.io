---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-hibernate-cache-lettuce.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Use plain Caffeine for a small single-process cache. Use [bluetape4k-cache-lettuce](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-lettuce/) when the application needs a direct cache API rather than a Hibernate provider.
...
1. [Near Cache architecture and regions](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/architecture-regions/)
2. [Configuration, codecs, and TTL](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/configuration-codecs-ttl/)
3. [Entity, collection, and query caching](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/entity-query-collection-cache/)
4. [Keys, concurrency, and invalidation](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/keys-concurrency-invalidation/)
5. [Lifecycle, failures, and operations](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/lifecycle-failures-operations/)
6. [Spring Boot and ecosystem paths](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/spring-boot-ecosystem/)
...
The module combines `bluetape4k-cache-lettuce`, `bluetape4k-lettuce`, `bluetape4k-io`, and Hibernate ORM. [bluetape4k-spring-boot-hibernate-lettuce](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-hibernate-lettuce/) maps `bluetape4k.cache.lettuce-near.*` settings to Hibernate and adds Metrics and Actuator integration.

Continue with [bluetape4k-hibernate](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate/) for ORM lifecycle helpers or [bluetape4k-lettuce](/manual/bluetape4k-projects/2.0/modules/bluetape4k-lettuce/) for direct Redis APIs.
...
The [Hibernate Lettuce demo](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-hibernate-lettuce-demo/) provides a runnable Product entity, Spring Data repository, cache endpoints, and `application.yml`. Inside this module, `HibernateEntityCacheTest`, `HibernateQueryCacheTest`, and `HibernateAdvancedKeyCacheTest` are small executable lessons.
