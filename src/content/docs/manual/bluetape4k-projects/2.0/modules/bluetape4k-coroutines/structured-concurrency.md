---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/structured-concurrency"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-coroutines/structured-concurrency.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Comparison of taskScope, firstSuccessTaskScope, and supervisedTaskScope](/manual-assets/bluetape4k-projects/2.0/coroutines/structured-policies.svg)
...
- [`StructuredConcurrency.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/StructuredConcurrency.kt)
...
Continue with [Operations and observability](/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/operations/) to operate and shut down the selected policy.
