---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/subjects"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-coroutines/subjects.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
![Comparison of Publish, Behavior, Replay, Multicast, and UnicastWork contracts](/manual-assets/bluetape4k-projects/2.0/coroutines/subject-contracts.svg)
...
- [`subject` implementations](https://github.com/bluetape4k/bluetape4k-projects/tree/2.0.0/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/flow/extensions/subject)
- [`SubjectCancellationTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/extensions/subject/SubjectCancellationTest.kt)
- [`PublishSubjectTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/extensions/subject/PublishSubjectTest.kt)
- [`ReplaySubjectSizeBoundTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/extensions/subject/ReplaySubjectSizeBoundTest.kt)

Next: choose child-failure semantics at scope level in [Structured concurrency policies](/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/structured-concurrency/).
