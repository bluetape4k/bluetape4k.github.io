---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/ecosystem-paths"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-r2dbc/ecosystem-paths.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
| 3 | [`bluetape4k-spring-boot-r2dbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/) | Coroutine CRUD and Flow repository patterns for `R2dbcEntityOperations` |
...
[`bluetape4k-jdbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/) remains appropriate for blocking services, batch work, existing JDBC tooling, and small vendor-SQL adapters. Choose R2DBC for a supported non-blocking driver and execution model, not merely because the caller uses coroutine syntax.
...
- [`bluetape4k-coroutines`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-coroutines/)
- [`bluetape4k-spring-boot-r2dbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/)
- [`bluetape4k-testcontainers`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-testcontainers/)
- [`bluetape4k-jdbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/)
