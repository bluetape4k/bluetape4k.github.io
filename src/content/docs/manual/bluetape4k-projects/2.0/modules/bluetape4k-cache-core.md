---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-cache-core.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
1. [Local providers and JCache](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/local-providers-jcache/) — compare Caffeine, Cache2k, Ehcache, JCache managers, and expiry defaults.
2. [Cache-aside and loader/writer contracts](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/cache-aside-loader-writer/) — separate caller-owned loading from JCache read/write-through configuration.
3. [Memoizers and same-key computation](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/memoizers-single-flight/) — cover sync, future, and suspend computation, `SingleFlight`, failure, and `clear()`.
4. [Near Cache front/back semantics](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/near-cache-semantics/) — trace local hits, back lookups, front fills, invalidation, and statistics.
5. [Retry, failures, and lifecycle](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/resilience-failures-lifecycle/) — verify read fallback, write exceptions, cancellation, and close behavior.
6. [Testing and ecosystem paths](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/testing-ecosystem-paths/) — move from shared fixtures to Lettuce, Redisson, Exposed, and workshops.
...
`bluetape4k-cache-lettuce` and `bluetape4k-cache-redisson` implement remote storage and invalidation on top of these common contracts. Continue with [bluetape4k-cache-lettuce](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-lettuce/) for Lettuce and RESP3, or [bluetape4k-cache-redisson](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-redisson/) for Redisson local cached maps.
...
The module tests are the smallest runnable examples. Continue with the [cache-lettuce manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-lettuce/) and [cache-redisson manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-redisson/) for Redis invalidation.
...
- [`CaffeineSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-core/src/main/kotlin/io/bluetape4k/cache/caffeine/CaffeineSupport.kt)
- [`JCacheSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-core/src/main/kotlin/io/bluetape4k/cache/jcache/JCacheSupport.kt)
- [`CaffeineSuspendJCache.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-core/src/main/kotlin/io/bluetape4k/cache/jcache/CaffeineSuspendJCache.kt)
- [`SingleFlight.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-core/src/main/kotlin/io/bluetape4k/cache/memoizer/SingleFlight.kt)
...
- [`JCacheSupportExtTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-core/src/test/kotlin/io/bluetape4k/cache/jcache/JCacheSupportExtTest.kt)
- [`SingleFlightTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-core/src/test/kotlin/io/bluetape4k/cache/memoizer/SingleFlightTest.kt)
