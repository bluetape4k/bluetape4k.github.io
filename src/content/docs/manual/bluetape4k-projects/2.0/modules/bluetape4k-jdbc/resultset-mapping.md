---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/resultset-mapping"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-jdbc/resultset-mapping.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [`ResultSetGetColumnTokens.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/jdbc/src/main/kotlin/io/bluetape4k/jdbc/sql/ResultSetGetColumnTokens.kt)
- [`ResultSetExtensionsTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/jdbc/src/test/kotlin/io/bluetape4k/jdbc/sql/ResultSetExtensionsTest.kt)
...
After defining how query results become values, continue with [Transactions and state restoration](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/transactions/) to group multiple statements into one success or failure boundary.
