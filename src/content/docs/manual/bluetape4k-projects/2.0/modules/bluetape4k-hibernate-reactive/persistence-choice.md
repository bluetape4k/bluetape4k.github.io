---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-reactive/persistence-choice"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-hibernate-reactive/persistence-choice.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
| --- | --- | --- |
| Spring JPA, blocking JDBC, conventional EntityManager | [bluetape4k-hibernate](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate/) | Uses regular Hibernate Session and the JPA ecosystem. |
...
| Direct control of SQL, row mapping, pools, and Flow | [bluetape4k-r2dbc](/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/) | Builds R2DBC boundaries without an ORM persistence context. |
...
- [Conventional Hibernate source](https://github.com/bluetape4k/bluetape4k-projects/tree/2.0.0/data/hibernate/src/main/kotlin)
- [Hibernate Reactive source](https://github.com/bluetape4k/bluetape4k-projects/tree/2.0.0/data/hibernate-reactive/src/main/kotlin)
- [R2DBC source](https://github.com/bluetape4k/bluetape4k-projects/tree/2.0.0/data/r2dbc/src/main/kotlin)
- [Choosing after JDBC](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/ecosystem-paths/)
