---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/cache-spring-separation"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-redis/cache-spring-separation.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
The [Cache Core manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-core/) explains cache-aside, stampede control, Near Cache, and failure contracts independently of a provider. Confirm that the abstraction is needed before selecting a provider.
...
- [Lettuce Cache](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-lettuce/)
- [Redisson Cache](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-redisson/)
- [Hibernate Cache Lettuce](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate-cache-lettuce/)
- [Spring Boot Redis](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-redis/)

## Release sources

- [`cache/cache-lettuce/build.gradle.kts`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-lettuce/build.gradle.kts)
- [`cache/cache-redisson/build.gradle.kts`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/cache/cache-redisson/build.gradle.kts)
- [`spring-boot/redis/build.gradle.kts`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/redis/build.gradle.kts)
