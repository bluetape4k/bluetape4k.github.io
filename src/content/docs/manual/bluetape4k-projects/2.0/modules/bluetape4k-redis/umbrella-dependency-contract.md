---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/umbrella-dependency-contract"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-redis/umbrella-dependency-contract.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
At 2.0.0, [`infra/redis/build.gradle.kts`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/infra/redis/build.gradle.kts) declares only these dependencies:
...
The real APIs and failure contracts belong to the [Lettuce manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-lettuce/) and [Redisson manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redisson/).
