---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-cassandra/configuration-and-ownership"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-spring-boot-cassandra/configuration-and-ownership.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
After configuration, read [Reactive operations and coroutines](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-cassandra/reactive-coroutine-operations/) for subscription and empty-result contracts. For hand-written CQL, continue with [Async and low-level CQL operations](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-cassandra/async-and-cql-operations/).
