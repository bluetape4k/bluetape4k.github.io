---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-redis"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-redis.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
This coordinate puts both client artifacts on the compile and runtime classpaths. If the application uses only one, follow [Selective dependency migration](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/selective-dependency-migration/) to reduce the classpath and operational surface.
...
Once new code uses only Lettuce and all Redisson calls are gone, replace the coordinate with `bluetape4k-lettuce`. The umbrella exposes no factory or initialization function of its own; use the [Lettuce manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-lettuce/) and [Redisson manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redisson/) for client examples.
...
1. [Umbrella dependency contract](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/umbrella-dependency-contract/) — inspect the two exported artifacts and the capabilities the umbrella does not provide.
2. [Choosing Lettuce or Redisson](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/lettuce-vs-redisson/) — compare a command-oriented client with a distributed-object client by requirement.
3. [Selective dependency migration](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/selective-dependency-migration/) — inventory usages and reduce the build to one client coordinate.
4. [Lifecycle and codec boundaries](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/lifecycle-codec-boundaries/) — manage shutdown, coroutine behavior, keyspaces, and wire formats per client.
5. [Separating cache providers and Spring Data Redis](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/cache-spring-separation/) — distinguish client helpers, cache abstractions, and serializer modules.
6. [Testing, operations, and ecosystem paths](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redis/testing-operations-ecosystem/) — connect submodule tests and metrics to workshops and Exposed caching.
...
- [`infra/redis/README.md`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/infra/redis/README.md)
- [`bluetape4k-lettuce` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-lettuce/)
- [`bluetape4k-redisson` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-redisson/)
- [`bluetape4k-cache-lettuce` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-lettuce/)
- [`bluetape4k-cache-redisson` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cache-redisson/)
- [`bluetape4k-spring-boot-redis` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-redis/)
