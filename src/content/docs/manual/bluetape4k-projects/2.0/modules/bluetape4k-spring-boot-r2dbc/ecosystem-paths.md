---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/ecosystem-paths"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-spring-boot-r2dbc/ecosystem-paths.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
| Raw SQL, binding, custom row mapping, connection and transaction helpers | [`bluetape4k-r2dbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/) |
| Kotlin table DSL, DDL/DML, and repository abstractions | `bluetape4k-exposed` R2DBC |
| Blocking-driver ecosystem and a simpler transaction model | [`bluetape4k-jdbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/) |
| Object graphs, dirty checking, and a persistence context | [`bluetape4k-hibernate`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate/) |
...
Move to `bluetape4k-r2dbc` for joins, DTO projections, or vendor-specific SQL that do not fit entity operations. Its [core R2DBC manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/) explains connection pools, transaction lifecycle, typed null binding, and raw SQL mapping.
...
The [JDBC manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/) covers blocking connection, transaction, and statement lifecycles. Choose from application call paths and driver maturity rather than technology labels.
...
- [`spring-boot/r2dbc` test application](https://github.com/bluetape4k/bluetape4k-projects/tree/2.0.0/spring-boot/r2dbc/src/test/kotlin/io/bluetape4k/spring/r2dbc/coroutines/blog)
- [`bluetape4k-r2dbc` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/)
- [`bluetape4k-jdbc` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-jdbc/)
- [`bluetape4k-hibernate` manual](/manual/bluetape4k-projects/2.0/modules/bluetape4k-hibernate/)
