---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/entity-operations"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-spring-boot-r2dbc/entity-operations.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Those responsibilities remain with Spring Boot, Spring Data R2DBC, or [`bluetape4k-r2dbc`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-r2dbc/). The artifact name is not evidence of auto-configuration.
...
Continue to [Flow and result cardinality](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-r2dbc/flow-and-cardinality/).
