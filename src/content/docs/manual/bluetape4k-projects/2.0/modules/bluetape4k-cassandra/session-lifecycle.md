---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/session-lifecycle"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-cassandra/session-lifecycle.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [`CqlSessionProvider.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/CqlSessionProvider.kt): identity construction, INFO context logging, open-session reuse, closed-cache eviction, bootstrap and final session creation, and `ShutdownQueue` registration
- [`CqlSessionSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/CqlSessionSupport.kt): `cqlSession` and `cqlSessionOf`
- [`CassandraAdmin.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/main/kotlin/io/bluetape4k/cassandra/CassandraAdmin.kt): `CREATE KEYSPACE IF NOT EXISTS`
- [`ShutdownQueue.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/bluetape4k/core/src/main/kotlin/io/bluetape4k/utils/ShutdownQueue.kt): cleanup of registered resources at process shutdown
- [`CqlSessionProviderTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/CqlSessionProviderTest.kt): same-identity reuse, context separation, and rejection of blank keyspace and local datacenter
- [`CqlSessionSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/data/cassandra/src/test/kotlin/io/bluetape4k/cassandra/CqlSessionSupportTest.kt): creation and closing of directly owned sessions

## Next reading

After choosing session ownership, continue with [Coroutine queries](/manual/bluetape4k-projects/2.0/modules/bluetape4k-cassandra/coroutine-queries/) for suspend execution and paging boundaries.
