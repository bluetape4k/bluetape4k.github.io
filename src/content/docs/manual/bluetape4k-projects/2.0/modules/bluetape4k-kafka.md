---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-kafka.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
Use [`bluetape4k-kafka4`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka4/) for Kafka 4.x. The two artifacts share package and class names, so do not place both on one application classpath.
...
1. [Module boundary and client/record helpers](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/module-boundary-client-records/)
2. [Codecs, wire format, and security](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/codecs-wire-format-security/)
3. [Coroutine producer](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/coroutine-producer/)
4. [Spring Kafka templates and listener adapters](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/spring-kafka-templates-listeners/)
5. [Kafka Streams DSL factories](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/kafka-streams-dsl/)
6. [Failures, testing, operations, and ecosystem](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/failures-testing-operations-ecosystem/)
...
| --- | --- | --- |
| Create native producers/consumers | `producerOf`, `consumerOf` | [Module boundary](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/module-boundary-client-records/) |
| Metrics and topic-partition helpers | `getMetricValueOrNull`, `topicPartitionOf` | [Module boundary](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/module-boundary-client-records/) |
| String, byte array, JSON, binary codecs | `KafkaCodec`, `KafkaCodecs` | [Codecs and security](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/codecs-wire-format-security/) |
| Await or stream native producer sends | `suspendSend`, `sendAsFlow`, `sendAndForget` | [Coroutine producer](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/coroutine-producer/) |
| Send with Spring `KafkaOperations` | `io.bluetape4k.kafka.spring.suspendSend` | [Spring integration](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/spring-kafka-templates-listeners/) |
| Use Reactor Kafka producer/consumer | `SuspendKafkaProducerTemplate`, `SuspendKafkaConsumerTemplate` | [Spring integration](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/spring-kafka-templates-listeners/) |
| Build Streams parameters | `consumedOf`, `materializedOf`, `streamJoinedOf` | [Streams DSL](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka/kafka-streams-dsl/) |
...
This artifact is the Kafka 3.9.x/Spring Kafka 3.x/Jackson 2 line. Choose `bluetape4k-kafka4` for Kafka 4.2.x/Spring Kafka 4.x/Jackson 3. Sending Logback events to Kafka belongs to the separate [`bluetape4k-kafka-logback`](/manual/bluetape4k-projects/2.0/modules/bluetape4k-kafka-logback/) artifact.
...
- [Module README](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/infra/kafka/README.md)
