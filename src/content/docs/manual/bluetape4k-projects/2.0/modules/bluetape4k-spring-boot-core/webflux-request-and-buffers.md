---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-core/webflux-request-and-buffers"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-spring-boot-core/webflux-request-and-buffers.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [`HttpRequestHolder.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/core/src/main/kotlin/io/bluetape4k/spring/webflux/filter/HttpRequestHolder.kt)
- [`AbstractRedirectWebFilter.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/core/src/main/kotlin/io/bluetape4k/spring/webflux/filter/AbstractRedirectWebFilter.kt)
...
- [`DataBufferSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/core/src/test/kotlin/io/bluetape4k/spring/core/io/buffer/DataBufferSupportTest.kt)

## Next chapter

[Error responses and observations](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-core/error-responses-and-observability/) shows how to represent failures as HTTP responses and telemetry.
