---
slug: "manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-mongodb/auto-configuration-boundaries"
...
manual:
  ...
  sourcePath: "docs/manual/bluetape4k-projects/en/modules/bluetape4k-spring-boot-mongodb/auto-configuration-boundaries.md"
  minorVersion: "2.0"
  releaseRef: "2.0.0"
...
- [`AutoConfiguration.imports`](https://github.com/bluetape4k/bluetape4k-projects/blob/2.0.0/spring-boot/mongodb/src/main/resources/META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports)
...
Use the configured template in [Coroutine reads and cardinality](/manual/bluetape4k-projects/2.0/modules/bluetape4k-spring-boot-mongodb/coroutine-reads-cardinality/).
