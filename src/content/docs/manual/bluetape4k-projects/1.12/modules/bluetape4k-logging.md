---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-logging"
...
![Responsibility map for logger creation, lazy messages, MDC, and asynchronous delivery](/manual-assets/bluetape4k-projects/1.12/logging/logger-api-map.svg)
...
1. [Logger foundation](/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/logger-foundation/) — names and provider boundary
2. [Lazy messages](/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/lazy-messages/) — level guards and supplier failure
3. [Scoped MDC](/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/scoped-mdc/) — nested restoration and exceptional cleanup
4. [Coroutine MDC](/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/coroutine-mdc/) — suspension and child propagation
5. [Async channel](/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/async-channel/) — buffer, collector, close, and event loss
6. [Operations & recipes](/manual/bluetape4k-projects/1.12/modules/bluetape4k-logging/operations-recipes/) — configuration, redaction, diagnosis, and tests
...
- [Module source](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/bluetape4k/logging/src/main/kotlin/io/bluetape4k/logging)
- [Representative tests](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/bluetape4k/logging/src/test/kotlin/io/bluetape4k/logging)
- [README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/logging/README.md)
