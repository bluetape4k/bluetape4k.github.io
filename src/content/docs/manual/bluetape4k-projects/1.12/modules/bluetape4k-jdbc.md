---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc"
...
1. [Connection and DataSource lifecycle](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/connection-lifecycle/) — choose connection ownership and define the Hikari helper boundary.
2. [Prepared statements and batches](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/statements-batches/) — parameter binding, generated keys, and batch-row contracts.
3. [Reading and mapping ResultSet](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/resultset-mapping/) — SQL NULL, cardinality, collections, cursor movement, and lazy sequences.
4. [Transactions and state restoration](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/transactions/) — commit, rollback, and restoration of reusable connections.
5. [Choosing the next persistence layer](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/ecosystem-paths/) — decide whether to stay with JDBC or move to Exposed or Hibernate.
