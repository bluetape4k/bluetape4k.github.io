---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-core/testing-and-ecosystem-paths"
...
- Learn coroutine, Flow, cancellation, dispatcher, and context rules in [`bluetape4k-coroutines`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/).
- Continue to [`bluetape4k-jdbc`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/) for JDBC helpers and imperative transactions.
- Use [`bluetape4k-spring-boot-r2dbc`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-r2dbc/) for Spring Data R2DBC entity operations with Flow and suspend functions.
...
- [English README](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/spring-boot/core/README.md)
- [`WebClientReadmeExamplesTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/spring-boot/core/src/test/kotlin/io/bluetape4k/spring/tests/WebClientReadmeExamplesTest.kt)
- [`RestClientCoroutinesDslTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/spring-boot/core/src/test/kotlin/io/bluetape4k/spring/http/RestClientCoroutinesDslTest.kt)
- [`HttpRequestFilterTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/spring-boot/core/src/test/kotlin/io/bluetape4k/spring/webflux/filter/HttpRequestFilterTest.kt)
...
Return to [Common boundaries for Spring Boot applications](/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-core/) for the complete API map and 1.12.1 limitations.
