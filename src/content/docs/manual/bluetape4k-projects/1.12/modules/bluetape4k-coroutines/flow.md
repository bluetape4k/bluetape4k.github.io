---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/flow"
...
![Ordered emission in flow.async and completion-order emission in mapParallel](/manual-assets/bluetape4k-projects/1.12/coroutines/ordered-parallel-flow.svg)
...
- [`AsyncFlow.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/flow/AsyncFlow.kt)
- [`mapParallel.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/flow/extensions/mapParallel.kt)
- [`AsyncFlowTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/AsyncFlowTest.kt)
- [`MapParallelTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/flow/extensions/MapParallelTest.kt)

For callback and hot-stream delivery semantics, continue with [Subjects and event contracts](/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/subjects/).
