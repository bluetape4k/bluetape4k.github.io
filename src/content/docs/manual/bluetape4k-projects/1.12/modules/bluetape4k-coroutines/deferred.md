---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/deferred"
...
![Comparison of awaitAny, awaitAnyAndCancelOthers, and firstSuccessTaskScope](/manual-assets/bluetape4k-projects/1.12/coroutines/deferred-race-policy.svg)
...
- [`DeferredSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/support/DeferredSupport.kt)
- [`DeferredValue.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/main/kotlin/io/bluetape4k/coroutines/DeferredValue.kt)
- [`DeferredSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/support/DeferredSupportTest.kt)
- [`StructuredConcurrencyTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/bluetape4k/coroutines/src/test/kotlin/io/bluetape4k/coroutines/StructuredConcurrencyTest.kt)

For ordering and concurrency across stream items, continue with [Ordered and parallel Flow](/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/flow/).
