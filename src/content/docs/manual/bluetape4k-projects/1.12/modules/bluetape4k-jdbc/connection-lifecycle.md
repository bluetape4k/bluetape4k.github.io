---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/connection-lifecycle"
...
manual:
  ...
  sourcePath: "docs/manual/en/modules/bluetape4k-jdbc/connection-lifecycle.md"
  minorVersion: "1.12"
  releaseRef: "1.12.1"
...
- [`ConnectionExtensions.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/jdbc/src/main/kotlin/io/bluetape4k/jdbc/sql/ConnectionExtensions.kt)
- [`HikariSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/jdbc/src/main/kotlin/io/bluetape4k/jdbc/hikari/HikariSupport.kt)
- [`DataSourceSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/jdbc/src/test/kotlin/io/bluetape4k/jdbc/sql/DataSourceSupportTest.kt)
- [`HikariSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/jdbc/src/test/kotlin/io/bluetape4k/jdbc/hikari/HikariSupportTest.kt)

## Next chapter

After ownership is explicit, continue with [Prepared statements and batches](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/statements-batches/).
