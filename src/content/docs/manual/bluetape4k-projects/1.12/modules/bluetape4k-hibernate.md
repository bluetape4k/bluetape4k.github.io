---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate"
...
Use [bluetape4k-jdbc](/manual/bluetape4k-projects/1.12/modules/bluetape4k-jdbc/) for a smaller adapter that needs explicit SQL control. Compare Hibernate with Exposed in [Choosing the surrounding persistence stack](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/ecosystem-paths/).
...
1. [Entity model and lifecycle](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/entity-model-lifecycle/) — identifiers, transient and persisted equality, tree entities, and proxies.
2. [EntityManager and transactions](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/entitymanager-transactions/) — transaction ownership, save and delete behavior, flush, and bulk queries.
3. [JPQL, Criteria, and Querydsl](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/queries-criteria-querydsl/) — move from basic queries to dynamic composition and projections.
4. [Converters and security boundaries](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/converters-security/) — JSON, compression, encryption keysets, and typed serialization.
5. [StatelessSession, batches, and events](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/stateless-batch-events/) — understand which ORM features bulk processing gives up.
6. [Choosing the surrounding persistence stack](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/ecosystem-paths/) — compare JDBC, Exposed, JPA examples, and reactive paths.
...
Continue to the [JPA Querydsl demo](/manual/bluetape4k-projects/1.12/modules/bluetape4k-examples-jpa-querydsl-demo/) and [Blaze-Persistence demo](/manual/bluetape4k-projects/1.12/modules/bluetape4k-examples-jpa-blazepersistence-demo/) for application-shaped examples.
...
- [`EntityManagerFactorySupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/main/kotlin/io/bluetape4k/hibernate/EntityManagerFactorySupport.kt)
- [`EntityManagerSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/main/kotlin/io/bluetape4k/hibernate/EntityManagerSupport.kt)
...
- [`AbstractJpaEntity.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/main/kotlin/io/bluetape4k/hibernate/model/AbstractJpaEntity.kt)
- [`CriteriaSupport.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/main/kotlin/io/bluetape4k/hibernate/criteria/CriteriaSupport.kt)
- [`EncryptedStringConverters.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/main/kotlin/io/bluetape4k/hibernate/converters/EncryptedStringConverters.kt)
...
- [`EntityManagerSupportTest.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/test/kotlin/io/bluetape4k/hibernate/EntityManagerSupportTest.kt)
- [`SimpleQuerydslExamples.kt`](https://github.com/bluetape4k/bluetape4k-projects/blob/1.12.1/data/hibernate/src/test/kotlin/io/bluetape4k/hibernate/querydsl/simple/SimpleQuerydslExamples.kt)
