---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-core/recipes"
...
![Validate at the boundary and preserve invariants](/manual-assets/bluetape4k-projects/1.12/core/validation-boundary.svg)
...
![BoundedStack and RingBuffer retain different read orders](/manual-assets/bluetape4k-projects/1.12/core/bounded-collection-ordering.svg)
...
![Bound active work and waiting work independently](/manual-assets/bluetape4k-projects/1.12/core/concurrent-reducer-capacity.svg)
...
![Register dependencies first so dependents close first](/manual-assets/bluetape4k-projects/1.12/core/shutdown-order.svg)
...
- [Validation and invariants](/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/validation/)
- [Encoding and data boundaries](/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/encoding-data/)
- [Bounded collections](/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/bounded-collections/)
- [Time and ranges](/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/time-ranges/)
- [Concurrency and lifecycle](/manual/bluetape4k-projects/1.12/modules/bluetape4k-core/concurrency-lifecycle/)
- [`bluetape4k-core` tests](https://github.com/bluetape4k/bluetape4k-projects/tree/1.12.1/bluetape4k/core/src/test/kotlin/io/bluetape4k)
