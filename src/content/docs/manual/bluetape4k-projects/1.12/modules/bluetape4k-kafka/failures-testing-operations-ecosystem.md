---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-kafka/failures-testing-operations-ecosystem"
...
| Kafka 4.2.x, Spring Kafka 4.x, Jackson 3 | [`bluetape4k-kafka4`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-kafka4/) | Same packages; choose one line |
| Export Logback events to Kafka | [`bluetape4k-kafka-logback`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-kafka-logback/) | Appender/exporter only, not a general producer replacement |
| Coroutine and Flow foundations | [`bluetape4k-coroutines`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-coroutines/) | Kafka delivery semantics remain here |
| Shared Kafka Testcontainers support | [`bluetape4k-testcontainers`](/manual/bluetape4k-projects/1.12/modules/bluetape4k-testcontainers/) | Caller owns application fixtures/lifecycle |
