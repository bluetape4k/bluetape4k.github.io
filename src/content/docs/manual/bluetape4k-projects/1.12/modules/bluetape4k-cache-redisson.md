---
slug: "manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson"
...
Use [cache-core](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-core/) for a single-JVM cache. Read the [redisson](/manual/bluetape4k-projects/1.12/modules/bluetape4k-redisson/) manual when you also need maps, locks, topics, or broader Redisson support.
...
1. [Redisson JCache and suspend wrappers](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson/redisson-jcache-suspend/) — provider creation, cache reuse, async bridges, and non-atomic `getAndPut`.
2. [Memoizers and same-key work sharing](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson/memoizers-concurrency/) — JVM-local single-flight behavior across sync, future, and suspend APIs.
3. [RLocalCachedMap near-cache invalidation](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson/near-cache-invalidation/) — local/Redis tiers, Pub/Sub invalidation, clear scope, and metric limits.
4. [Configuration, codecs, and client ownership](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson/config-codec-ownership/) — TTL, idle, eviction, reconnect, wire format, and lifecycle owners.
5. [Failures, cancellation, lifecycle, and operations](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson/failures-cancellation-operations/) — Redis failures, partial success, cancellation, close, and telemetry.
6. [Cache strategies and ecosystem paths](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-redisson/ecosystem-paths/) — cache-aside versus read/write-through/behind, then Hibernate, Spring, Exposed, and workshops.
...
[cache-core](/manual/bluetape4k-projects/1.12/modules/bluetape4k-cache-core/) explains provider-independent contracts; [redisson](/manual/bluetape4k-projects/1.12/modules/bluetape4k-redisson/) covers broader Redisson APIs. Persistence caching continues through [Hibernate](/manual/bluetape4k-projects/1.12/modules/bluetape4k-hibernate/), [Spring Boot Hibernate Lettuce](/manual/bluetape4k-projects/1.12/modules/bluetape4k-spring-boot-hibernate-lettuce/), and the Exposed workshop.
...
Start with the module tests. For persistence read-through, write-through, and write-behind, follow the [redisson-demo manual](/manual/bluetape4k-projects/1.12/modules/bluetape4k-examples-redisson-demo/) and its cache-strategy tests.
