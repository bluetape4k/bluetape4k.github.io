...
const sequenceCopy = {
  ko: {
    ...
    messages: [
      ...
      ['expectedVersion과 후보로 확정 요청', 1, 2, 'amber'],
  ...
  en: {
    ...
    messages: [
      ...
      ['confirm with expectedVersion and candidate', 1, 2, 'amber'],
...
const screenCopy = {
  ko: {
    ...
    selected: '선택한 예약', selectedValues: [['appointmentRef', 'a_7F3A…91C2'], ['expectedVersion', '12'], ['원래 일정', '08-17 10:30'], ['변경 사유', 'EQUIPMENT_UNAVAILABLE']],
  ...
  en: {
    ...
    selected: 'Selected appointment', selectedValues: [['appointmentRef', 'a_7F3A…91C2'], ['expectedVersion', '12'], ['Original time', 'Aug 17 / 10:30'], ['Reason', 'EQUIPMENT_UNAVAILABLE']],
