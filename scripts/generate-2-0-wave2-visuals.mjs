...
Generated source-backed assets for Epic #413, wave 2. This directory currently contains only Issue #417.
...
Regenerate SVG and semantic ledgers with \`node scripts/generate-2-0-wave2-visuals.mjs\`. PNG files are rendered from the generated SVG files at 2x resolution.
`;
