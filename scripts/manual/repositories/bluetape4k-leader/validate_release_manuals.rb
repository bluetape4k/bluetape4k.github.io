...
if central
  ...
  begin
    options = CentralReleaseSupport.parse(ARGV, slug: "leader", inventory_name: "module-inventory.json")
    inventory = CentralReleaseSupport.ensure_inventory(options, slug: "leader")
