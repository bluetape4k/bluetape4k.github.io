...
if central
  ...
  begin
    options = CentralReleaseSupport.parse(ARGV, slug: "image", expected_tag: "0.4.0", expected_sha: "ea5175b083babf8880f53cf80c9a264a0c61777e")
    inventory = CentralReleaseSupport.ensure_inventory(options, slug: "image")
