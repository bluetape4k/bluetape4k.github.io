...
| #422 | [SVG](/assets/visual-companions/wave2/aws-sns-signature-verification-en.svg) · [PNG](/assets/visual-companions/wave2/aws-sns-signature-verification-en.png) | [SVG](/assets/visual-companions/wave2/aws-sns-signature-verification-ko.svg) · [PNG](/assets/visual-companions/wave2/aws-sns-signature-verification-ko.png) | [EN](/visual-companions/bluetape4k-aws/aws-sns-signature-verification/) · [KO](/ko/visual-companions/bluetape4k-aws/aws-sns-signature-verification/) |
| #423 | [SVG](/assets/visual-companions/wave2/aws-sqs-extended-client-en.svg) · [PNG](/assets/visual-companions/wave2/aws-sqs-extended-client-en.png) | [SVG](/assets/visual-companions/wave2/aws-sqs-extended-client-ko.svg) · [PNG](/assets/visual-companions/wave2/aws-sqs-extended-client-ko.png) | [EN](/visual-companions/bluetape4k-aws/aws-sqs-extended-client/) · [KO](/ko/visual-companions/bluetape4k-aws/aws-sqs-extended-client/) |
...
![AWS SNS signature verification (EN)](./aws-sns-signature-verification-en.png)
![AWS SNS signature verification (KO)](./aws-sns-signature-verification-ko.png)

![AWS SQS Extended Client lifecycle (EN)](./aws-sqs-extended-client-en.png)
![AWS SQS Extended Client lifecycle (KO)](./aws-sqs-extended-client-ko.png)
