...
test('global sidebar keeps visual companions inside Ecosystem navigation', () => {
  ...
  assert.deepEqual(
    ...
    ['Repositories', 'Ecosystem Atlas', 'Examples', 'Visual Companions', 'Version Governance'],
  );
