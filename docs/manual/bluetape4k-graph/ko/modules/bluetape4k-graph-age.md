...
[Apache AGE](../backends/apache-age.md), [구현 선택](../backends/selection-guide.md), [schema와 트랜잭션](../architecture/schema-and-transactions.md)을 참고한다. 이 모듈은 PostgreSQL을 운영하거나 Bolt/Cypher 호환성을 보장하지 않는다.
