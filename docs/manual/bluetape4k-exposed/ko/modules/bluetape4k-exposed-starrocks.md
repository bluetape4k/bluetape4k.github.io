...
[데이터베이스 어댑터 표](../guides/database-adapter-matrix.md)와 [OLTP와 OLAP 가이드](../guides/oltp-vs-olap.md)를 읽으세요. 연결 → DDL → 단건 삽입 → 단건 조회 순서로 근거를 쌓은 뒤 기능 범위를 넓힙니다.
