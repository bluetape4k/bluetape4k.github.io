...
- [x] **Step 3: Implement the catalog boundary**
...
- [x] **Step 2: Run the atlas test and verify RED**
...
- [x] **Step 3: Implement the staged map**
...
- [x] **Step 4: Add progressive relation highlighting**
...
- [x] **Step 5: Run the atlas test and verify GREEN**
...
- [x] **Step 1: Write failing style assertions**
...
- [x] **Step 4: Implement responsive and accessibility states**
...
- [x] **Step 5: Run the atlas and catalog tests and verify GREEN**
...
- [x] **Step 1: Write failing page-copy assertions**
...
- [x] **Step 3: Update both locale pages**
...
- [x] **Step 3: Verify clean completion**
